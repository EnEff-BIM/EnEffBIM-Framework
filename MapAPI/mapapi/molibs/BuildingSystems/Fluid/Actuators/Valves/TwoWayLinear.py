...
class TwoWayLinear(MapHierarchy.MapComponent):
    """Representation of BuildingSystems.Fluid.Actuators.Valves.TwoWayLinear
    """

    def init_me(self):

        self.fluid_two_port()
        self.y = self.add_connector(name='y', type='Real')
        return True
    ...
    def pid_control(self, thermal_zone):
        ...
        self.add_connection(self.y, pid.y)
