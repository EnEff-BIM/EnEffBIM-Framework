...
#ifndef MULTIPLE_LIBRARY_MAP_HXX
#define MULTIPLE_LIBRARY_MAP_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace DataMap
    {
      class Multiple_Library_Map: public ::xml_schema::type
      {
        public:
        // Description
        //
        ...
        //
        typedef ::xml_schema::idref Component_Map_Many2One_Name_type;
        typedef ::xsd::cxx::tree::sequence< Component_Map_Many2One_Name_type > Component_Map_Many2One_Name_sequence;
        typedef Component_Map_Many2One_Name_sequence::iterator Component_Map_Many2One_Name_iterator;
        typedef Component_Map_Many2One_Name_sequence::const_iterator Component_Map_Many2One_Name_const_iterator;
        typedef ::xsd::cxx::tree::traits< Component_Map_Many2One_Name_type, char > Component_Map_Many2One_Name_traits;

        const Component_Map_Many2One_Name_sequence&
        Component_Map_Many2One_Name () const;

        Component_Map_Many2One_Name_sequence&
        Component_Map_Many2One_Name ();
        ...
        // Constructors.
        //
        Multiple_Library_Map (const TargetLibraryName_type&);
        ...
        Component_Map_Many2One_Name_sequence Component_Map_Many2One_Name_;
...
#endif // MULTIPLE_LIBRARY_MAP_HXX
