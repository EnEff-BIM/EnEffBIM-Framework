...
#ifndef COMPONENT_MAP_MANY2ONE_HXX
#define COMPONENT_MAP_MANY2ONE_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace DataMap
    {
      class Component_Map_Many2One: public ::xml_schema::type
      {
        public:
        // Description
        //
        ...
        typedef ::xsd::cxx::tree::sequence< SourceComponentName_type > SourceComponentName_sequence;
        typedef SourceComponentName_sequence::iterator SourceComponentName_iterator;
        typedef SourceComponentName_sequence::const_iterator SourceComponentName_const_iterator;
        typedef ::xsd::cxx::tree::traits< SourceComponentName_type, char > SourceComponentName_traits;

        const SourceComponentName_sequence&
        SourceComponentName () const;

        SourceComponentName_sequence&
        SourceComponentName ();
        ...
        // Constructors.
        //
        Component_Map_Many2One (const TargetComponentName_type&,
                                const RefId_type&);
        ...
        virtual Component_Map_Many2One*
        ...
        SourceComponentName_sequence SourceComponentName_;
...
#endif // COMPONENT_MAP_MANY2ONE_HXX
