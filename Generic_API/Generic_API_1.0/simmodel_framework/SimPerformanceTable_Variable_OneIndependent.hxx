...
#ifndef SIM_PERFORMANCE_TABLE_VARIABLE_ONE_INDEPENDENT_HXX
#define SIM_PERFORMANCE_TABLE_VARIABLE_ONE_INDEPENDENT_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeometry
    {
      class SimPerformanceTable_Variable_OneIndependent: public ::namespaces::Sim::ResourcesGeometry::SimPerformanceTable_Variable
      {
        public:
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimPerformanceTable_XValue_1_57_type;
        typedef ::xsd::cxx::tree::optional< SimPerformanceTable_XValue_1_57_type > SimPerformanceTable_XValue_1_57_optional;
        typedef ::xsd::cxx::tree::traits< SimPerformanceTable_XValue_1_57_type, char > SimPerformanceTable_XValue_1_57_traits;

        const SimPerformanceTable_XValue_1_57_optional&
        SimPerformanceTable_XValue_1_57 () const;

        SimPerformanceTable_XValue_1_57_optional&
        SimPerformanceTable_XValue_1_57 ();
        ...
        void
        SimPerformanceTable_XValue_1_57 (::std::auto_ptr< SimPerformanceTable_XValue_1_57_type > p);

        // SimPerformanceTable_OutputValue_1_57
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimPerformanceTable_OutputValue_1_57_type;
        typedef ::xsd::cxx::tree::optional< SimPerformanceTable_OutputValue_1_57_type > SimPerformanceTable_OutputValue_1_57_optional;
        typedef ::xsd::cxx::tree::traits< SimPerformanceTable_OutputValue_1_57_type, char > SimPerformanceTable_OutputValue_1_57_traits;

        const SimPerformanceTable_OutputValue_1_57_optional&
        SimPerformanceTable_OutputValue_1_57 () const;

        SimPerformanceTable_OutputValue_1_57_optional&
        SimPerformanceTable_OutputValue_1_57 ();
        ...
        void
        SimPerformanceTable_OutputValue_1_57 (::std::auto_ptr< SimPerformanceTable_OutputValue_1_57_type > p);

        // Constructors.
        //
        SimPerformanceTable_Variable_OneIndependent (const RefId_type&);
        ...
        virtual SimPerformanceTable_Variable_OneIndependent*
        ...
        SimPerformanceTable_XValue_1_57_optional SimPerformanceTable_XValue_1_57_;
        SimPerformanceTable_OutputValue_1_57_optional SimPerformanceTable_OutputValue_1_57_;
      };
    }
  }
}
...
#endif // SIM_PERFORMANCE_TABLE_VARIABLE_ONE_INDEPENDENT_HXX
