...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      class SimMaterialLayerSet: public ::namespaces::Sim::ResourcesGeneral::SimResourceObject
      {
        public:
        // IntendedBldgElemTypes
        //
        typedef ::namespaces::Sim::ResourcesGeneral::IntendedBldgElemTypes IntendedBldgElemTypes_type;
