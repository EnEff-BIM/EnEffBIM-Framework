    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // IntendedPanelWidth
          //
          if (n.name () == "IntendedPanelWidth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // IntendedPanelHeight
          //
          if (n.name () == "IntendedPanelHeight" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ContainedPanelParams
          //
          if (n.name () == "ContainedPanelParams" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // IntendedFrameWidth
          //
          if (n.name () == "IntendedFrameWidth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // IntendedFrameDepth
          //
          if (n.name () == "IntendedFrameDepth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ContainedFrameParams
          //
          if (n.name () == "ContainedFrameParams" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
