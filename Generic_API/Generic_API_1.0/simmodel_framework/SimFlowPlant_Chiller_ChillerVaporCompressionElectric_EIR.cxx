...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      const SimFlowPlant_Chiller_ChillerVaporCompressionElectric_EIR::SimFlowPlant_CompMotorEff_optional& SimFlowPlant_Chiller_ChillerVaporCompressionElectric_EIR::
      SimFlowPlant_CompMotorEff () const
      {
        return this->SimFlowPlant_CompMotorEff_;
      }

      SimFlowPlant_Chiller_ChillerVaporCompressionElectric_EIR::SimFlowPlant_CompMotorEff_optional& SimFlowPlant_Chiller_ChillerVaporCompressionElectric_EIR::
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowPlant_RefEnterCondFluidTemp
          //
          if (n.name () == "SimFlowPlant_RefEnterCondFluidTemp" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowPlant_RefCondenserFluidFlowRate
          //
          if (n.name () == "SimFlowPlant_RefCondenserFluidFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowPlant_CondFanPwrRatio
          //
          if (n.name () == "SimFlowPlant_CondFanPwrRatio" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
