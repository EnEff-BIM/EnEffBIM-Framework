...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimNode_Node (RefId),
        SimNode_Name_ (this),
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimNode_Node (x, f, c),
      ...
      SimNode_Node_OutdoorAir (const ::xercesc::DOMElement& e,
                               ::xml_schema::flags f,
                               ::xml_schema::container* c)
      : ::namespaces::Sim::ResourcesGeneral::SimNode_Node (e, f | ::xml_schema::flags::base, c),
        SimNode_Name_ (this),
        SimNode_HeightAboveGround_ (this)
      {
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::ResourcesGeneral::SimNode_Node::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimNode_HeightAboveGround
          //
          if (n.name () == "SimNode_HeightAboveGround" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
      ...
      operator= (const SimNode_Node_OutdoorAir& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::ResourcesGeneral::SimNode_Node& > (*this) = x;
