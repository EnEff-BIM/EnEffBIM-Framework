...
#ifndef SIM_SENSOR_DEFAULT_HXX
#define SIM_SENSOR_DEFAULT_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimSensor_Default: public ::namespaces::Sim::MepModel::SimSensor
      {
        public:
        ...
        // Constructors.
        //
        SimSensor_Default (const RefId_type&);
