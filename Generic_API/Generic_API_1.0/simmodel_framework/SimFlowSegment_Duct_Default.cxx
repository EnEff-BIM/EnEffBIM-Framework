...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      const SimFlowSegment_Duct_Default::SimFlowSeg_InNodeName_optional& SimFlowSegment_Duct_Default::
      SimFlowSeg_InNodeName () const
      {
        return this->SimFlowSeg_InNodeName_;
      }

      SimFlowSegment_Duct_Default::SimFlowSeg_InNodeName_optional& SimFlowSegment_Duct_Default::
      SimFlowSeg_InNodeName ()
      {
        return this->SimFlowSeg_InNodeName_;
      }

      void SimFlowSegment_Duct_Default::
      ...
      const SimFlowSegment_Duct_Default::SimFlowSeg_OutNodeName_optional& SimFlowSegment_Duct_Default::
      SimFlowSeg_OutNodeName () const
      {
        return this->SimFlowSeg_OutNodeName_;
      }

      SimFlowSegment_Duct_Default::SimFlowSeg_OutNodeName_optional& SimFlowSegment_Duct_Default::
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      SimFlowSegment_Duct_Default::
      SimFlowSegment_Duct_Default (const RefId_type& RefId)
      : ::namespaces::Sim::MepModel::SimFlowSegment_Duct (RefId),
      ...
      : ::namespaces::Sim::MepModel::SimFlowSegment_Duct (x, f, c),
      ...
      SimFlowSegment_Duct_Default (const ::xercesc::DOMElement& e,
                                   ::xml_schema::flags f,
                                   ::xml_schema::container* c)
      : ::namespaces::Sim::MepModel::SimFlowSegment_Duct (e, f | ::xml_schema::flags::base, c),
        SimFlowSeg_InNodeName_ (this),
        SimFlowSeg_OutNodeName_ (this)
      {
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::MepModel::SimFlowSegment_Duct::parse (p, f);
      ...
      SimFlowSegment_Duct_Default* SimFlowSegment_Duct_Default::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowSegment_Duct_Default (*this, f, c);
      }
      ...
      operator= (const SimFlowSegment_Duct_Default& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::MepModel::SimFlowSegment_Duct& > (*this) = x;
