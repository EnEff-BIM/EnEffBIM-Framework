...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeometry
    {
      ...
      : ::namespaces::Sim::ResourcesGeometry::SimAnalyticalRepresentation (RefId)
      {
      }
      ...
      : ::namespaces::Sim::ResourcesGeometry::SimAnalyticalRepresentation (x, f, c)
      {
      }
      ...
      SimAnalyticalRepresentation_AnalyticalRepresentation (const ::xercesc::DOMElement& e,
                                                            ::xml_schema::flags f,
                                                            ::xml_schema::container* c)
      : ::namespaces::Sim::ResourcesGeometry::SimAnalyticalRepresentation (e, f, c)
      {
      }
