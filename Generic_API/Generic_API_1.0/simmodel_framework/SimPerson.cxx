...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimActorDefinition (RefId),
        Id_ (this),
        FamilyName_ (this),
        GivenName_ (this),
        MiddleNames_ (this),
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimActorDefinition (x, f, c),
        Id_ (x.Id_, f, this),
      ...
      SimPerson (const ::xercesc::DOMElement& e,
                 ::xml_schema::flags f,
                 ::xml_schema::container* c)
      : ::namespaces::Sim::ResourcesGeneral::SimActorDefinition (e, f | ::xml_schema::flags::base, c),
        Id_ (this),
        FamilyName_ (this),
        GivenName_ (this),
        MiddleNames_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::ResourcesGeneral::SimActorDefinition::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // FamilyName
          //
          if (n.name () == "FamilyName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // GivenName
          //
          if (n.name () == "GivenName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // MiddleNames
          //
          if (n.name () == "MiddleNames" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // PrefixTitles
          //
          if (n.name () == "PrefixTitles" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SuffixTitles
          //
          if (n.name () == "SuffixTitles" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
      ...
      operator= (const SimPerson& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::ResourcesGeneral::SimActorDefinition& > (*this) = x;
          this->Id_ = x.Id_;
