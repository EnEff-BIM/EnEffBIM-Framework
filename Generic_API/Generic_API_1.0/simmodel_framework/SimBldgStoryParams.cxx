...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      const SimBldgStoryParams::ZoneConfiguration_optional& SimBldgStoryParams::
      ZoneConfiguration () const
      {
        return this->ZoneConfiguration_;
      }

      SimBldgStoryParams::ZoneConfiguration_optional& SimBldgStoryParams::
      ZoneConfiguration ()
      {
        return this->ZoneConfiguration_;
      }
      ...
      {
        this->ZoneConfiguration_.set (x);
      }

      void SimBldgStoryParams::
      ZoneConfiguration (const ZoneConfiguration_optional& x)
      {
        this->ZoneConfiguration_ = x;
      }

      void SimBldgStoryParams::
      ZoneConfiguration (::std::auto_ptr< ZoneConfiguration_type > x)
      {
        this->ZoneConfiguration_.set (x);
      }
  ...
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimBldgModelParams (x, f, c),
        ...
        ZoneConfiguration_ (x.ZoneConfiguration_, f, this),
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // BldgStoryName
          //
          if (n.name () == "BldgStoryName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // BldgStoryShape
          //
          if (n.name () == "BldgStoryShape" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // FloorToFloorHeight
          //
          if (n.name () == "FloorToFloorHeight" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // CeilingBottomElevation
          //
          if (n.name () == "CeilingBottomElevation" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // FinishFloorTopElevation
          //
          if (n.name () == "FinishFloorTopElevation" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ZoneConfiguration
          //
          if (n.name () == "ZoneConfiguration" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            ::std::auto_ptr< ZoneConfiguration_type > r (
              ZoneConfiguration_traits::create (i, f, this));

            if (!this->ZoneConfiguration_)
            {
              this->ZoneConfiguration_.set (r);
              continue;
            }
          }
          ...
          // PerimeterZoneDepth
          //
          if (n.name () == "PerimeterZoneDepth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // PlenumConfiguration
          //
          if (n.name () == "PlenumConfiguration" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // WallProfilePathType
          //
          if (n.name () == "WallProfilePathType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // BldgStoryProfilePath
          //
          if (n.name () == "BldgStoryProfilePath" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // PerimeterZoneOutsidePath
          //
          if (n.name () == "PerimeterZoneOutsidePath" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // CoreZoneOutsidePaths
          //
          if (n.name () == "CoreZoneOutsidePaths" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // CoreZoneInsidePaths
          //
          if (n.name () == "CoreZoneInsidePaths" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TargetNorthWinArrayParams
          //
          if (n.name () == "TargetNorthWinArrayParams" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TargetSouthWinArrayParams
          //
          if (n.name () == "TargetSouthWinArrayParams" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TargetEastWinArrayParams
          //
          if (n.name () == "TargetEastWinArrayParams" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TargetWestWinArrayParams
          //
          if (n.name () == "TargetWestWinArrayParams" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // InsertedDWG
          //
          if (n.name () == "InsertedDWG" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
      ...
      operator= (const SimBldgStoryParams& x)
      {
        if (this != &x)
        {
          ...
          this->ZoneConfiguration_ = x.ZoneConfiguration_;
