    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // TopLevelSystem
          //
          if (n.name () == "TopLevelSystem" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // FatalErrorMsgs
          //
          if (n.name () == "FatalErrorMsgs" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // FatalErrorObjectRefs
          //
          if (n.name () == "FatalErrorObjectRefs" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SevereErrorMsgs
          //
          if (n.name () == "SevereErrorMsgs" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SevereErrorObjectRefs
          //
          if (n.name () == "SevereErrorObjectRefs" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // WarningMsgs
          //
          if (n.name () == "WarningMsgs" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // WarningErrorObjectRefs
          //
          if (n.name () == "WarningErrorObjectRefs" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
