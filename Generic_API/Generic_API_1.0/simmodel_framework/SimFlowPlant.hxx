...
#ifndef SIM_FLOW_PLANT_HXX
#define SIM_FLOW_PLANT_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowPlant: public ::namespaces::Sim::MepModel::SimFlowEnergyConverter
      {
        public:
        // Representation
        //
