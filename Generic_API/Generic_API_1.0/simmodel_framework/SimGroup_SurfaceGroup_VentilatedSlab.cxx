    ...
    namespace BuildingModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimGroup_Zone_1_10_Name
          //
          if (n.name () == "SimGroup_Zone_1_10_Name" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimGroup_SurfName_1_10
          //
          if (n.name () == "SimGroup_SurfName_1_10" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimGroup_CoreDiamSurf_1_10
          //
          if (n.name () == "SimGroup_CoreDiamSurf_1_10" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimGroup_CoreLengthSurf_1_10
          //
          if (n.name () == "SimGroup_CoreLengthSurf_1_10" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimGroup_CoreNumbsSurf_1_10
          //
          if (n.name () == "SimGroup_CoreNumbsSurf_1_10" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimGroup_SlabInNodeNameForSurf_1_10
          //
          if (n.name () == "SimGroup_SlabInNodeNameForSurf_1_10" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimGroup_SlabOutNodeNameSurf_1_10
          //
          if (n.name () == "SimGroup_SlabOutNodeNameSurf_1_10" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
