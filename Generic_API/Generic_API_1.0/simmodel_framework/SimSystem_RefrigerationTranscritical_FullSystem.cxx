...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      ...
      const SimSystem_RefrigerationTranscritical_FullSystem::SimSys_HighPressureCompressOrCompressListName_optional& SimSystem_RefrigerationTranscritical_FullSystem::
      SimSys_HighPressureCompressOrCompressListName () const
      {
        return this->SimSys_HighPressureCompressOrCompressListName_;
      }

      SimSystem_RefrigerationTranscritical_FullSystem::SimSys_HighPressureCompressOrCompressListName_optional& SimSystem_RefrigerationTranscritical_FullSystem::
      ...
      {
        this->SimSys_HighPressureCompressOrCompressListName_.set (x);
      }

      void SimSystem_RefrigerationTranscritical_FullSystem::
      SimSys_HighPressureCompressOrCompressListName (const SimSys_HighPressureCompressOrCompressListName_optional& x)
      {
        this->SimSys_HighPressureCompressOrCompressListName_ = x;
      }

      void SimSystem_RefrigerationTranscritical_FullSystem::
      SimSys_HighPressureCompressOrCompressListName (::std::auto_ptr< SimSys_HighPressureCompressOrCompressListName_type > x)
      {
        this->SimSys_HighPressureCompressOrCompressListName_.set (x);
      }
...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      ...
      : ::namespaces::Sim::BuildingModel::SimSystem_RefrigerationTranscritical (RefId),
        ...
        SimSys_HighPressureCompressOrCompressListName_ (this),
      ...
      : ::namespaces::Sim::BuildingModel::SimSystem_RefrigerationTranscritical (x, f, c),
        ...
        SimSys_HighPressureCompressOrCompressListName_ (x.SimSys_HighPressureCompressOrCompressListName_, f, this),
      ...
      SimSystem_RefrigerationTranscritical_FullSystem (const ::xercesc::DOMElement& e,
                                                       ::xml_schema::flags f,
                                                       ::xml_schema::container* c)
      : ::namespaces::Sim::BuildingModel::SimSystem_RefrigerationTranscritical (e, f | ::xml_schema::flags::base, c),
        SimSys_RefrigSysWorkingFluidType_ (this),
        SimSys_EndUseSubCat_ (this),
        SimSys_SystemType_ (this),
        SimSys_MediumTempRefrigCaseorWalkinOrCaseAndWalkInListName_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::BuildingModel::SimSystem_RefrigerationTranscritical::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimSys_SystemType
          //
          if (n.name () == "SimSys_SystemType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_MediumTempRefrigCaseorWalkinOrCaseAndWalkInListName
          //
          if (n.name () == "SimSys_MediumTempRefrigCaseorWalkinOrCaseAndWalkInListName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_LowTempRefrigCaseorWalkinOrCaseAndWalkInListName
          //
          if (n.name () == "SimSys_LowTempRefrigCaseorWalkinOrCaseAndWalkInListName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_RefrigerationGasCoolerName
          //
          if (n.name () == "SimSys_RefrigerationGasCoolerName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_HighPressureCompressOrCompressListName
          //
          if (n.name () == "SimSys_HighPressureCompressOrCompressListName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
            ::std::auto_ptr< SimSys_HighPressureCompressOrCompressListName_type > r (
              SimSys_HighPressureCompressOrCompressListName_traits::create (i, f, this));

            if (!this->SimSys_HighPressureCompressOrCompressListName_)
            {
              this->SimSys_HighPressureCompressOrCompressListName_.set (r);
              continue;
            }
          }
          ...
          // SimSys_LowPressureCompressOrCompressListName
          //
          if (n.name () == "SimSys_LowPressureCompressOrCompressListName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_ReceiverPressure
          //
          if (n.name () == "SimSys_ReceiverPressure" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_SubcoolerEffectiveness
          //
          if (n.name () == "SimSys_SubcoolerEffectiveness" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_SumUASuctionPipingforMediumTempLoads
          //
          if (n.name () == "SimSys_SumUASuctionPipingforMediumTempLoads" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_MediumTempSuctionPipingZoneName
          //
          if (n.name () == "SimSys_MediumTempSuctionPipingZoneName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_SumUASuctionPipingforLowTempLoads
          //
          if (n.name () == "SimSys_SumUASuctionPipingforLowTempLoads" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_LowTempSuctionPipingZoneName
          //
          if (n.name () == "SimSys_LowTempSuctionPipingZoneName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
      ...
      operator= (const SimSystem_RefrigerationTranscritical_FullSystem& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::BuildingModel::SimSystem_RefrigerationTranscritical& > (*this) = x;
          ...
          this->SimSys_HighPressureCompressOrCompressListName_ = x.SimSys_HighPressureCompressOrCompressListName_;
