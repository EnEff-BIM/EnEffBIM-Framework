...
#ifndef SIM_DOOR_TYPE_HXX
#define SIM_DOOR_TYPE_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      class SimDoorType: public ::namespaces::Sim::SimModelCore::SimObjectTypeDefinition
      {
        public:
        // Name
        //
