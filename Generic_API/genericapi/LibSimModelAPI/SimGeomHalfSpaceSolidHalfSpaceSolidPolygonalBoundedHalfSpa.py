...
import base
class SimGeomHalfSpaceSolid(base.SimGeometricRepresentationItem):
    __swig_setmethods__ = {}
    for _s in [base.SimGeometricRepresentationItem]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, SimGeomHalfSpaceSolid, name, value)
    __swig_getmethods__ = {}
    for _s in [base.SimGeometricRepresentationItem]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, SimGeomHalfSpaceSolid, name)
    __repr__ = _swig_repr
...
class SimGeomHalfSpaceSolid_HalfSpaceSolid(SimGeomHalfSpaceSolid):
    __swig_setmethods__ = {}
    for _s in [SimGeomHalfSpaceSolid]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, SimGeomHalfSpaceSolid_HalfSpaceSolid, name, value)
    __swig_getmethods__ = {}
    for _s in [SimGeomHalfSpaceSolid]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, SimGeomHalfSpaceSolid_HalfSpaceSolid, name)
    __repr__ = _swig_repr
...
class SimGeomHalfSpaceSolid_HalfSpaceSolid_PolygonalBoundedHalfSpace(SimGeomHalfSpaceSolid_HalfSpaceSolid):
    __swig_setmethods__ = {}
    for _s in [SimGeomHalfSpaceSolid_HalfSpaceSolid]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, SimGeomHalfSpaceSolid_HalfSpaceSolid_PolygonalBoundedHalfSpace, name, value)
    __swig_getmethods__ = {}
    for _s in [SimGeomHalfSpaceSolid_HalfSpaceSolid]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, SimGeomHalfSpaceSolid_HalfSpaceSolid_PolygonalBoundedHalfSpace, name)
    __repr__ = _swig_repr
...
class SimGeomHalfSpaceSolid_HalfSpaceSolid_PolygonalBoundedHalfSpace_sequence(base.sequence_common):
    ...
    for _s in [base.sequence_common]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, SimGeomHalfSpaceSolid_HalfSpaceSolid_PolygonalBoundedHalfSpace_sequence, name, value)
    __swig_getmethods__ = {}
    for _s in [base.sequence_common]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, SimGeomHalfSpaceSolid_HalfSpaceSolid_PolygonalBoundedHalfSpace_sequence, name)
    __repr__ = _swig_repr
