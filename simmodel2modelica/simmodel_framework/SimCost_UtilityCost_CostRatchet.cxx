...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      const SimCost_UtilityCost_CostRatchet::SimCost_MultVarName_optional& SimCost_UtilityCost_CostRatchet::
      SimCost_MultVarName () const
      {
        return this->SimCost_MultVarName_;
      }

      SimCost_UtilityCost_CostRatchet::SimCost_MultVarName_optional& SimCost_UtilityCost_CostRatchet::
      SimCost_MultVarName ()
      {
        return this->SimCost_MultVarName_;
      }
      ...
      {
        this->SimCost_MultVarName_.set (x);
      }

      void SimCost_UtilityCost_CostRatchet::
      SimCost_MultVarName (const SimCost_MultVarName_optional& x)
      {
        this->SimCost_MultVarName_ = x;
      }

      void SimCost_UtilityCost_CostRatchet::
      SimCost_MultVarName (::std::auto_ptr< SimCost_MultVarName_type > x)
      {
        this->SimCost_MultVarName_.set (x);
      }

      const SimCost_UtilityCost_CostRatchet::SimCost_OffsetVarName_optional& SimCost_UtilityCost_CostRatchet::
      SimCost_OffsetVarName () const
      {
        return this->SimCost_OffsetVarName_;
      }

      SimCost_UtilityCost_CostRatchet::SimCost_OffsetVarName_optional& SimCost_UtilityCost_CostRatchet::
      ...
      {
        this->SimCost_OffsetVarName_.set (x);
      }

      void SimCost_UtilityCost_CostRatchet::
      SimCost_OffsetVarName (const SimCost_OffsetVarName_optional& x)
      {
        this->SimCost_OffsetVarName_ = x;
      }

      void SimCost_UtilityCost_CostRatchet::
      SimCost_OffsetVarName (::std::auto_ptr< SimCost_OffsetVarName_type > x)
      {
        this->SimCost_OffsetVarName_.set (x);
      }
    }
  ...
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimCost_UtilityCost (RefId),
        ...
        SimCost_MultVarName_ (this),
        SimCost_OffsetVarName_ (this)
      {
      }
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimCost_UtilityCost (x, f, c),
        ...
        SimCost_MultVarName_ (x.SimCost_MultVarName_, f, this),
        SimCost_OffsetVarName_ (x.SimCost_OffsetVarName_, f, this)
      {
      }
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimCost_RatchetVarName
          //
          if (n.name () == "SimCost_RatchetVarName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_BaselineSrcVar
          //
          if (n.name () == "SimCost_BaselineSrcVar" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_AdjSrcVar
          //
          if (n.name () == "SimCost_AdjSrcVar" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_SeasonFrom
          //
          if (n.name () == "SimCost_SeasonFrom" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_SeasonTo
          //
          if (n.name () == "SimCost_SeasonTo" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_MultVarName
          //
          if (n.name () == "SimCost_MultVarName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            ::std::auto_ptr< SimCost_MultVarName_type > r (
              SimCost_MultVarName_traits::create (i, f, this));

            if (!this->SimCost_MultVarName_)
            {
              this->SimCost_MultVarName_.set (r);
              continue;
            }
          }
          ...
          // SimCost_OffsetVarName
          //
          if (n.name () == "SimCost_OffsetVarName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            ::std::auto_ptr< SimCost_OffsetVarName_type > r (
              SimCost_OffsetVarName_traits::create (i, f, this));

            if (!this->SimCost_OffsetVarName_)
            {
              this->SimCost_OffsetVarName_.set (r);
              continue;
            }
          }
      ...
      operator= (const SimCost_UtilityCost_CostRatchet& x)
      {
        if (this != &x)
        {
          ...
          this->SimCost_MultVarName_ = x.SimCost_MultVarName_;
          this->SimCost_OffsetVarName_ = x.SimCost_OffsetVarName_;
        }
