    ...
    namespace BuildingModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // RampConfiguration
          //
          if (n.name () == "RampConfiguration" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // RampIsExternal
          //
          if (n.name () == "RampIsExternal" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
