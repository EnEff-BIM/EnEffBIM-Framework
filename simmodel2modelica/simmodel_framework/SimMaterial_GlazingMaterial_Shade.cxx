    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimMaterial_SolarTrans
          //
          if (n.name () == "SimMaterial_SolarTrans" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimMaterial_SolarReflect
          //
          if (n.name () == "SimMaterial_SolarReflect" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimMaterial_VisReflect
          //
          if (n.name () == "SimMaterial_VisReflect" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimMaterial_InfraredTransmittance
          //
          if (n.name () == "SimMaterial_InfraredTransmittance" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimMaterial_ShadeToGlassDist
          //
          if (n.name () == "SimMaterial_ShadeToGlassDist" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimMaterial_LeftSideOpngMult_2
          //
          if (n.name () == "SimMaterial_LeftSideOpngMult_2" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimMaterial_RightSideOpngMult_2
          //
          if (n.name () == "SimMaterial_RightSideOpngMult_2" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimMaterial_AirflowPermeability
          //
          if (n.name () == "SimMaterial_AirflowPermeability" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
