...
#ifndef SIM_SOLAR_OBS_PARAMS_HXX
#define SIM_SOLAR_OBS_PARAMS_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      class SimSolarObsParams: public ::namespaces::Sim::ResourcesGeneral::SimBldgModelParams
      {
        public:
        // SolarObstructionType
        //
        typedef ::xml_schema::string SolarObstructionType_type;
        typedef ::xsd::cxx::tree::optional< SolarObstructionType_type > SolarObstructionType_optional;
        typedef ::xsd::cxx::tree::traits< SolarObstructionType_type, char > SolarObstructionType_traits;

        const SolarObstructionType_optional&
        SolarObstructionType () const;

        SolarObstructionType_optional&
        SolarObstructionType ();
        ...
        void
        SolarObstructionType (::std::auto_ptr< SolarObstructionType_type > p);

        // SolarObstructionShape
        //
        typedef ::xml_schema::string SolarObstructionShape_type;
        typedef ::xsd::cxx::tree::optional< SolarObstructionShape_type > SolarObstructionShape_optional;
        typedef ::xsd::cxx::tree::traits< SolarObstructionShape_type, char > SolarObstructionShape_traits;

        const SolarObstructionShape_optional&
        SolarObstructionShape () const;

        SolarObstructionShape_optional&
        SolarObstructionShape ();
        ...
        void
        SolarObstructionShape (::std::auto_ptr< SolarObstructionShape_type > p);
        ...
        // Constructors.
        //
        SimSolarObsParams (const RefId_type&);
        ...
        protected:
        SolarObstructionType_optional SolarObstructionType_;
        SolarObstructionShape_optional SolarObstructionShape_;
...
#endif // SIM_SOLAR_OBS_PARAMS_HXX
