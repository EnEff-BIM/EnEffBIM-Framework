...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_CoolingCoilWater_CoilAirCoolingWaterToAirHeatPumpVariableSpeedEquationFit: public ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_CoolingCoilWater
      {
        public:
        ...
        //
        typedef ::xml_schema::double_ SimFlowEnergyTrans_RatedVolWaterFlowRateAtSelectNominalSpeedLevel_type;
        typedef ::xsd::cxx::tree::optional< SimFlowEnergyTrans_RatedVolWaterFlowRateAtSelectNominalSpeedLevel_type > SimFlowEnergyTrans_RatedVolWaterFlowRateAtSelectNominalSpeedLevel_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowEnergyTrans_RatedVolWaterFlowRateAtSelectNominalSpeedLevel_type, char, ::xsd::cxx::tree::schema_type::double_ > SimFlowEnergyTrans_RatedVolWaterFlowRateAtSelectNominalSpeedLevel_traits;

        const SimFlowEnergyTrans_RatedVolWaterFlowRateAtSelectNominalSpeedLevel_optional&
        SimFlowEnergyTrans_RatedVolWaterFlowRateAtSelectNominalSpeedLevel () const;

        SimFlowEnergyTrans_RatedVolWaterFlowRateAtSelectNominalSpeedLevel_optional&
        SimFlowEnergyTrans_RatedVolWaterFlowRateAtSelectNominalSpeedLevel ();
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds_type;
        typedef ::xsd::cxx::tree::optional< SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds_type > SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds_type, char > SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds_traits;

        const SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds_optional&
        SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds () const;

        SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds_optional&
        SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds ();
        ...
        void
        SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds (::std::auto_ptr< SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds_type > p);
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowEnergyTrans_Speed_1_10_RefUnitWasteHeatFractionofInputPowerAtRatedConds_type;
        ...
        SimFlowEnergyTrans_RatedVolWaterFlowRateAtSelectNominalSpeedLevel_optional SimFlowEnergyTrans_RatedVolWaterFlowRateAtSelectNominalSpeedLevel_;
        SimFlowEnergyTrans_FlagforUsingHotGasReheat_0_or_1_optional SimFlowEnergyTrans_FlagforUsingHotGasReheat_0_or_1_;
        SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds_optional SimFlowEnergyTrans_Speed_1_10_RefUnitWaterFlowRateAtRatedConds_;
