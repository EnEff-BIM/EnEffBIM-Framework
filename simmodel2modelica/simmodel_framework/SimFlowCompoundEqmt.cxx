...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      const SimFlowCompoundEqmt::Representation_optional& SimFlowCompoundEqmt::
      Representation () const
      {
        return this->Representation_;
      }

      SimFlowCompoundEqmt::Representation_optional& SimFlowCompoundEqmt::
      Representation ()
      {
        return this->Representation_;
      }
      ...
      const SimFlowCompoundEqmt::SimFlowCompEqmt_Name_optional& SimFlowCompoundEqmt::
      SimFlowCompEqmt_Name () const
      {
        return this->SimFlowCompEqmt_Name_;
      }

      SimFlowCompoundEqmt::SimFlowCompEqmt_Name_optional& SimFlowCompoundEqmt::
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      SimFlowCompoundEqmt::
      SimFlowCompoundEqmt (const SimFlowCompoundEqmt& x,
                           ::xml_schema::flags f,
      ...
      SimFlowCompoundEqmt::
      SimFlowCompoundEqmt (const ::xercesc::DOMElement& e,
                           ::xml_schema::flags f,
                           ::xml_schema::container* c)
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowCompEqmt_Name
          //
          if (n.name () == "SimFlowCompEqmt_Name" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
      ...
      SimFlowCompoundEqmt* SimFlowCompoundEqmt::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowCompoundEqmt (*this, f, c);
      }

      SimFlowCompoundEqmt& SimFlowCompoundEqmt::
      operator= (const SimFlowCompoundEqmt& x)
      {
        if (this != &x)
        {
