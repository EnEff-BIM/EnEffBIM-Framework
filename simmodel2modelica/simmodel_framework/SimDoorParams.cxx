    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // DoorType
          //
          if (n.name () == "DoorType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // DoorHeight
          //
          if (n.name () == "DoorHeight" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->DoorHeight_)
            {
          ...
          // DoorWidth
          //
          if (n.name () == "DoorWidth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->DoorWidth_)
            {
          ...
          // DoorPanelThickness
          //
          if (n.name () == "DoorPanelThickness" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // YDirectionX
          //
          if (n.name () == "YDirectionX" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // YDirectionY
          //
          if (n.name () == "YDirectionY" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // YDirectionZ
          //
          if (n.name () == "YDirectionZ" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // DoorPanelProfiles
          //
          if (n.name () == "DoorPanelProfiles" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // DoorFrameProfiles
          //
          if (n.name () == "DoorFrameProfiles" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // OpeningProfilePath
          //
          if (n.name () == "OpeningProfilePath" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
