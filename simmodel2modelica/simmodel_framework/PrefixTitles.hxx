...
#ifndef PREFIX_TITLES_HXX
#define PREFIX_TITLES_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      class PrefixTitles: public ::xml_schema::type
      {
        public:
        // stringItem
        //
        ...
        PrefixTitles (const ::xercesc::DOMElement& e,
                      ::xml_schema::flags f = 0,
                      ::xml_schema::container* c = 0);

        PrefixTitles (const PrefixTitles& x,
                      ::xml_schema::flags f = 0,
                      ::xml_schema::container* c = 0);

        virtual PrefixTitles*
        _clone (::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0) const;

        PrefixTitles&
        operator= (const PrefixTitles& x);
