    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimMaterial_OpticalDataTemp_1_45
          //
          if (n.name () == "SimMaterial_OpticalDataTemp_1_45" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimMaterial_WndwMatlGlazingName_1_45
          //
          if (n.name () == "SimMaterial_WndwMatlGlazingName_1_45" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
