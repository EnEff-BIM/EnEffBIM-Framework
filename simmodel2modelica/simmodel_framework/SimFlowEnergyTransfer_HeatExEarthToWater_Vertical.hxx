...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatExEarthToWater_Vertical: public ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_HeatExEarthToWater
      {
        public:
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowEnergyTrans_GFuncLnTTsVal_1_100_type;
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowEnergyTrans_GFuncGVal_1_100_type;
