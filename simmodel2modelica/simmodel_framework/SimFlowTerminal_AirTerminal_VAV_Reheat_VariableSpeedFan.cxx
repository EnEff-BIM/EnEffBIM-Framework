    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowTerm_MaxCoolAirFlowRate
          //
          if (n.name () == "SimFlowTerm_MaxCoolAirFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowTerm_MaxHeatingAirFlowRate
          //
          if (n.name () == "SimFlowTerm_MaxHeatingAirFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowTerm_HeatingCoilAirInletNodeName
          //
          if (n.name () == "SimFlowTerm_HeatingCoilAirInletNodeName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowTerm_FanObjType
          //
          if (n.name () == "SimFlowTerm_FanObjType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
