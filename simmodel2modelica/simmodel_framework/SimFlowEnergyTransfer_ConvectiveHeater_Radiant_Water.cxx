    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowEnergyTrans_RatedAverageWaterTemp
          //
          if (n.name () == "SimFlowEnergyTrans_RatedAverageWaterTemp" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_RatedWaterMassFlowRate
          //
          if (n.name () == "SimFlowEnergyTrans_RatedWaterMassFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_SurfName_1_100
          //
          if (n.name () == "SimFlowEnergyTrans_SurfName_1_100" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_FractRadiantEnergyToSurf_1_20
          //
          if (n.name () == "SimFlowEnergyTrans_FractRadiantEnergyToSurf_1_20" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
