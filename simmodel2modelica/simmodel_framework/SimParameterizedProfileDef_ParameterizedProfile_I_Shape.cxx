    ...
    namespace ResourcesGeometry
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // OverallWidth
          //
          if (n.name () == "OverallWidth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeometry")
          {
          ...
          // OverallDepth
          //
          if (n.name () == "OverallDepth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeometry")
          {
