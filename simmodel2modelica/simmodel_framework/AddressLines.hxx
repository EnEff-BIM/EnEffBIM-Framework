...
#ifndef ADDRESS_LINES_HXX
#define ADDRESS_LINES_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      class AddressLines: public ::xml_schema::type
      {
        public:
        // stringItem
        //
        ...
        AddressLines (const ::xercesc::DOMElement& e,
                      ::xml_schema::flags f = 0,
                      ::xml_schema::container* c = 0);

        AddressLines (const AddressLines& x,
                      ::xml_schema::flags f = 0,
                      ::xml_schema::container* c = 0);

        virtual AddressLines*
        _clone (::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0) const;

        AddressLines&
        operator= (const AddressLines& x);
