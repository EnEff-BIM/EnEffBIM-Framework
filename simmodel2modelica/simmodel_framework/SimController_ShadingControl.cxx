    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimCntrl_ShadingType
          //
          if (n.name () == "SimCntrl_ShadingType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_ConstwithShadingName
          //
          if (n.name () == "SimCntrl_ConstwithShadingName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_ShadingCntlType
          //
          if (n.name () == "SimCntrl_ShadingCntlType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_SchedName
          //
          if (n.name () == "SimCntrl_SchedName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_Setpoint
          //
          if (n.name () == "SimCntrl_Setpoint" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_ShadingCntlSchedd
          //
          if (n.name () == "SimCntrl_ShadingCntlSchedd" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_GlareCntlActive
          //
          if (n.name () == "SimCntrl_GlareCntlActive" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_ShadingDeviceMatlName
          //
          if (n.name () == "SimCntrl_ShadingDeviceMatlName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_TypeSlatAngleCntlForBlinds
          //
          if (n.name () == "SimCntrl_TypeSlatAngleCntlForBlinds" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_SlatAngleSchedName
          //
          if (n.name () == "SimCntrl_SlatAngleSchedName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_Setpoint2
          //
          if (n.name () == "SimCntrl_Setpoint2" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
