...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      const SimFlowEnergyTransfer_HeatingCoilDX_CoilAirHeatingDxVariableRefrigerantFlow::SimFlowEnergyTrans_RatedTotalHeatingCap_optional& SimFlowEnergyTransfer_HeatingCoilDX_CoilAirHeatingDxVariableRefrigerantFlow::
      SimFlowEnergyTrans_RatedTotalHeatingCap () const
      {
        return this->SimFlowEnergyTrans_RatedTotalHeatingCap_;
      }

      SimFlowEnergyTransfer_HeatingCoilDX_CoilAirHeatingDxVariableRefrigerantFlow::SimFlowEnergyTrans_RatedTotalHeatingCap_optional& SimFlowEnergyTransfer_HeatingCoilDX_CoilAirHeatingDxVariableRefrigerantFlow::
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowEnergyTrans_AvailSched
          //
          if (n.name () == "SimFlowEnergyTrans_AvailSched" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_HeatingCapRatioModifierFuncTempCurveName
          //
          if (n.name () == "SimFlowEnergyTrans_HeatingCapRatioModifierFuncTempCurveName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_HeatingCapModifierFuncFlowFractionCurveName
          //
          if (n.name () == "SimFlowEnergyTrans_HeatingCapModifierFuncFlowFractionCurveName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
