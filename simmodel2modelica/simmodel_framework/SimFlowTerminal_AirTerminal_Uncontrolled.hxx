...
#ifndef SIM_FLOW_TERMINAL_AIR_TERMINAL_UNCONTROLLED_HXX
#define SIM_FLOW_TERMINAL_AIR_TERMINAL_UNCONTROLLED_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowTerminal_AirTerminal_Uncontrolled: public ::namespaces::Sim::MepModel::SimFlowTerminal_AirTerminal
      {
        public:
        ...
        //
        typedef ::xml_schema::string SimFlowTerm_ZoneSupAirNodeName_type;
        typedef ::xsd::cxx::tree::optional< SimFlowTerm_ZoneSupAirNodeName_type > SimFlowTerm_ZoneSupAirNodeName_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowTerm_ZoneSupAirNodeName_type, char > SimFlowTerm_ZoneSupAirNodeName_traits;

        const SimFlowTerm_ZoneSupAirNodeName_optional&
        SimFlowTerm_ZoneSupAirNodeName () const;

        SimFlowTerm_ZoneSupAirNodeName_optional&
        SimFlowTerm_ZoneSupAirNodeName ();
        ...
        void
        SimFlowTerm_ZoneSupAirNodeName (::std::auto_ptr< SimFlowTerm_ZoneSupAirNodeName_type > p);
        ...
        // Constructors.
        //
        SimFlowTerminal_AirTerminal_Uncontrolled (const RefId_type&);
        ...
        virtual SimFlowTerminal_AirTerminal_Uncontrolled*
        ...
        SimFlowTerm_ZoneSupAirNodeName_optional SimFlowTerm_ZoneSupAirNodeName_;
...
#endif // SIM_FLOW_TERMINAL_AIR_TERMINAL_UNCONTROLLED_HXX
