...
#ifndef SIM_PERFORMANCE_CURVE_MATHEMATICAL_DOUBLE_EXPONENTIAL_DECAY_HXX
#define SIM_PERFORMANCE_CURVE_MATHEMATICAL_DOUBLE_EXPONENTIAL_DECAY_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeometry
    {
      class SimPerformanceCurve_Mathematical_DoubleExponentialDecay: public ::namespaces::Sim::ResourcesGeometry::SimPerformanceCurve_Mathematical
      {
        public:
        ...
        //
        typedef ::xml_schema::double_ SimPerfCurve_Coeff3C4_type;
        typedef ::xsd::cxx::tree::optional< SimPerfCurve_Coeff3C4_type > SimPerfCurve_Coeff3C4_optional;
        typedef ::xsd::cxx::tree::traits< SimPerfCurve_Coeff3C4_type, char, ::xsd::cxx::tree::schema_type::double_ > SimPerfCurve_Coeff3C4_traits;

        const SimPerfCurve_Coeff3C4_optional&
        SimPerfCurve_Coeff3C4 () const;

        SimPerfCurve_Coeff3C4_optional&
        SimPerfCurve_Coeff3C4 ();
        ...
        //
        typedef ::xml_schema::double_ SimPerfCurve_Coeff3C5_type;
        typedef ::xsd::cxx::tree::optional< SimPerfCurve_Coeff3C5_type > SimPerfCurve_Coeff3C5_optional;
        typedef ::xsd::cxx::tree::traits< SimPerfCurve_Coeff3C5_type, char, ::xsd::cxx::tree::schema_type::double_ > SimPerfCurve_Coeff3C5_traits;

        const SimPerfCurve_Coeff3C5_optional&
        SimPerfCurve_Coeff3C5 () const;

        SimPerfCurve_Coeff3C5_optional&
        SimPerfCurve_Coeff3C5 ();
        ...
        // Constructors.
        //
        SimPerformanceCurve_Mathematical_DoubleExponentialDecay (const RefId_type&);
        ...
        virtual SimPerformanceCurve_Mathematical_DoubleExponentialDecay*
        ...
        SimPerfCurve_Coeff3C4_optional SimPerfCurve_Coeff3C4_;
        SimPerfCurve_Coeff3C5_optional SimPerfCurve_Coeff3C5_;
      };
    }
  }
}
...
#endif // SIM_PERFORMANCE_CURVE_MATHEMATICAL_DOUBLE_EXPONENTIAL_DECAY_HXX
