...
#ifndef SIM_FACE_BOUND_HXX
#define SIM_FACE_BOUND_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeometry
    {
      class SimFaceBound: public ::namespaces::Sim::ResourcesGeometry::SimTopologicalRepresentationItem
      {
        public:
        // Bound
        //
