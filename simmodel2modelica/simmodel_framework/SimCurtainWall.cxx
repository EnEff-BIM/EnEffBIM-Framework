...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      ...
      : ::namespaces::Sim::BuildingModel::SimBuildingElementAssembly (RefId),
        Name_ (this),
      ...
      : ::namespaces::Sim::BuildingModel::SimBuildingElementAssembly (x, f, c),
      ...
      SimCurtainWall (const ::xercesc::DOMElement& e,
                      ::xml_schema::flags f,
                      ::xml_schema::container* c)
      : ::namespaces::Sim::BuildingModel::SimBuildingElementAssembly (e, f | ::xml_schema::flags::base, c),
        Name_ (this),
        ConstructionType_ (this),
        CurtainWallIsExternal_ (this),
        CompositeThermalTrans_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::BuildingModel::SimBuildingElementAssembly::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // CurtainWallIsExternal
          //
          if (n.name () == "CurtainWallIsExternal" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // Windows6GlazingSystemName
          //
          if (n.name () == "Windows6GlazingSystemName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // ExteriorSurfaceColorofGlass
          //
          if (n.name () == "ExteriorSurfaceColorofGlass" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // InteriorSurfaceColorofGlass
          //
          if (n.name () == "InteriorSurfaceColorofGlass" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // Transmittance_Visible
          //
          if (n.name () == "Transmittance_Visible" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // Transmittance_Solar
          //
          if (n.name () == "Transmittance_Solar" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // CompositeThermalTransGlazing
          //
          if (n.name () == "CompositeThermalTransGlazing" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // ShadingCoefficient_SC
          //
          if (n.name () == "ShadingCoefficient_SC" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SolarHeatGainCoefficient_SHGC
          //
          if (n.name () == "SolarHeatGainCoefficient_SHGC" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // GlazingAssemblyManufacturer
          //
          if (n.name () == "GlazingAssemblyManufacturer" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // GlazingProductID
          //
          if (n.name () == "GlazingProductID" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // GrossSideArea
          //
          if (n.name () == "GrossSideArea" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // FrameDepth
          //
          if (n.name () == "FrameDepth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
            if (!this->FrameDepth_)
            {
          ...
          // FrameThickness
          //
          if (n.name () == "FrameThickness" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // ExternalCornersCount
          //
          if (n.name () == "ExternalCornersCount" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // InternalCornersCount
          //
          if (n.name () == "InternalCornersCount" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // VoidsInCurtainWall
          //
          if (n.name () == "VoidsInCurtainWall" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // MembersInCurtainWall
          //
          if (n.name () == "MembersInCurtainWall" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // PanelsInCurtainWall
          //
          if (n.name () == "PanelsInCurtainWall" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
      ...
      operator= (const SimCurtainWall& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::BuildingModel::SimBuildingElementAssembly& > (*this) = x;
          this->Name_ = x.Name_;
