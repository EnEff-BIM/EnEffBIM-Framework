...
namespace namespaces
{
  namespace Sim
  {
    namespace DataMap
    {
      class __declspec(dllexport) IdList: public ::xml_schema::simple_type,
        public ::xsd::cxx::tree::list< ::xml_schema::id, char >
      {
        public:
        IdList ();
        ...
        : ::xsd::cxx::tree::list< ::xml_schema::id, char > (begin, end, this)
        {
        }
