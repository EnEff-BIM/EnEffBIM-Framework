...
namespace namespaces
{
  namespace Sim
  {
    ...
    {
      void
      operator<< (::xercesc::DOMElement& e, const InputParameter& i)
      {
        ...
        if (i.LowerBoundValue ())
        {
          ...
          s << ::xml_schema::as_double(*i.LowerBoundValue ());
        }
        ...
        if (i.UpperBoundValue ())
        {
          ...
          s << ::xml_schema::as_double(*i.UpperBoundValue ());
        }
