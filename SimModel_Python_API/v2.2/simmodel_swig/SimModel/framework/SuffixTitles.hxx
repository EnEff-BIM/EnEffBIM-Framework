...
#ifndef SUFFIX_TITLES_HXX
#define SUFFIX_TITLES_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class SuffixTitles: public ::xml_schema::type
      {
        public:
        // stringItem
        //
        ...
        SuffixTitles (const ::xercesc::DOMElement& e,
                      ::xml_schema::flags f = 0,
                      ::xml_schema::container* c = 0);

        SuffixTitles (const SuffixTitles& x,
                      ::xml_schema::flags f = 0,
                      ::xml_schema::container* c = 0);

        virtual SuffixTitles*
        _clone (::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0) const;

        SuffixTitles&
        operator= (const SuffixTitles& x);
