...
#ifndef SIM_RAILING_HXX
#define SIM_RAILING_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimRailing: public ::schema::simxml::SimModelCore::SimBuildingElement
      {
        public:
        // Name
        //
