...
#ifndef SIM_INTERNAL_LOAD_EQUIPMENT_ELECTRIC_ESCALATORS_HXX
#define SIM_INTERNAL_LOAD_EQUIPMENT_ELECTRIC_ESCALATORS_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimInternalLoad_Equipment_Electric_Escalators;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class SimInternalLoad_Equipment_Electric_Escalators: public ::schema::simxml::ResourcesGeneral::SimInternalLoad_Equipment
      {
        public:
        ...
        SimInternalLoad_Equipment_Electric_Escalators (const RefId_type&);
        ...
        virtual SimInternalLoad_Equipment_Electric_Escalators*
...
#endif // SIM_INTERNAL_LOAD_EQUIPMENT_ELECTRIC_ESCALATORS_HXX
