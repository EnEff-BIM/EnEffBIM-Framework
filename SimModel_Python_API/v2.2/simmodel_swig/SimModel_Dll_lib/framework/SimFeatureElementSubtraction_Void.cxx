    ...
    namespace ResourcesGeometry
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // OpeningHeight
          //
          if (n.name () == "OpeningHeight" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // OpeningWidth
          //
          if (n.name () == "OpeningWidth" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // OpeningDepth
          //
          if (n.name () == "OpeningDepth" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // OpeningPerimeter
          //
          if (n.name () == "OpeningPerimeter" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // OpeningArea
          //
          if (n.name () == "OpeningArea" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // OpeningVolume
          //
          if (n.name () == "OpeningVolume" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // TypeDefinition
          //
          if (n.name () == "TypeDefinition" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // Placement
          //
          if (n.name () == "Placement" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // GeometricRepresentations
          //
          if (n.name () == "GeometricRepresentations" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // VoidedBldgElement
          //
          if (n.name () == "VoidedBldgElement" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
