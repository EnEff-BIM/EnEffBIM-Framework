...
#ifndef SIM_FLOW_ENERGY_TRANSFER_HEATING_COIL_DX_HXX
#define SIM_FLOW_ENERGY_TRANSFER_HEATING_COIL_DX_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatingCoilDX;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatingCoilDX: public ::schema::simxml::MepModel::SimFlowEnergyTransfer
      {
        public:
        ...
        SimFlowEnergyTransfer_HeatingCoilDX (const RefId_type&);
        ...
        virtual SimFlowEnergyTransfer_HeatingCoilDX*
...
#endif // SIM_FLOW_ENERGY_TRANSFER_HEATING_COIL_DX_HXX
