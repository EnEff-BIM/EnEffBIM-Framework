...
#ifndef SIM_WALL_OTHER_SIDE_CONDITIONS_MODEL_DETAILED_HXX
#define SIM_WALL_OTHER_SIDE_CONDITIONS_MODEL_DETAILED_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimWall_OtherSideConditionsModel_Detailed: public ::schema::simxml::BuildingModel::SimWall_OtherSideConditionsModel
      {
        public:
        ...
        SimWall_OtherSideConditionsModel_Detailed (const RefId_type&);
        ...
        virtual SimWall_OtherSideConditionsModel_Detailed*
...
#endif // SIM_WALL_OTHER_SIDE_CONDITIONS_MODEL_DETAILED_HXX
