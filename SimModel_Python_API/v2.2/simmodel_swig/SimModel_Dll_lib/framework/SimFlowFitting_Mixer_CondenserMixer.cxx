...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowFitting_Mixer_CondenserMixer::SimFlowFitting_Name_optional& SimFlowFitting_Mixer_CondenserMixer::
      SimFlowFitting_Name () const
      {
        return this->SimFlowFitting_Name_;
      }

      SimFlowFitting_Mixer_CondenserMixer::SimFlowFitting_Name_optional& SimFlowFitting_Mixer_CondenserMixer::
      SimFlowFitting_Name ()
      {
        return this->SimFlowFitting_Name_;
      }
