...
#ifndef SIM_FLOW_ENERGY_TRANSFER_CONVECTIVE_HEATER_HXX
#define SIM_FLOW_ENERGY_TRANSFER_CONVECTIVE_HEATER_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_ConvectiveHeater;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class __declspec(dllexport) SimFlowEnergyTransfer_ConvectiveHeater: public ::schema::simxml::MepModel::SimFlowEnergyTransfer
      {
        public:
        ...
        SimFlowEnergyTransfer_ConvectiveHeater (const RefId_type&);
        ...
        virtual SimFlowEnergyTransfer_ConvectiveHeater*
...
#endif // SIM_FLOW_ENERGY_TRANSFER_CONVECTIVE_HEATER_HXX
