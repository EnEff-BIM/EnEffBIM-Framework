...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      ...
      SimSystem_RefrigerationPrimary_FullSystem::
      SimSystem_RefrigerationPrimary_FullSystem ()
      : ::schema::simxml::BuildingModel::SimSystem_RefrigerationPrimary (),
      ...
      : ::schema::simxml::BuildingModel::SimSystem_RefrigerationPrimary (RefId),
        SimSys_RefrigCaseWalkinCaseAndWalkInListName_ (this),
        SimSys_RefrigTransLoadOrTransLoadListName_ (this),
        SimSys_RefrigCndnsrName_ (this),
        SimSys_CompresrOrCompresrListName_ (this),
      ...
      : ::schema::simxml::BuildingModel::SimSystem_RefrigerationPrimary (x, f, c),
      ...
      SimSystem_RefrigerationPrimary_FullSystem (const ::xercesc::DOMElement& e,
                                                 ::xml_schema::flags f,
                                                 ::xml_schema::container* c)
      : ::schema::simxml::BuildingModel::SimSystem_RefrigerationPrimary (e, f | ::xml_schema::flags::base, c),
        SimSys_RefrigCaseWalkinCaseAndWalkInListName_ (this),
        SimSys_RefrigTransLoadOrTransLoadListName_ (this),
        SimSys_RefrigCndnsrName_ (this),
        SimSys_CompresrOrCompresrListName_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::schema::simxml::BuildingModel::SimSystem_RefrigerationPrimary::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimSys_RefrigTransLoadOrTransLoadListName
          //
          if (n.name () == "SimSys_RefrigTransLoadOrTransLoadListName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_RefrigCndnsrName
          //
          if (n.name () == "SimSys_RefrigCndnsrName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_CompresrOrCompresrListName
          //
          if (n.name () == "SimSys_CompresrOrCompresrListName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_MinCondensTemp
          //
          if (n.name () == "SimSys_MinCondensTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_SucTempContType
          //
          if (n.name () == "SimSys_SucTempContType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_MechanicalSubCoolName
          //
          if (n.name () == "SimSys_MechanicalSubCoolName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_LiquidSucHeatExchSubCoolName
          //
          if (n.name () == "SimSys_LiquidSucHeatExchSubCoolName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_SumUASucPiping
          //
          if (n.name () == "SimSys_SumUASucPiping" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_SucPipingZoneName
          //
          if (n.name () == "SimSys_SucPipingZoneName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_NumberofCompressStages
          //
          if (n.name () == "SimSys_NumberofCompressStages" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_IntercoolerType
          //
          if (n.name () == "SimSys_IntercoolerType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_Shell_and_CoilIntercoolerEffectiveness
          //
          if (n.name () == "SimSys_Shell_and_CoilIntercoolerEffectiveness" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_High_StageCompressOrCompressListName
          //
          if (n.name () == "SimSys_High_StageCompressOrCompressListName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
      ...
      operator= (const SimSystem_RefrigerationPrimary_FullSystem& x)
      {
        if (this != &x)
        {
          static_cast< ::schema::simxml::BuildingModel::SimSystem_RefrigerationPrimary& > (*this) = x;
