    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimSimParams_PlantOrCondenserLoopName
          //
          if (n.name () == "SimSimParams_PlantOrCondenserLoopName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimSimParams_LoopType
          //
          if (n.name () == "SimSimParams_LoopType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimSimParams_DesignLoopExitTemp
          //
          if (n.name () == "SimSimParams_DesignLoopExitTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimSimParams_LoopDesignTempDifference
          //
          if (n.name () == "SimSimParams_LoopDesignTempDifference" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
