    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // RefLinePosition
          //
          if (n.name () == "RefLinePosition" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // RefLinePath
          //
          if (n.name () == "RefLinePath" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // CompassNsewDirection
          //
          if (n.name () == "CompassNsewDirection" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // WallIsExternal
          //
          if (n.name () == "WallIsExternal" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // Justify
          //
          if (n.name () == "Justify" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
            if (!this->Justify_)
            {
          ...
          // ContainedWinArrayParams
          //
          if (n.name () == "ContainedWinArrayParams" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ContainedWindowParams
          //
          if (n.name () == "ContainedWindowParams" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ContainedDoorArrayParams
          //
          if (n.name () == "ContainedDoorArrayParams" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ContainedDoorParams
          //
          if (n.name () == "ContainedDoorParams" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
