...
#ifndef SIM_DOOR_OPAQUE_DOOR_EXTERIOR_HXX
#define SIM_DOOR_OPAQUE_DOOR_EXTERIOR_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimDoor_OpaqueDoor_Exterior: public ::schema::simxml::BuildingModel::SimDoor_OpaqueDoor
      {
        public:
        // SimDoor_Name
        //
        typedef ::xml_schema::string SimDoor_Name_type;
        typedef ::xsd::cxx::tree::optional< SimDoor_Name_type > SimDoor_Name_optional;
        typedef ::xsd::cxx::tree::traits< SimDoor_Name_type, char > SimDoor_Name_traits;

        const SimDoor_Name_optional&
        SimDoor_Name () const;

        SimDoor_Name_optional&
        SimDoor_Name ();
        ...
        void
        SimDoor_Name (::std::auto_ptr< SimDoor_Name_type > p);
        ...
        SimDoor_OpaqueDoor_Exterior (const RefId_type&);
        ...
        virtual SimDoor_OpaqueDoor_Exterior*
        ...
        protected:
        SimDoor_Name_optional SimDoor_Name_;
...
#endif // SIM_DOOR_OPAQUE_DOOR_EXTERIOR_HXX
