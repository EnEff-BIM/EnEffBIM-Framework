    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimMaterial_SolardexRefract
          //
          if (n.name () == "SimMaterial_SolardexRefract" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimMaterial_SolarExtinctCoef
          //
          if (n.name () == "SimMaterial_SolarExtinctCoef" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimMaterial_VisdexRefract
          //
          if (n.name () == "SimMaterial_VisdexRefract" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimMaterial_VisExtinctCoef
          //
          if (n.name () == "SimMaterial_VisExtinctCoef" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
