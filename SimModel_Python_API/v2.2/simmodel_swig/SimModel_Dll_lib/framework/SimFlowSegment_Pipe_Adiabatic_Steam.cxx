...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowSegment_Pipe_Adiabatic_Steam::SimFlowSeg_InNodeName_optional& SimFlowSegment_Pipe_Adiabatic_Steam::
      SimFlowSeg_InNodeName () const
      {
        return this->SimFlowSeg_InNodeName_;
      }

      SimFlowSegment_Pipe_Adiabatic_Steam::SimFlowSeg_InNodeName_optional& SimFlowSegment_Pipe_Adiabatic_Steam::
      SimFlowSeg_InNodeName ()
      {
        return this->SimFlowSeg_InNodeName_;
      }

      void SimFlowSegment_Pipe_Adiabatic_Steam::
      ...
      const SimFlowSegment_Pipe_Adiabatic_Steam::SimFlowSeg_OutNodeName_optional& SimFlowSegment_Pipe_Adiabatic_Steam::
      SimFlowSeg_OutNodeName () const
      {
        return this->SimFlowSeg_OutNodeName_;
      }

      SimFlowSegment_Pipe_Adiabatic_Steam::SimFlowSeg_OutNodeName_optional& SimFlowSegment_Pipe_Adiabatic_Steam::
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowSegment_Pipe_Adiabatic_Steam::
      SimFlowSegment_Pipe_Adiabatic_Steam (const RefId_type& RefId)
      ...
      SimFlowSegment_Pipe_Adiabatic_Steam* SimFlowSegment_Pipe_Adiabatic_Steam::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowSegment_Pipe_Adiabatic_Steam (*this, f, c);
      }
