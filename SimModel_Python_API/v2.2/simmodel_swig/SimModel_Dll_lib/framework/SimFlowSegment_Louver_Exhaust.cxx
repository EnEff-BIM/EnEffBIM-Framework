...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowSegment_Louver_Exhaust::SimFlowSeg_Name_optional& SimFlowSegment_Louver_Exhaust::
      SimFlowSeg_Name () const
      {
        return this->SimFlowSeg_Name_;
      }

      SimFlowSegment_Louver_Exhaust::SimFlowSeg_Name_optional& SimFlowSegment_Louver_Exhaust::
      SimFlowSeg_Name ()
      {
        return this->SimFlowSeg_Name_;
      }
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowSegment_Louver_Exhaust::
      SimFlowSegment_Louver_Exhaust ()
      : ::schema::simxml::MepModel::SimFlowSegment_Louver (),
      ...
      : ::schema::simxml::MepModel::SimFlowSegment_Louver (RefId),
        SimFlowSeg_Name_ (this),
        SimFlowSeg_DesignPresDrop_ (this),
        SimFlowSeg_Ht_ (this),
        SimFlowSeg_Width_ (this),
      ...
      : ::schema::simxml::MepModel::SimFlowSegment_Louver (x, f, c),
      ...
      SimFlowSegment_Louver_Exhaust (const ::xercesc::DOMElement& e,
                                     ::xml_schema::flags f,
                                     ::xml_schema::container* c)
      : ::schema::simxml::MepModel::SimFlowSegment_Louver (e, f | ::xml_schema::flags::base, c),
        SimFlowSeg_Name_ (this),
        SimFlowSeg_DesignPresDrop_ (this),
        SimFlowSeg_Ht_ (this),
        SimFlowSeg_Width_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::schema::simxml::MepModel::SimFlowSegment_Louver::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowSeg_NumberofSlats
          //
          if (n.name () == "SimFlowSeg_NumberofSlats" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowSeg_FixedAngle
          //
          if (n.name () == "SimFlowSeg_FixedAngle" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
      ...
      operator= (const SimFlowSegment_Louver_Exhaust& x)
      {
        if (this != &x)
        {
          static_cast< ::schema::simxml::MepModel::SimFlowSegment_Louver& > (*this) = x;
