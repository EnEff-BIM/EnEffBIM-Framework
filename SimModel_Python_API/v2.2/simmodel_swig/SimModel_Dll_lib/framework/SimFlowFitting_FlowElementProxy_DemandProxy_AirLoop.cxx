...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowFitting_FlowElementProxy_DemandProxy_AirLoop::SimFlowFitting_Name_optional& SimFlowFitting_FlowElementProxy_DemandProxy_AirLoop::
      SimFlowFitting_Name () const
      {
        return this->SimFlowFitting_Name_;
      }

      SimFlowFitting_FlowElementProxy_DemandProxy_AirLoop::SimFlowFitting_Name_optional& SimFlowFitting_FlowElementProxy_DemandProxy_AirLoop::
      SimFlowFitting_Name ()
      {
        return this->SimFlowFitting_Name_;
      }
