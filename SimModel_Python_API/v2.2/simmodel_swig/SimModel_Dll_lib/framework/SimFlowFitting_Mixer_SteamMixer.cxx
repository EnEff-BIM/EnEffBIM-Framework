...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowFitting_Mixer_SteamMixer::SimFlowFitting_Name_optional& SimFlowFitting_Mixer_SteamMixer::
      SimFlowFitting_Name () const
      {
        return this->SimFlowFitting_Name_;
      }

      SimFlowFitting_Mixer_SteamMixer::SimFlowFitting_Name_optional& SimFlowFitting_Mixer_SteamMixer::
      SimFlowFitting_Name ()
      {
        return this->SimFlowFitting_Name_;
      }
