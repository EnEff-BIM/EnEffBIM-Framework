...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      ...
      const SimDaylightingAssembly_DaylightingAssembly_LightTube::SimDaylightingAssembly_Name_optional& SimDaylightingAssembly_DaylightingAssembly_LightTube::
      SimDaylightingAssembly_Name () const
      {
        return this->SimDaylightingAssembly_Name_;
      }

      SimDaylightingAssembly_DaylightingAssembly_LightTube::SimDaylightingAssembly_Name_optional& SimDaylightingAssembly_DaylightingAssembly_LightTube::
    ...
    namespace BuildingModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimDaylightingAssembly_DomeName
          //
          if (n.name () == "SimDaylightingAssembly_DomeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimDaylightingAssembly_DiffuserName
          //
          if (n.name () == "SimDaylightingAssembly_DiffuserName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimDaylightingAssembly_Diam
          //
          if (n.name () == "SimDaylightingAssembly_Diam" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimDaylightingAssembly_TotalLength
          //
          if (n.name () == "SimDaylightingAssembly_TotalLength" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimDaylightingAssembly_EffecThermalResist
          //
          if (n.name () == "SimDaylightingAssembly_EffecThermalResist" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimDaylightingAssembly_TransitionZoneName_1_4
          //
          if (n.name () == "SimDaylightingAssembly_TransitionZoneName_1_4" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimDaylightingAssembly_TransitionZoneLength_1_4
          //
          if (n.name () == "SimDaylightingAssembly_TransitionZoneLength_1_4" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
