...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeometry
    {
      ...
      const SimPerformanceCurve_Mathematical_QuadLinear::SimPerfCurve_InputUnitTypeForX_optional& SimPerformanceCurve_Mathematical_QuadLinear::
      SimPerfCurve_InputUnitTypeForX () const
      {
        return this->SimPerfCurve_InputUnitTypeForX_;
      }

      SimPerformanceCurve_Mathematical_QuadLinear::SimPerfCurve_InputUnitTypeForX_optional& SimPerformanceCurve_Mathematical_QuadLinear::
    ...
    namespace ResourcesGeometry
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimPerfCurve_Coefficient2w
          //
          if (n.name () == "SimPerfCurve_Coefficient2w" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // SimPerfCurve_Coefficient5z
          //
          if (n.name () == "SimPerfCurve_Coefficient5z" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // SimPerfCurve_MinValueofw
          //
          if (n.name () == "SimPerfCurve_MinValueofw" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // SimPerfCurve_MaxValueofw
          //
          if (n.name () == "SimPerfCurve_MaxValueofw" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // SimPerfCurve_InputUnitTypeforw
          //
          if (n.name () == "SimPerfCurve_InputUnitTypeforw" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
