...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      ...
      SimExtendedMaterialProps_ExtendedMatlProps_Default::
      SimExtendedMaterialProps_ExtendedMatlProps_Default ()
      : ::schema::simxml::ResourcesGeneral::SimExtendedMaterialProps_ExtendedMatlProps ()
      {
      }

      SimExtendedMaterialProps_ExtendedMatlProps_Default::
      SimExtendedMaterialProps_ExtendedMatlProps_Default (const RefId_type& RefId)
      : ::schema::simxml::ResourcesGeneral::SimExtendedMaterialProps_ExtendedMatlProps (RefId)
      {
      }
      ...
      : ::schema::simxml::ResourcesGeneral::SimExtendedMaterialProps_ExtendedMatlProps (x, f, c)
      {
      }
      ...
      SimExtendedMaterialProps_ExtendedMatlProps_Default (const ::xercesc::DOMElement& e,
                                                          ::xml_schema::flags f,
                                                          ::xml_schema::container* c)
      : ::schema::simxml::ResourcesGeneral::SimExtendedMaterialProps_ExtendedMatlProps (e, f, c)
      {
      }
