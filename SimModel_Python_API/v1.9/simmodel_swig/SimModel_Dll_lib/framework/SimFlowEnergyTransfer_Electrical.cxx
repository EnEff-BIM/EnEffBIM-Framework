...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowEnergyTransfer_Electrical::SimFlowEnergyTrans_Name_optional& SimFlowEnergyTransfer_Electrical::
      SimFlowEnergyTrans_Name () const
      {
        return this->SimFlowEnergyTrans_Name_;
      }

      SimFlowEnergyTransfer_Electrical::SimFlowEnergyTrans_Name_optional& SimFlowEnergyTransfer_Electrical::
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowEnergyTrans_RadiativeFract
          //
          if (n.name () == "SimFlowEnergyTrans_RadiativeFract" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_TransformUsage
          //
          if (n.name () == "SimFlowEnergyTrans_TransformUsage" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_Phase
          //
          if (n.name () == "SimFlowEnergyTrans_Phase" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_ConductorMaterial
          //
          if (n.name () == "SimFlowEnergyTrans_ConductorMaterial" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_FullLoadTemperatureRise
          //
          if (n.name () == "SimFlowEnergyTrans_FullLoadTemperatureRise" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_FractionOfEddyCurrentLosses
          //
          if (n.name () == "SimFlowEnergyTrans_FractionOfEddyCurrentLosses" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_RatedNoLoadLoss
          //
          if (n.name () == "SimFlowEnergyTrans_RatedNoLoadLoss" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_RatedLoadLoss
          //
          if (n.name () == "SimFlowEnergyTrans_RatedLoadLoss" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_NameplateEfficiency
          //
          if (n.name () == "SimFlowEnergyTrans_NameplateEfficiency" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_PerUnitLoadForNameplateEfficiency
          //
          if (n.name () == "SimFlowEnergyTrans_PerUnitLoadForNameplateEfficiency" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_RefTemperatureForNameplateEfficiency
          //
          if (n.name () == "SimFlowEnergyTrans_RefTemperatureForNameplateEfficiency" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_PerUnitLoadForMaxEfficiency
          //
          if (n.name () == "SimFlowEnergyTrans_PerUnitLoadForMaxEfficiency" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_ConsiderTransformLossForUtilityCost
          //
          if (n.name () == "SimFlowEnergyTrans_ConsiderTransformLossForUtilityCost" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_Meter_1_10_Name
          //
          if (n.name () == "SimFlowEnergyTrans_Meter_1_10_Name" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
