...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowPlant_SolarDevice_SolarThermalAir::SimFlowPlant_Name_optional& SimFlowPlant_SolarDevice_SolarThermalAir::
      SimFlowPlant_Name () const
      {
        return this->SimFlowPlant_Name_;
      }

      SimFlowPlant_SolarDevice_SolarThermalAir::SimFlowPlant_Name_optional& SimFlowPlant_SolarDevice_SolarThermalAir::
      SimFlowPlant_Name ()
      {
        return this->SimFlowPlant_Name_;
      }
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowPlant_BoundaryCondModelName
          //
          if (n.name () == "SimFlowPlant_BoundaryCondModelName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_SetpointNodeName
          //
          if (n.name () == "SimFlowPlant_SetpointNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_ZoneNodeName
          //
          if (n.name () == "SimFlowPlant_ZoneNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_FreeHeatingSetpointSchedName
          //
          if (n.name () == "SimFlowPlant_FreeHeatingSetpointSchedName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_DiamPerfCollect
          //
          if (n.name () == "SimFlowPlant_DiamPerfCollect" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_DistBetweenPerfCollect
          //
          if (n.name () == "SimFlowPlant_DistBetweenPerfCollect" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_ThermalEmisCollectSurf
          //
          if (n.name () == "SimFlowPlant_ThermalEmisCollectSurf" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_SolarAbsorbCollectSurf
          //
          if (n.name () == "SimFlowPlant_SolarAbsorbCollectSurf" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_EffecOverallHeightCollect
          //
          if (n.name () == "SimFlowPlant_EffecOverallHeightCollect" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_EffecGapThickPlenumBehindCollect
          //
          if (n.name () == "SimFlowPlant_EffecGapThickPlenumBehindCollect" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_EffecCrossSectionAreaPlenumBehindCollect
          //
          if (n.name () == "SimFlowPlant_EffecCrossSectionAreaPlenumBehindCollect" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_HoleLayoutPatternForPitch
          //
          if (n.name () == "SimFlowPlant_HoleLayoutPatternForPitch" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_HeatExchangeEffectCorrel
          //
          if (n.name () == "SimFlowPlant_HeatExchangeEffectCorrel" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_RatioActCollectSurfAreaToProjSurfArea
          //
          if (n.name () == "SimFlowPlant_RatioActCollectSurfAreaToProjSurfArea" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_RoughCollect
          //
          if (n.name () == "SimFlowPlant_RoughCollect" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_CollectThick
          //
          if (n.name () == "SimFlowPlant_CollectThick" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_EffectForPerfWithRespectToWind
          //
          if (n.name () == "SimFlowPlant_EffectForPerfWithRespectToWind" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_DischargeCoefForOpngsBuoyancyDrivenFlow
          //
          if (n.name () == "SimFlowPlant_DischargeCoefForOpngsBuoyancyDrivenFlow" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_SurfName_1_10
          //
          if (n.name () == "SimFlowPlant_SurfName_1_10" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
