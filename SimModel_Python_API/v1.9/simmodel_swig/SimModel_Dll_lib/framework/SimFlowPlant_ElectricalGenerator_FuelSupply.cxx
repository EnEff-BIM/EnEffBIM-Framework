...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowPlant_ElectricalGenerator_FuelSupply::SimFlowPlant_Name_optional& SimFlowPlant_ElectricalGenerator_FuelSupply::
      SimFlowPlant_Name () const
      {
        return this->SimFlowPlant_Name_;
      }

      SimFlowPlant_ElectricalGenerator_FuelSupply::SimFlowPlant_Name_optional& SimFlowPlant_ElectricalGenerator_FuelSupply::
      SimFlowPlant_Name ()
      {
        return this->SimFlowPlant_Name_;
      }
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowPlant_FuelTempModelingMode
          //
          if (n.name () == "SimFlowPlant_FuelTempModelingMode" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_FuelTempRefNodeName
          //
          if (n.name () == "SimFlowPlant_FuelTempRefNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_FuelTempSchedName
          //
          if (n.name () == "SimFlowPlant_FuelTempSchedName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_CompPwrFuncFuelRateCurveName
          //
          if (n.name () == "SimFlowPlant_CompPwrFuncFuelRateCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_CompHeatLossFactor
          //
          if (n.name () == "SimFlowPlant_CompHeatLossFactor" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_LiqGenericFuelLowHeatingVal
          //
          if (n.name () == "SimFlowPlant_LiqGenericFuelLowHeatingVal" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_LiqGenericFuelHigherHeatingVal
          //
          if (n.name () == "SimFlowPlant_LiqGenericFuelHigherHeatingVal" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_LiqGenericFuelMolecularWeight
          //
          if (n.name () == "SimFlowPlant_LiqGenericFuelMolecularWeight" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_LiqGenericFuelCO2EmissionFactor
          //
          if (n.name () == "SimFlowPlant_LiqGenericFuelCO2EmissionFactor" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_NumConstsGaseousConstFuelSupply
          //
          if (n.name () == "SimFlowPlant_NumConstsGaseousConstFuelSupply" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_ConstName_1_12
          //
          if (n.name () == "SimFlowPlant_ConstName_1_12" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_ConstMolarFract_1_12
          //
          if (n.name () == "SimFlowPlant_ConstMolarFract_1_12" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
