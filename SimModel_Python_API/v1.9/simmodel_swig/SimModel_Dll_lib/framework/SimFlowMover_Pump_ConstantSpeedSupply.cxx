...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowMover_Pump_ConstantSpeedSupply::SimFlowMover_Name_optional& SimFlowMover_Pump_ConstantSpeedSupply::
      SimFlowMover_Name () const
      {
        return this->SimFlowMover_Name_;
      }

      SimFlowMover_Pump_ConstantSpeedSupply::SimFlowMover_Name_optional& SimFlowMover_Pump_ConstantSpeedSupply::
      SimFlowMover_Name ()
      {
        return this->SimFlowMover_Name_;
      }
