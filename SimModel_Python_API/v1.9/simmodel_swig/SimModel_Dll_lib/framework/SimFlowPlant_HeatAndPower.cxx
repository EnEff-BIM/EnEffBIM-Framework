...
#include "SimFlowPlant_HeatAndPower.hxx"
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      // SimFlowPlant_HeatAndPower
      // 

      const SimFlowPlant_HeatAndPower::Representation_optional& SimFlowPlant_HeatAndPower::
      Representation () const
      {
        return this->Representation_;
      }

      SimFlowPlant_HeatAndPower::Representation_optional& SimFlowPlant_HeatAndPower::
      Representation ()
      {
        return this->Representation_;
      }

      void SimFlowPlant_HeatAndPower::
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowPlant_HeatAndPower::
      SimFlowPlant_HeatAndPower (const RefId_type& RefId)
      ...
      SimFlowPlant_HeatAndPower::
      SimFlowPlant_HeatAndPower (const SimFlowPlant_HeatAndPower& x,
                                 ::xml_schema::flags f,
      ...
      SimFlowPlant_HeatAndPower::
      SimFlowPlant_HeatAndPower (const ::xercesc::DOMElement& e,
                                 ::xml_schema::flags f,
                                 ::xml_schema::container* c)
      ...
      SimFlowPlant_HeatAndPower* SimFlowPlant_HeatAndPower::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowPlant_HeatAndPower (*this, f, c);
      }

      SimFlowPlant_HeatAndPower& SimFlowPlant_HeatAndPower::
      operator= (const SimFlowPlant_HeatAndPower& x)
      {
        if (this != &x)
        {
