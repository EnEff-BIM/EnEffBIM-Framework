...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowPlant_ElectricalGenerator_WindTurbine::SimFlowPlant_Name_optional& SimFlowPlant_ElectricalGenerator_WindTurbine::
      SimFlowPlant_Name () const
      {
        return this->SimFlowPlant_Name_;
      }

      SimFlowPlant_ElectricalGenerator_WindTurbine::SimFlowPlant_Name_optional& SimFlowPlant_ElectricalGenerator_WindTurbine::
      SimFlowPlant_Name ()
      {
        return this->SimFlowPlant_Name_;
      }
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowPlant_RotorType
          //
          if (n.name () == "SimFlowPlant_RotorType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_PwrCntl
          //
          if (n.name () == "SimFlowPlant_PwrCntl" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_RatedRotorSpeed
          //
          if (n.name () == "SimFlowPlant_RatedRotorSpeed" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_RotorDiam
          //
          if (n.name () == "SimFlowPlant_RotorDiam" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_OverallHeight
          //
          if (n.name () == "SimFlowPlant_OverallHeight" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_NumBlades
          //
          if (n.name () == "SimFlowPlant_NumBlades" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_RatedPwr
          //
          if (n.name () == "SimFlowPlant_RatedPwr" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_RatedWindSpeed
          //
          if (n.name () == "SimFlowPlant_RatedWindSpeed" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_CutWindSpeed
          //
          if (n.name () == "SimFlowPlant_CutWindSpeed" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_CutOutWindSpeed
          //
          if (n.name () == "SimFlowPlant_CutOutWindSpeed" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_FractSysEff
          //
          if (n.name () == "SimFlowPlant_FractSysEff" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_MaxTipSpeedRatio
          //
          if (n.name () == "SimFlowPlant_MaxTipSpeedRatio" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_MaxPwrCoef
          //
          if (n.name () == "SimFlowPlant_MaxPwrCoef" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_AnnualLocalAverageWindSpeed
          //
          if (n.name () == "SimFlowPlant_AnnualLocalAverageWindSpeed" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_HeightForLocalAverageWindSpeed
          //
          if (n.name () == "SimFlowPlant_HeightForLocalAverageWindSpeed" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_BladeChordArea
          //
          if (n.name () == "SimFlowPlant_BladeChordArea" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_BladeDragCoef
          //
          if (n.name () == "SimFlowPlant_BladeDragCoef" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_BladeLiftCoef
          //
          if (n.name () == "SimFlowPlant_BladeLiftCoef" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_PowerCoeffC_1_6
          //
          if (n.name () == "SimFlowPlant_PowerCoeffC_1_6" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
