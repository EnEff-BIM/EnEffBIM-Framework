    ...
    namespace SimModelCore
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // ControlledBy
          //
          if (n.name () == "ControlledBy" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/SimModelCore")
          {
          ...
          // _3dLength
          //
          if (n.name () == "_3dLength" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/SimModelCore")
          {
            if (!this->_3dLength_)
            {
          ...
          // _3dWidth
          //
          if (n.name () == "_3dWidth" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/SimModelCore")
          {
            if (!this->_3dWidth_)
            {
          ...
          // _3dHeight
          //
          if (n.name () == "_3dHeight" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/SimModelCore")
          {
            if (!this->_3dHeight_)
            {
