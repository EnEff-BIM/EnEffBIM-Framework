    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SolarObstructionType
          //
          if (n.name () == "SolarObstructionType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SolarObstructionShape
          //
          if (n.name () == "SolarObstructionShape" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
