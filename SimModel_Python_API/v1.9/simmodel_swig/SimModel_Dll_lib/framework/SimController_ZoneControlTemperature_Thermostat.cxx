...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimController_ZoneControlTemperature_Thermostat::ZoneCont_Tstat_TempAndHumid_ThermostatName_optional& SimController_ZoneControlTemperature_Thermostat::
      ZoneCont_Tstat_TempAndHumid_ThermostatName () const
      {
        return this->ZoneCont_Tstat_TempAndHumid_ThermostatName_;
      }

      SimController_ZoneControlTemperature_Thermostat::ZoneCont_Tstat_TempAndHumid_ThermostatName_optional& SimController_ZoneControlTemperature_Thermostat::
