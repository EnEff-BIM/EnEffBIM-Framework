...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      // SimFlowPlant_Chiller
      // 

      const SimFlowPlant_Chiller::Representation_optional& SimFlowPlant_Chiller::
      Representation () const
      {
        return this->Representation_;
      }

      SimFlowPlant_Chiller::Representation_optional& SimFlowPlant_Chiller::
      Representation ()
      {
        return this->Representation_;
      }

      void SimFlowPlant_Chiller::
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowPlant_Chiller::
      SimFlowPlant_Chiller (const RefId_type& RefId)
      ...
      SimFlowPlant_Chiller::
      SimFlowPlant_Chiller (const SimFlowPlant_Chiller& x,
                            ::xml_schema::flags f,
      ...
      SimFlowPlant_Chiller::
      SimFlowPlant_Chiller (const ::xercesc::DOMElement& e,
                            ::xml_schema::flags f,
                            ::xml_schema::container* c)
      ...
      SimFlowPlant_Chiller* SimFlowPlant_Chiller::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowPlant_Chiller (*this, f, c);
      }

      SimFlowPlant_Chiller& SimFlowPlant_Chiller::
      operator= (const SimFlowPlant_Chiller& x)
      {
        if (this != &x)
        {
