...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowTerminal_AirTerminal_AirTerminal_DualDuct_ConstantVolume::SimFlowTerm_Name_optional& SimFlowTerminal_AirTerminal_AirTerminal_DualDuct_ConstantVolume::
      SimFlowTerm_Name () const
      {
        return this->SimFlowTerm_Name_;
      }

      SimFlowTerminal_AirTerminal_AirTerminal_DualDuct_ConstantVolume::SimFlowTerm_Name_optional& SimFlowTerminal_AirTerminal_AirTerminal_DualDuct_ConstantVolume::
      SimFlowTerm_Name ()
      {
        return this->SimFlowTerm_Name_;
      }
