...
#ifndef SIM_SLAB_FLOOR_FLOOR_OVER_EARTH_DETAILED_HXX
#define SIM_SLAB_FLOOR_FLOOR_OVER_EARTH_DETAILED_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimSlab_Floor_FloorOverEarthDetailed: public ::schema::simxml::BuildingModel::SimSlab_Floor
      {
        public:
        ...
        SimSlab_Floor_FloorOverEarthDetailed (const RefId_type&);
        ...
        virtual SimSlab_Floor_FloorOverEarthDetailed*
...
#endif // SIM_SLAB_FLOOR_FLOOR_OVER_EARTH_DETAILED_HXX
