    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimCost_Type
          //
          if (n.name () == "SimCost_Type" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCost_LineItemType
          //
          if (n.name () == "SimCost_LineItemType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCost_ItemName
          //
          if (n.name () == "SimCost_ItemName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCost_ObjEndUseKey
          //
          if (n.name () == "SimCost_ObjEndUseKey" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCost_CostPerEach
          //
          if (n.name () == "SimCost_CostPerEach" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCost_CostPerArea
          //
          if (n.name () == "SimCost_CostPerArea" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCost_CostPerUnitOutputCap
          //
          if (n.name () == "SimCost_CostPerUnitOutputCap" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCost_CostPerUnitOutputCapPerCOP
          //
          if (n.name () == "SimCost_CostPerUnitOutputCapPerCOP" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCost_CostPerVol
          //
          if (n.name () == "SimCost_CostPerVol" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCost_CostPerVolRate
          //
          if (n.name () == "SimCost_CostPerVolRate" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCost_CostPerEnergyPerTempDiff
          //
          if (n.name () == "SimCost_CostPerEnergyPerTempDiff" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCost_Quantity
          //
          if (n.name () == "SimCost_Quantity" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
