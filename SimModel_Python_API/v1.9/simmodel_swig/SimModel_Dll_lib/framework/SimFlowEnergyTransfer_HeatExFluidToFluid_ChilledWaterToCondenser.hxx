...
#ifndef SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_CHILLED_WATER_TO_CONDENSER_HXX
#define SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_CHILLED_WATER_TO_CONDENSER_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatExFluidToFluid_ChilledWaterToCondenser;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatExFluidToFluid_ChilledWaterToCondenser: public ::schema::simxml::MepModel::SimFlowEnergyTransfer_HeatExFluidToFluid
      {
        public:
        ...
        SimFlowEnergyTransfer_HeatExFluidToFluid_ChilledWaterToCondenser (const RefId_type&);
        ...
        virtual SimFlowEnergyTransfer_HeatExFluidToFluid_ChilledWaterToCondenser*
...
#endif // SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_CHILLED_WATER_TO_CONDENSER_HXX
