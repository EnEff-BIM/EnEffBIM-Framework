...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowCompoundEqmt_UnitaryZoneEqmt_OutdoorAirUnit: public ::schema::simxml::MepModel::SimFlowCompoundEqmt_UnitaryZoneEqmt
      {
        public:
        ...
        //
        typedef ::xml_schema::string ZoneHvac_OutdrAirUnit_EquipList_Name_type;
        typedef ::xsd::cxx::tree::optional< ZoneHvac_OutdrAirUnit_EquipList_Name_type > ZoneHvac_OutdrAirUnit_EquipList_Name_optional;
        typedef ::xsd::cxx::tree::traits< ZoneHvac_OutdrAirUnit_EquipList_Name_type, char > ZoneHvac_OutdrAirUnit_EquipList_Name_traits;

        const ZoneHvac_OutdrAirUnit_EquipList_Name_optional&
        ZoneHvac_OutdrAirUnit_EquipList_Name () const;

        ZoneHvac_OutdrAirUnit_EquipList_Name_optional&
        ZoneHvac_OutdrAirUnit_EquipList_Name ();
        ...
        void
        ZoneHvac_OutdrAirUnit_EquipList_Name (::std::auto_ptr< ZoneHvac_OutdrAirUnit_EquipList_Name_type > p);

        // ZoneHvac_OutdrAirUnit_EquipList_ComponentObjectType_1_8
        //
        typedef ::schema::simxml::MepModel::ZoneHvac_OutdrAirUnit_EquipList_ComponentObjectType_1_8 ZoneHvac_OutdrAirUnit_EquipList_ComponentObjectType_1_8_type;
        ...
        ZoneHvac_OutdrAirUnit_EquipList_Name_optional ZoneHvac_OutdrAirUnit_EquipList_Name_;
