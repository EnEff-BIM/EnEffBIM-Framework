    ...
    namespace BuildingModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimList_MeterName
          //
          if (n.name () == "SimList_MeterName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimList_DemandLimitSchedName
          //
          if (n.name () == "SimList_DemandLimitSchedName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimList_DemandLimitSafetyFrac
          //
          if (n.name () == "SimList_DemandLimitSafetyFrac" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimList_BillingPerSchedName
          //
          if (n.name () == "SimList_BillingPerSchedName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimList_PeakPerSchedName
          //
          if (n.name () == "SimList_PeakPerSchedName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimList_DemandWindLength
          //
          if (n.name () == "SimList_DemandWindLength" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimList_DemandMngrPrio
          //
          if (n.name () == "SimList_DemandMngrPrio" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimList_DemandMngr_1_10_ObjectType
          //
          if (n.name () == "SimList_DemandMngr_1_10_ObjectType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimList_DemandMngr_1_10_Name
          //
          if (n.name () == "SimList_DemandMngr_1_10_Name" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
