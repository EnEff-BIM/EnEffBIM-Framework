    ...
    namespace BuildingModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // BeamLength
          //
          if (n.name () == "BeamLength" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
            if (!this->BeamLength_)
            {
          ...
          // BeamWidth
          //
          if (n.name () == "BeamWidth" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
            if (!this->BeamWidth_)
            {
          ...
          // BeamDepth
          //
          if (n.name () == "BeamDepth" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
            if (!this->BeamDepth_)
            {
          ...
          // BeamNetSurfaceAreaExtrudedSides
          //
          if (n.name () == "BeamNetSurfaceAreaExtrudedSides" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // BeamCrossSectionArea
          //
          if (n.name () == "BeamCrossSectionArea" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // BeamGrossVolume
          //
          if (n.name () == "BeamGrossVolume" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // BeamNetVolume
          //
          if (n.name () == "BeamNetVolume" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // VoidsInBeam
          //
          if (n.name () == "VoidsInBeam" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
