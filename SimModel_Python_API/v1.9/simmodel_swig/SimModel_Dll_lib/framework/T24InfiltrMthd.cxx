...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      ...
      const T24InfiltrMthd::stringItem_sequence& T24InfiltrMthd::
      stringItem () const
      {
        return this->stringItem_;
      }

      T24InfiltrMthd::stringItem_sequence& T24InfiltrMthd::
      stringItem ()
      {
        return this->stringItem_;
      }
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      ...
      T24InfiltrMthd* T24InfiltrMthd::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class T24InfiltrMthd (*this, f, c);
      }
