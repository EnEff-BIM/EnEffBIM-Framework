...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      ...
      SimSystem_RefrigerationSecondary_FullSystem::
      SimSystem_RefrigerationSecondary_FullSystem ()
      : ::schema::simxml::BuildingModel::SimSystem_RefrigerationSecondary (),
      ...
      : ::schema::simxml::BuildingModel::SimSystem_RefrigerationSecondary (RefId),
        SimSys_RefrigCaseWalkinCaseAndWalkInListName_ (this),
        SimSys_EndUseSubCat_ (this),
        SimSys_CircFluidType_ (this),
        SimSys_CircFluidName_ (this),
      ...
      : ::schema::simxml::BuildingModel::SimSystem_RefrigerationSecondary (x, f, c),
      ...
      SimSystem_RefrigerationSecondary_FullSystem (const ::xercesc::DOMElement& e,
                                                   ::xml_schema::flags f,
                                                   ::xml_schema::container* c)
      : ::schema::simxml::BuildingModel::SimSystem_RefrigerationSecondary (e, f | ::xml_schema::flags::base, c),
        SimSys_RefrigCaseWalkinCaseAndWalkInListName_ (this),
        SimSys_EndUseSubCat_ (this),
        SimSys_CircFluidType_ (this),
        SimSys_CircFluidName_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::schema::simxml::BuildingModel::SimSystem_RefrigerationSecondary::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimSys_RefrigCaseWalkinCaseAndWalkInListName
          //
          if (n.name () == "SimSys_RefrigCaseWalkinCaseAndWalkInListName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_CircFluidType
          //
          if (n.name () == "SimSys_CircFluidType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_CircFluidName
          //
          if (n.name () == "SimSys_CircFluidName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_EvapCapacity
          //
          if (n.name () == "SimSys_EvapCapacity" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_EvapFlowRateSecndFluid
          //
          if (n.name () == "SimSys_EvapFlowRateSecndFluid" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_EvapEvaporatingTemp
          //
          if (n.name () == "SimSys_EvapEvaporatingTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_EvapApproachTempDiff
          //
          if (n.name () == "SimSys_EvapApproachTempDiff" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_EvapRangeTempDiff
          //
          if (n.name () == "SimSys_EvapRangeTempDiff" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_NumbPumpsInLoop
          //
          if (n.name () == "SimSys_NumbPumpsInLoop" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_TotalPumpFlowRate
          //
          if (n.name () == "SimSys_TotalPumpFlowRate" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_TotalPumpPower
          //
          if (n.name () == "SimSys_TotalPumpPower" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_TotalPumpHead
          //
          if (n.name () == "SimSys_TotalPumpHead" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_PhaseChangeCircRate
          //
          if (n.name () == "SimSys_PhaseChangeCircRate" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_PumpDriveType
          //
          if (n.name () == "SimSys_PumpDriveType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_VarSpdPumpCubicCurveName
          //
          if (n.name () == "SimSys_VarSpdPumpCubicCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_PumpMotorHeatToFluid
          //
          if (n.name () == "SimSys_PumpMotorHeatToFluid" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_SumUADistPiping
          //
          if (n.name () == "SimSys_SumUADistPiping" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_DistPipingZoneName
          //
          if (n.name () == "SimSys_DistPipingZoneName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_SumUARecvr_SepShell
          //
          if (n.name () == "SimSys_SumUARecvr_SepShell" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_Recvr_SepZoneName
          //
          if (n.name () == "SimSys_Recvr_SepZoneName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // SimSys_EvapRefrigInventory
          //
          if (n.name () == "SimSys_EvapRefrigInventory" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
      ...
      operator= (const SimSystem_RefrigerationSecondary_FullSystem& x)
      {
        if (this != &x)
        {
          static_cast< ::schema::simxml::BuildingModel::SimSystem_RefrigerationSecondary& > (*this) = x;
