...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimController_OperationManager_PlantLoop::SimCntrl_Name_optional& SimController_OperationManager_PlantLoop::
      SimCntrl_Name () const
      {
        return this->SimCntrl_Name_;
      }

      SimController_OperationManager_PlantLoop::SimCntrl_Name_optional& SimController_OperationManager_PlantLoop::
      SimCntrl_Name ()
      {
        return this->SimCntrl_Name_;
      }

      void SimController_OperationManager_PlantLoop::
      ...
      const SimController_OperationManager_PlantLoop::SimCntrl_ControllerScheme_1_optional& SimController_OperationManager_PlantLoop::
      SimCntrl_ControllerScheme_1 () const
      {
        return this->SimCntrl_ControllerScheme_1_;
      }

      SimController_OperationManager_PlantLoop::SimCntrl_ControllerScheme_1_optional& SimController_OperationManager_PlantLoop::
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimController_OperationManager_PlantLoop::
      SimController_OperationManager_PlantLoop (const RefId_type& RefId)
      ...
      SimController_OperationManager_PlantLoop::
      SimController_OperationManager_PlantLoop (const SimController_OperationManager_PlantLoop& x,
                                                ::xml_schema::flags f,
      ...
      SimController_OperationManager_PlantLoop::
      SimController_OperationManager_PlantLoop (const ::xercesc::DOMElement& e,
                                                ::xml_schema::flags f,
                                                ::xml_schema::container* c)
      : ::schema::simxml::MepModel::SimController_OperationManager (e, f | ::xml_schema::flags::base, c),
        SimCntrl_Name_ (this),
        SimCntrl_ControllerScheme_1_ (this)
      {
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::schema::simxml::MepModel::SimController_OperationManager::parse (p, f);
      ...
      SimController_OperationManager_PlantLoop* SimController_OperationManager_PlantLoop::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimController_OperationManager_PlantLoop (*this, f, c);
      }

      SimController_OperationManager_PlantLoop& SimController_OperationManager_PlantLoop::
      operator= (const SimController_OperationManager_PlantLoop& x)
      {
        if (this != &x)
        {
          static_cast< ::schema::simxml::MepModel::SimController_OperationManager& > (*this) = x;
