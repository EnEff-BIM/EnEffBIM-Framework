...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatingCoilWater_CoilAirHeatingWaterToAirHeatPumpEquationFit: public ::schema::simxml::MepModel::SimFlowEnergyTransfer_HeatingCoilWater
      {
        public:
        ...
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimFlowEnergyTrans_HeatingCapCoef_1_5_type;
        ...
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimFlowEnergyTrans_HeatingPwrConsumpCoef_1_5_type;
