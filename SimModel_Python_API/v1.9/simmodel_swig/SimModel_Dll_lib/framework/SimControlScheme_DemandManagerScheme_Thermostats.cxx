    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimCntrlSchm_ResetCntl
          //
          if (n.name () == "SimCntrlSchm_ResetCntl" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_MinResetDuration
          //
          if (n.name () == "SimCntrlSchm_MinResetDuration" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_MaxHeatingSetpointReset
          //
          if (n.name () == "SimCntrlSchm_MaxHeatingSetpointReset" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_MaxCoolingSetpointReset
          //
          if (n.name () == "SimCntrlSchm_MaxCoolingSetpointReset" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_ResetStepChange
          //
          if (n.name () == "SimCntrlSchm_ResetStepChange" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_ThermostatName_1_10
          //
          if (n.name () == "SimCntrlSchm_ThermostatName_1_10" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
