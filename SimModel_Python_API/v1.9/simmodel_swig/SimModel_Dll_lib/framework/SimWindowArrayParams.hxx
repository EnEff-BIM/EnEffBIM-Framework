...
#ifndef SIM_WINDOW_ARRAY_PARAMS_HXX
#define SIM_WINDOW_ARRAY_PARAMS_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimWindowArrayParams: public ::schema::simxml::ResourcesGeneral::SimArrayParams
      {
        public:
        // WindowTypeDef
        //
        ...
        void
        WindowTypeDef (::std::auto_ptr< WindowTypeDef_type > p);
        ...
        WindowOpeningProfilePath_optional&
        WindowOpeningProfilePath ();
        ...
        SimWindowArrayParams (const RefId_type&);
...
#endif // SIM_WINDOW_ARRAY_PARAMS_HXX
