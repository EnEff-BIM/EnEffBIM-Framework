...
#ifndef SIM_WALL_WALL_EXTERIOR_BELOW_GRADE_STANDARD_HXX
#define SIM_WALL_WALL_EXTERIOR_BELOW_GRADE_STANDARD_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimWall_Wall_ExteriorBelowGradeStandard;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimWall_Wall_ExteriorBelowGradeStandard: public ::schema::simxml::BuildingModel::SimWall_Wall
      {
        public:
        ...
        SimWall_Wall_ExteriorBelowGradeStandard (const RefId_type&);
        ...
        virtual SimWall_Wall_ExteriorBelowGradeStandard*
...
#endif // SIM_WALL_WALL_EXTERIOR_BELOW_GRADE_STANDARD_HXX
