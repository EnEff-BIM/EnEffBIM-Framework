...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimController_SupplyWater::SimCntrl_Name_optional& SimController_SupplyWater::
      SimCntrl_Name () const
      {
        return this->SimCntrl_Name_;
      }

      SimController_SupplyWater::SimCntrl_Name_optional& SimController_SupplyWater::
      SimCntrl_Name ()
      {
        return this->SimCntrl_Name_;
      }
