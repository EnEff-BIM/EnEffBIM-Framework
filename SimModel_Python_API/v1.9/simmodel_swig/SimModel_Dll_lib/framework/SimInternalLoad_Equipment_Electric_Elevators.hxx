...
#ifndef SIM_INTERNAL_LOAD_EQUIPMENT_ELECTRIC_ELEVATORS_HXX
#define SIM_INTERNAL_LOAD_EQUIPMENT_ELECTRIC_ELEVATORS_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimInternalLoad_Equipment_Electric_Elevators;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class SimInternalLoad_Equipment_Electric_Elevators: public ::schema::simxml::ResourcesGeneral::SimInternalLoad_Equipment
      {
        public:
        ...
        SimInternalLoad_Equipment_Electric_Elevators (const RefId_type&);
        ...
        virtual SimInternalLoad_Equipment_Electric_Elevators*
...
#endif // SIM_INTERNAL_LOAD_EQUIPMENT_ELECTRIC_ELEVATORS_HXX
