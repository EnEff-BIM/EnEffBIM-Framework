...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowCompoundEqmt_VavSubsystems::SimFlowCompEqmt_Name_optional& SimFlowCompoundEqmt_VavSubsystems::
      SimFlowCompEqmt_Name () const
      {
        return this->SimFlowCompEqmt_Name_;
      }

      SimFlowCompoundEqmt_VavSubsystems::SimFlowCompEqmt_Name_optional& SimFlowCompoundEqmt_VavSubsystems::
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowCompEqmt_SysAirFlowRateDuringCoolingOp
          //
          if (n.name () == "SimFlowCompEqmt_SysAirFlowRateDuringCoolingOp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_SysAirFlowRateDuringHeatingOp
          //
          if (n.name () == "SimFlowCompEqmt_SysAirFlowRateDuringHeatingOp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_SysAirFlowRateWhenNoCoolingOrHeatingNeeded
          //
          if (n.name () == "SimFlowCompEqmt_SysAirFlowRateWhenNoCoolingOrHeatingNeeded" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_OutdrAirFlowRateMultSchedName
          //
          if (n.name () == "SimFlowCompEqmt_OutdrAirFlowRateMultSchedName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_BypassDuctMixerNodeName
          //
          if (n.name () == "SimFlowCompEqmt_BypassDuctMixerNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_BypassDuctSplitterNodeName
          //
          if (n.name () == "SimFlowCompEqmt_BypassDuctSplitterNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_PriorityCntlMode
          //
          if (n.name () == "SimFlowCompEqmt_PriorityCntlMode" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MinOutletAirTempDuringCoolingOp
          //
          if (n.name () == "SimFlowCompEqmt_MinOutletAirTempDuringCoolingOp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MaxOutletAirTempDuringHeatingOp
          //
          if (n.name () == "SimFlowCompEqmt_MaxOutletAirTempDuringHeatingOp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
