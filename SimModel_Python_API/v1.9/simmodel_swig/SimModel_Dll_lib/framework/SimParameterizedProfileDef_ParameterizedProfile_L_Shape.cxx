    ...
    namespace ResourcesGeometry
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // Thickness
          //
          if (n.name () == "Thickness" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
            if (!this->Thickness_)
            {
          ...
          // LegSlope
          //
          if (n.name () == "LegSlope" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
            if (!this->LegSlope_)
            {
