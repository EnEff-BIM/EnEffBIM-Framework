...
#ifndef SIM_SLAB_FLOOR_FLOOR_OVER_AIR_DETAILED_HXX
#define SIM_SLAB_FLOOR_FLOOR_OVER_AIR_DETAILED_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimSlab_Floor_FloorOverAirDetailed: public ::schema::simxml::BuildingModel::SimSlab_Floor
      {
        public:
        ...
        SimSlab_Floor_FloorOverAirDetailed (const RefId_type&);
        ...
        virtual SimSlab_Floor_FloorOverAirDetailed*
...
#endif // SIM_SLAB_FLOOR_FLOOR_OVER_AIR_DETAILED_HXX
