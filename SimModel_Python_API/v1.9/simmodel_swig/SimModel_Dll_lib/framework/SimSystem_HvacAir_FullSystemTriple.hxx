...
#ifndef SIM_SYSTEM_HVAC_AIR_FULL_SYSTEM_TRIPLE_HXX
#define SIM_SYSTEM_HVAC_AIR_FULL_SYSTEM_TRIPLE_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimSystem_HvacAir_FullSystemTriple;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimSystem_HvacAir_FullSystemTriple: public ::schema::simxml::BuildingModel::SimSystem_HvacAir
      {
        public:
        // SimSys_ContListName
        //
        ...
        SimSystem_HvacAir_FullSystemTriple (const RefId_type&);
        ...
        virtual SimSystem_HvacAir_FullSystemTriple*
...
#endif // SIM_SYSTEM_HVAC_AIR_FULL_SYSTEM_TRIPLE_HXX
