...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      // SimFlowPlant_ElectricalGenerator
      // 

      const SimFlowPlant_ElectricalGenerator::Representation_optional& SimFlowPlant_ElectricalGenerator::
      Representation () const
      {
        return this->Representation_;
      }

      SimFlowPlant_ElectricalGenerator::Representation_optional& SimFlowPlant_ElectricalGenerator::
      Representation ()
      {
        return this->Representation_;
      }

      void SimFlowPlant_ElectricalGenerator::
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowPlant_ElectricalGenerator::
      SimFlowPlant_ElectricalGenerator (const RefId_type& RefId)
      ...
      SimFlowPlant_ElectricalGenerator::
      SimFlowPlant_ElectricalGenerator (const SimFlowPlant_ElectricalGenerator& x,
                                        ::xml_schema::flags f,
      ...
      SimFlowPlant_ElectricalGenerator::
      SimFlowPlant_ElectricalGenerator (const ::xercesc::DOMElement& e,
                                        ::xml_schema::flags f,
                                        ::xml_schema::container* c)
      ...
      SimFlowPlant_ElectricalGenerator* SimFlowPlant_ElectricalGenerator::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowPlant_ElectricalGenerator (*this, f, c);
      }

      SimFlowPlant_ElectricalGenerator& SimFlowPlant_ElectricalGenerator::
      operator= (const SimFlowPlant_ElectricalGenerator& x)
      {
        if (this != &x)
        {
