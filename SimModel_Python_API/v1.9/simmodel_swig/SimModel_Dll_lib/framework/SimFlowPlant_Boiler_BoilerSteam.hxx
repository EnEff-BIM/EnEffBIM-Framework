...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowPlant_Boiler_BoilerSteam: public ::schema::simxml::MepModel::SimFlowPlant_Boiler
      {
        public:
        // SimFlowPlant_Name
        //
        ...
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList_type;
