...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      // SimFlowPlant_SolarDevice
      // 

      const SimFlowPlant_SolarDevice::Representation_optional& SimFlowPlant_SolarDevice::
      Representation () const
      {
        return this->Representation_;
      }

      SimFlowPlant_SolarDevice::Representation_optional& SimFlowPlant_SolarDevice::
      Representation ()
      {
        return this->Representation_;
      }

      void SimFlowPlant_SolarDevice::
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowPlant_SolarDevice::
      SimFlowPlant_SolarDevice (const RefId_type& RefId)
      ...
      SimFlowPlant_SolarDevice::
      SimFlowPlant_SolarDevice (const SimFlowPlant_SolarDevice& x,
                                ::xml_schema::flags f,
      ...
      SimFlowPlant_SolarDevice::
      SimFlowPlant_SolarDevice (const ::xercesc::DOMElement& e,
                                ::xml_schema::flags f,
                                ::xml_schema::container* c)
      ...
      SimFlowPlant_SolarDevice* SimFlowPlant_SolarDevice::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowPlant_SolarDevice (*this, f, c);
      }

      SimFlowPlant_SolarDevice& SimFlowPlant_SolarDevice::
      operator= (const SimFlowPlant_SolarDevice& x)
      {
        if (this != &x)
        {
