...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowFitting_Splitter_SteamSplitter::SimFlowFitting_Name_optional& SimFlowFitting_Splitter_SteamSplitter::
      SimFlowFitting_Name () const
      {
        return this->SimFlowFitting_Name_;
      }

      SimFlowFitting_Splitter_SteamSplitter::SimFlowFitting_Name_optional& SimFlowFitting_Splitter_SteamSplitter::
      SimFlowFitting_Name ()
      {
        return this->SimFlowFitting_Name_;
      }

      void SimFlowFitting_Splitter_SteamSplitter::
      ...
      const SimFlowFitting_Splitter_SteamSplitter::SimFlowFitting_InletBranchName_optional& SimFlowFitting_Splitter_SteamSplitter::
      SimFlowFitting_InletBranchName () const
      {
        return this->SimFlowFitting_InletBranchName_;
      }

      SimFlowFitting_Splitter_SteamSplitter::SimFlowFitting_InletBranchName_optional& SimFlowFitting_Splitter_SteamSplitter::
      ...
      const SimFlowFitting_Splitter_SteamSplitter::SimFlowFitting_OutletBranch_1_500_Name_optional& SimFlowFitting_Splitter_SteamSplitter::
      SimFlowFitting_OutletBranch_1_500_Name () const
      {
        return this->SimFlowFitting_OutletBranch_1_500_Name_;
      }

      SimFlowFitting_Splitter_SteamSplitter::SimFlowFitting_OutletBranch_1_500_Name_optional& SimFlowFitting_Splitter_SteamSplitter::
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowFitting_Splitter_SteamSplitter::
      SimFlowFitting_Splitter_SteamSplitter (const RefId_type& RefId)
      ...
      SimFlowFitting_Splitter_SteamSplitter* SimFlowFitting_Splitter_SteamSplitter::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowFitting_Splitter_SteamSplitter (*this, f, c);
      }
