...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowCompoundEqmt_UnitaryZoneEqmt_IdealLoadsAirSystem::SimFlowCompEqmt_Name_optional& SimFlowCompoundEqmt_UnitaryZoneEqmt_IdealLoadsAirSystem::
      SimFlowCompEqmt_Name () const
      {
        return this->SimFlowCompEqmt_Name_;
      }

      SimFlowCompoundEqmt_UnitaryZoneEqmt_IdealLoadsAirSystem::SimFlowCompEqmt_Name_optional& SimFlowCompoundEqmt_UnitaryZoneEqmt_IdealLoadsAirSystem::
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowCompEqmt_ZoneSupAirNodeName
          //
          if (n.name () == "SimFlowCompEqmt_ZoneSupAirNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_ZoneExhaustAirNodeName
          //
          if (n.name () == "SimFlowCompEqmt_ZoneExhaustAirNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MaxHeatingSupplyAirTemp
          //
          if (n.name () == "SimFlowCompEqmt_MaxHeatingSupplyAirTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MinCoolSupplyAirTemp
          //
          if (n.name () == "SimFlowCompEqmt_MinCoolSupplyAirTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MaxHeatingSupplyAirHumdRatio
          //
          if (n.name () == "SimFlowCompEqmt_MaxHeatingSupplyAirHumdRatio" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MinCoolSupplyAirHumdRatio
          //
          if (n.name () == "SimFlowCompEqmt_MinCoolSupplyAirHumdRatio" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_HeatingLimit
          //
          if (n.name () == "SimFlowCompEqmt_HeatingLimit" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MaxHeatingAirFlowRate
          //
          if (n.name () == "SimFlowCompEqmt_MaxHeatingAirFlowRate" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MaxSensHeatingCap
          //
          if (n.name () == "SimFlowCompEqmt_MaxSensHeatingCap" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_CoolLimit
          //
          if (n.name () == "SimFlowCompEqmt_CoolLimit" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MaxCoolAirFlowRate
          //
          if (n.name () == "SimFlowCompEqmt_MaxCoolAirFlowRate" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MaxTotalCoolCap
          //
          if (n.name () == "SimFlowCompEqmt_MaxTotalCoolCap" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_HeatingAvailSchedName
          //
          if (n.name () == "SimFlowCompEqmt_HeatingAvailSchedName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_CoolAvailSchedName
          //
          if (n.name () == "SimFlowCompEqmt_CoolAvailSchedName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_CoolSensHeatRatio
          //
          if (n.name () == "SimFlowCompEqmt_CoolSensHeatRatio" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_HumdCtrlType
          //
          if (n.name () == "SimFlowCompEqmt_HumdCtrlType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_DesignSpecOutdrAirObjName
          //
          if (n.name () == "SimFlowCompEqmt_DesignSpecOutdrAirObjName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_DemandCtrlledVentilationType
          //
          if (n.name () == "SimFlowCompEqmt_DemandCtrlledVentilationType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_OutdoorAirEconomizerType
          //
          if (n.name () == "SimFlowCompEqmt_OutdoorAirEconomizerType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_HeatRecovType
          //
          if (n.name () == "SimFlowCompEqmt_HeatRecovType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_SensHeatRecovEffect
          //
          if (n.name () == "SimFlowCompEqmt_SensHeatRecovEffect" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_LatentHeatRecovEffect
          //
          if (n.name () == "SimFlowCompEqmt_LatentHeatRecovEffect" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
