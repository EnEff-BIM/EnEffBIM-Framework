...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowCompoundEqmt_UnitaryZoneEqmt_DehumidifierDX::SimFlowCompEqmt_Name_optional& SimFlowCompoundEqmt_UnitaryZoneEqmt_DehumidifierDX::
      SimFlowCompEqmt_Name () const
      {
        return this->SimFlowCompEqmt_Name_;
      }

      SimFlowCompoundEqmt_UnitaryZoneEqmt_DehumidifierDX::SimFlowCompEqmt_Name_optional& SimFlowCompoundEqmt_UnitaryZoneEqmt_DehumidifierDX::
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowCompEqmt_RatedWaterRemov
          //
          if (n.name () == "SimFlowCompEqmt_RatedWaterRemov" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_RatedEnergyFactor
          //
          if (n.name () == "SimFlowCompEqmt_RatedEnergyFactor" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_RatedAirFlowRate
          //
          if (n.name () == "SimFlowCompEqmt_RatedAirFlowRate" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_WaterRemovCurveName
          //
          if (n.name () == "SimFlowCompEqmt_WaterRemovCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_EnergyFactorCurveName
          //
          if (n.name () == "SimFlowCompEqmt_EnergyFactorCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_PartLoadFractCorrelCurveName
          //
          if (n.name () == "SimFlowCompEqmt_PartLoadFractCorrelCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MinDryBulbTempForDehumidifierOp
          //
          if (n.name () == "SimFlowCompEqmt_MinDryBulbTempForDehumidifierOp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MaxDryBulbTempForDehumidifierOp
          //
          if (n.name () == "SimFlowCompEqmt_MaxDryBulbTempForDehumidifierOp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_fCycleParasiticElecLoad
          //
          if (n.name () == "SimFlowCompEqmt_fCycleParasiticElecLoad" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_CondsCollectionWaterStorageTankName
          //
          if (n.name () == "SimFlowCompEqmt_CondsCollectionWaterStorageTankName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
