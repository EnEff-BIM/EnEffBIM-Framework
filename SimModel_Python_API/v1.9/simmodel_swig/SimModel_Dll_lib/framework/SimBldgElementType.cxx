...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      ...
      const SimBldgElementType::RepresentationMaps_optional& SimBldgElementType::
      RepresentationMaps () const
      {
        return this->RepresentationMaps_;
      }

      SimBldgElementType::RepresentationMaps_optional& SimBldgElementType::
      RepresentationMaps ()
      {
        return this->RepresentationMaps_;
      }

      void SimBldgElementType::
      ...
      const SimBldgElementType::Tag_optional& SimBldgElementType::
      Tag () const
      {
        return this->Tag_;
      }

      SimBldgElementType::Tag_optional& SimBldgElementType::
      Tag ()
      {
        return this->Tag_;
      }
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      ...
      SimBldgElementType::
      SimBldgElementType (const RefId_type& RefId)
      ...
      SimBldgElementType::
      SimBldgElementType (const SimBldgElementType& x,
                          ::xml_schema::flags f,
      ...
      SimBldgElementType::
      SimBldgElementType (const ::xercesc::DOMElement& e,
                          ::xml_schema::flags f,
                          ::xml_schema::container* c)
      ...
      SimBldgElementType* SimBldgElementType::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimBldgElementType (*this, f, c);
      }

      SimBldgElementType& SimBldgElementType::
      operator= (const SimBldgElementType& x)
      {
        if (this != &x)
        {
