...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowPlant_HeatPump_WaterToWater_ParameterEstimation_Cooling::SimFlowPlant_Name_optional& SimFlowPlant_HeatPump_WaterToWater_ParameterEstimation_Cooling::
      SimFlowPlant_Name () const
      {
        return this->SimFlowPlant_Name_;
      }

      SimFlowPlant_HeatPump_WaterToWater_ParameterEstimation_Cooling::SimFlowPlant_Name_optional& SimFlowPlant_HeatPump_WaterToWater_ParameterEstimation_Cooling::
      SimFlowPlant_Name ()
      {
        return this->SimFlowPlant_Name_;
      }
