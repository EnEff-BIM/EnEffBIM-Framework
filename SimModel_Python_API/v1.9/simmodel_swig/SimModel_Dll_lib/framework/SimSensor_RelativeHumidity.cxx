...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimSensor_RelativeHumidity::SimSensor_Name_optional& SimSensor_RelativeHumidity::
      SimSensor_Name () const
      {
        return this->SimSensor_Name_;
      }

      SimSensor_RelativeHumidity::SimSensor_Name_optional& SimSensor_RelativeHumidity::
      SimSensor_Name ()
      {
        return this->SimSensor_Name_;
      }
