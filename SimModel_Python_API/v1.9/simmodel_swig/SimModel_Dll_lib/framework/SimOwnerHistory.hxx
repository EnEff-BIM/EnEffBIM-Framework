...
#ifndef SIM_OWNER_HISTORY_HXX
#define SIM_OWNER_HISTORY_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimOwnerHistory: public ::schema::simxml::SimModelCore::SimResourceObject
      {
        public:
        // OwningUser
        //
        ...
        void
        OwningUser (::std::auto_ptr< OwningUser_type > p);
        ...
        void
        OwningApplication (::std::auto_ptr< OwningApplication_type > p);
        ...
        void
        ChangeAction (::std::auto_ptr< ChangeAction_type > p);
        ...
        void
        LastModifyingUser (::std::auto_ptr< LastModifyingUser_type > p);
        ...
        LastModifyingApplication_optional&
        LastModifyingApplication ();
        ...
        void
        LastModifyingApplication (::std::auto_ptr< LastModifyingApplication_type > p);
        ...
        SimOwnerHistory (const RefId_type&);
        ...
        protected:
        OwningUser_optional OwningUser_;
        OwningApplication_optional OwningApplication_;
        State_optional State_;
        ChangeAction_optional ChangeAction_;
        LastModifiedDate_optional LastModifiedDate_;
        LastModifyingUser_optional LastModifyingUser_;
        LastModifyingApplication_optional LastModifyingApplication_;
