...
#ifndef SIM_SLAB_FLOOR_INTERZONE_FLOOR_DETAILED_HXX
#define SIM_SLAB_FLOOR_INTERZONE_FLOOR_DETAILED_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimSlab_Floor_InterzoneFloorDetailed: public ::schema::simxml::BuildingModel::SimSlab_Floor
      {
        public:
        ...
        SimSlab_Floor_InterzoneFloorDetailed (const RefId_type&);
        ...
        virtual SimSlab_Floor_InterzoneFloorDetailed*
...
#endif // SIM_SLAB_FLOOR_INTERZONE_FLOOR_DETAILED_HXX
