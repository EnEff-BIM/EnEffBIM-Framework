...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowTerminal_AirTerminal_ParallelPIU_Reheat::SimFlowTerm_Name_optional& SimFlowTerminal_AirTerminal_ParallelPIU_Reheat::
      SimFlowTerm_Name () const
      {
        return this->SimFlowTerm_Name_;
      }

      SimFlowTerminal_AirTerminal_ParallelPIU_Reheat::SimFlowTerm_Name_optional& SimFlowTerminal_AirTerminal_ParallelPIU_Reheat::
      SimFlowTerm_Name ()
      {
        return this->SimFlowTerm_Name_;
      }
      ...
      const SimFlowTerminal_AirTerminal_ParallelPIU_Reheat::T24ConstructStatus2_optional& SimFlowTerminal_AirTerminal_ParallelPIU_Reheat::
      T24ConstructStatus2 () const
      {
        return this->T24ConstructStatus2_;
      }

      SimFlowTerminal_AirTerminal_ParallelPIU_Reheat::T24ConstructStatus2_optional& SimFlowTerminal_AirTerminal_ParallelPIU_Reheat::
      T24ConstructStatus2 ()
      {
        return this->T24ConstructStatus2_;
      }
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowTerm_MaxSecondAirFlowRate
          //
          if (n.name () == "SimFlowTerm_MaxSecondAirFlowRate" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowTerm_FanOnFlowFract
          //
          if (n.name () == "SimFlowTerm_FanOnFlowFract" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
