...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimRefrigerationSystemElement_Compressor::SimRefrigSysElem_Name_optional& SimRefrigerationSystemElement_Compressor::
      SimRefrigSysElem_Name () const
      {
        return this->SimRefrigSysElem_Name_;
      }

      SimRefrigerationSystemElement_Compressor::SimRefrigSysElem_Name_optional& SimRefrigerationSystemElement_Compressor::
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimRefrigSysElem_RefrigCompPwrCurveName
          //
          if (n.name () == "SimRefrigSysElem_RefrigCompPwrCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimRefrigSysElem_RefrigCompCapCurveName
          //
          if (n.name () == "SimRefrigSysElem_RefrigCompCapCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimRefrigSysElem_RatedSuperheat
          //
          if (n.name () == "SimRefrigSysElem_RatedSuperheat" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimRefrigSysElem_RatedRtnGasTemp
          //
          if (n.name () == "SimRefrigSysElem_RatedRtnGasTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimRefrigSysElem_RatedLiqTemp
          //
          if (n.name () == "SimRefrigSysElem_RatedLiqTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimRefrigSysElem_RatedSubcooling
          //
          if (n.name () == "SimRefrigSysElem_RatedSubcooling" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimRefrigSysElem_ModeofOperation
          //
          if (n.name () == "SimRefrigSysElem_ModeofOperation" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimRefrigSysElem_TranscriticalCompressPowerCurveName
          //
          if (n.name () == "SimRefrigSysElem_TranscriticalCompressPowerCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimRefrigSysElem_TranscriticalCompressCapCurveName
          //
          if (n.name () == "SimRefrigSysElem_TranscriticalCompressCapCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
