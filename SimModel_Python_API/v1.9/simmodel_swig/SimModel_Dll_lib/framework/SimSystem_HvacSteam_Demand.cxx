...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      ...
      const SimSystem_HvacSteam_Demand::SimSys_Branch_1_500_Name_optional& SimSystem_HvacSteam_Demand::
      SimSys_Branch_1_500_Name () const
      {
        return this->SimSys_Branch_1_500_Name_;
      }

      SimSystem_HvacSteam_Demand::SimSys_Branch_1_500_Name_optional& SimSystem_HvacSteam_Demand::
      SimSys_Branch_1_500_Name ()
      {
        return this->SimSys_Branch_1_500_Name_;
      }

      void SimSystem_HvacSteam_Demand::
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      ...
      SimSystem_HvacSteam_Demand::
      SimSystem_HvacSteam_Demand (const RefId_type& RefId)
      ...
      SimSystem_HvacSteam_Demand* SimSystem_HvacSteam_Demand::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimSystem_HvacSteam_Demand (*this, f, c);
      }
