...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      ...
      const SevereErrorMsgs::stringItem_sequence& SevereErrorMsgs::
      stringItem () const
      {
        return this->stringItem_;
      }

      SevereErrorMsgs::stringItem_sequence& SevereErrorMsgs::
      stringItem ()
      {
        return this->stringItem_;
      }

      void SevereErrorMsgs::
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      ...
      SevereErrorMsgs* SevereErrorMsgs::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SevereErrorMsgs (*this, f, c);
      }
