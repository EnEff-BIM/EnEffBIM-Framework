    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // DesignAlternative
          //
          if (n.name () == "DesignAlternative" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateSimulationParameters
          //
          if (n.name () == "TemplateSimulationParameters" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateReportSet
          //
          if (n.name () == "TemplateReportSet" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateOutputRequestSet
          //
          if (n.name () == "TemplateOutputRequestSet" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateOutputFormatSet
          //
          if (n.name () == "TemplateOutputFormatSet" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // CreatedBy
          //
          if (n.name () == "CreatedBy" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ReviewedBy
          //
          if (n.name () == "ReviewedBy" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
