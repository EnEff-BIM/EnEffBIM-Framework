...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimDaylightingAssembly_DaylightingAssembly_LightTube: public ::schema::simxml::BuildingModel::SimDaylightingAssembly_DaylightingAssembly
      {
        public:
        ...
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimDaylightingAssembly_TransitionZoneLength_1_4_type;
