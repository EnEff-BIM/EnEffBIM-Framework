    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // BuildingName
          //
          if (n.name () == "BuildingName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ContainingBldgSiteParams
          //
          if (n.name () == "ContainingBldgSiteParams" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ContainedBldgStoryParams
          //
          if (n.name () == "ContainedBldgStoryParams" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // GrossFloorAreaAllStories
          //
          if (n.name () == "GrossFloorAreaAllStories" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
