...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowPlant_ElectricalGenerator_CombustionTurbine::SimFlowPlant_Name_optional& SimFlowPlant_ElectricalGenerator_CombustionTurbine::
      SimFlowPlant_Name () const
      {
        return this->SimFlowPlant_Name_;
      }

      SimFlowPlant_ElectricalGenerator_CombustionTurbine::SimFlowPlant_Name_optional& SimFlowPlant_ElectricalGenerator_CombustionTurbine::
      SimFlowPlant_Name ()
      {
        return this->SimFlowPlant_Name_;
      }
      ...
      const SimFlowPlant_ElectricalGenerator_CombustionTurbine::SimFlowPlant_CoefUFactorTimesAreaCurve_1_2_optional& SimFlowPlant_ElectricalGenerator_CombustionTurbine::
      SimFlowPlant_CoefUFactorTimesAreaCurve_1_2 () const
      {
        return this->SimFlowPlant_CoefUFactorTimesAreaCurve_1_2_;
      }

      SimFlowPlant_ElectricalGenerator_CombustionTurbine::SimFlowPlant_CoefUFactorTimesAreaCurve_1_2_optional& SimFlowPlant_ElectricalGenerator_CombustionTurbine::
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowPlant_PartLoadBasedFuelInputCurveName
          //
          if (n.name () == "SimFlowPlant_PartLoadBasedFuelInputCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_TempBasedFuelInputCurveName
          //
          if (n.name () == "SimFlowPlant_TempBasedFuelInputCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_ExhFlowCurveName
          //
          if (n.name () == "SimFlowPlant_ExhFlowCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_PartLoadBasedExhTempCurveName
          //
          if (n.name () == "SimFlowPlant_PartLoadBasedExhTempCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_TempBasedExhTempCurveName
          //
          if (n.name () == "SimFlowPlant_TempBasedExhTempCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_HeatRecovLubeEnergyCurveName
          //
          if (n.name () == "SimFlowPlant_HeatRecovLubeEnergyCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_DesignAirInletTemp
          //
          if (n.name () == "SimFlowPlant_DesignAirInletTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
