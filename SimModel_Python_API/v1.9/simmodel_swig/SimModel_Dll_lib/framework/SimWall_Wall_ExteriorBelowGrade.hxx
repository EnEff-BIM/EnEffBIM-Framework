...
#ifndef SIM_WALL_WALL_EXTERIOR_BELOW_GRADE_HXX
#define SIM_WALL_WALL_EXTERIOR_BELOW_GRADE_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimWall_Wall_ExteriorBelowGrade;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimWall_Wall_ExteriorBelowGrade: public ::schema::simxml::BuildingModel::SimWall_Wall
      {
        public:
        ...
        SimWall_Wall_ExteriorBelowGrade (const RefId_type&);
        ...
        virtual SimWall_Wall_ExteriorBelowGrade*
...
#endif // SIM_WALL_WALL_EXTERIOR_BELOW_GRADE_HXX
