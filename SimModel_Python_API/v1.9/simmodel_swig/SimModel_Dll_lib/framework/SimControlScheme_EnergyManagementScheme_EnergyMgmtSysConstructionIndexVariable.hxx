...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class SimControlScheme_EnergyManagementScheme_EnergyMgmtSysConstructionIndexVariable: public ::schema::simxml::ResourcesGeneral::SimControlScheme_EnergyManagementScheme
      {
        public:
        // SimCntrlSchm_Name
        //
