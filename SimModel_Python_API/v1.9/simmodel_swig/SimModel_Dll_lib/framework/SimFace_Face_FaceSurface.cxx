...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeometry
    {
      ...
      SimFace_Face_FaceSurface::
      SimFace_Face_FaceSurface ()
      : ::schema::simxml::ResourcesGeometry::SimFace_Face (),
        FaceSurface_ (this),
        SameSense_ (this)
      {
      }
      ...
      : ::schema::simxml::ResourcesGeometry::SimFace_Face (RefId),
        FaceSurface_ (this),
        SameSense_ (this)
      {
      }
      ...
      : ::schema::simxml::ResourcesGeometry::SimFace_Face (x, f, c),
      ...
      SimFace_Face_FaceSurface (const ::xercesc::DOMElement& e,
                                ::xml_schema::flags f,
                                ::xml_schema::container* c)
      : ::schema::simxml::ResourcesGeometry::SimFace_Face (e, f | ::xml_schema::flags::base, c),
        FaceSurface_ (this),
        SameSense_ (this)
      {
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::schema::simxml::ResourcesGeometry::SimFace_Face::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // FaceSurface
          //
          if (n.name () == "FaceSurface" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
      ...
      operator= (const SimFace_Face_FaceSurface& x)
      {
        if (this != &x)
        {
          static_cast< ::schema::simxml::ResourcesGeometry::SimFace_Face& > (*this) = x;
