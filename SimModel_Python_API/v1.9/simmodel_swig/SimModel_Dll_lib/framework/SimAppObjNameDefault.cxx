    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // DefaultForObjectType
          //
          if (n.name () == "DefaultForObjectType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // NameString1
          //
          if (n.name () == "NameString1" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // NameString2
          //
          if (n.name () == "NameString2" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // IndexType1
          //
          if (n.name () == "IndexType1" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // IndexType2
          //
          if (n.name () == "IndexType2" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // LastUsedIndex1
          //
          if (n.name () == "LastUsedIndex1" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // LastUsedIndex2
          //
          if (n.name () == "LastUsedIndex2" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
