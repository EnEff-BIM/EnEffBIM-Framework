...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      ...
      const SimMaterial_OpaqueMaterial_InfraredTransparent::SimMaterial_Name_optional& SimMaterial_OpaqueMaterial_InfraredTransparent::
      SimMaterial_Name () const
      {
        return this->SimMaterial_Name_;
      }

      SimMaterial_OpaqueMaterial_InfraredTransparent::SimMaterial_Name_optional& SimMaterial_OpaqueMaterial_InfraredTransparent::
      SimMaterial_Name ()
      {
        return this->SimMaterial_Name_;
      }

      void SimMaterial_OpaqueMaterial_InfraredTransparent::
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      ...
      SimMaterial_OpaqueMaterial_InfraredTransparent::
      SimMaterial_OpaqueMaterial_InfraredTransparent (const RefId_type& RefId)
      ...
      SimMaterial_OpaqueMaterial_InfraredTransparent::
      SimMaterial_OpaqueMaterial_InfraredTransparent (const SimMaterial_OpaqueMaterial_InfraredTransparent& x,
                                                      ::xml_schema::flags f,
      ...
      SimMaterial_OpaqueMaterial_InfraredTransparent::
      SimMaterial_OpaqueMaterial_InfraredTransparent (const ::xercesc::DOMElement& e,
                                                      ::xml_schema::flags f,
                                                      ::xml_schema::container* c)
      ...
      SimMaterial_OpaqueMaterial_InfraredTransparent* SimMaterial_OpaqueMaterial_InfraredTransparent::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimMaterial_OpaqueMaterial_InfraredTransparent (*this, f, c);
      }

      SimMaterial_OpaqueMaterial_InfraredTransparent& SimMaterial_OpaqueMaterial_InfraredTransparent::
      operator= (const SimMaterial_OpaqueMaterial_InfraredTransparent& x)
      {
        if (this != &x)
        {
