...
#ifndef SIM_ACTUATOR_HXX
#define SIM_ACTUATOR_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimActuator: public ::schema::simxml::SimModelCore::SimDistributionControlElement
      {
        public:
        // Representation
        //
