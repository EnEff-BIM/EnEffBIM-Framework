...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      ...
      SimIrregularTimeSeries::
      SimIrregularTimeSeries ()
      : ::schema::simxml::SimModelCore::SimTimeSeries (),
        Name_ (this),
        StartTime_ (this),
        EndTime_ (this),
      ...
      : ::schema::simxml::SimModelCore::SimTimeSeries (RefId),
        Name_ (this),
        StartTime_ (this),
        EndTime_ (this),
        TimeSeriesDataType_ (this),
      ...
      : ::schema::simxml::SimModelCore::SimTimeSeries (x, f, c),
      ...
      SimIrregularTimeSeries (const ::xercesc::DOMElement& e,
                              ::xml_schema::flags f,
                              ::xml_schema::container* c)
      : ::schema::simxml::SimModelCore::SimTimeSeries (e, f | ::xml_schema::flags::base, c),
        Name_ (this),
        StartTime_ (this),
        EndTime_ (this),
        TimeSeriesDataType_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::schema::simxml::SimModelCore::SimTimeSeries::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // StartTime
          //
          if (n.name () == "StartTime" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // EndTime
          //
          if (n.name () == "EndTime" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TimeSeriesDataType
          //
          if (n.name () == "TimeSeriesDataType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // DataOrigin
          //
          if (n.name () == "DataOrigin" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // UserDefinedDataOrigin
          //
          if (n.name () == "UserDefinedDataOrigin" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // Values
          //
          if (n.name () == "Values" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
      ...
      operator= (const SimIrregularTimeSeries& x)
      {
        if (this != &x)
        {
          static_cast< ::schema::simxml::SimModelCore::SimTimeSeries& > (*this) = x;
          this->Name_ = x.Name_;
