...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowCompoundEqmt_UnitaryLoopEqmt_FurnaceHeatOnly::SimFlowCompEqmt_Name_optional& SimFlowCompoundEqmt_UnitaryLoopEqmt_FurnaceHeatOnly::
      SimFlowCompEqmt_Name () const
      {
        return this->SimFlowCompEqmt_Name_;
      }

      SimFlowCompoundEqmt_UnitaryLoopEqmt_FurnaceHeatOnly::SimFlowCompEqmt_Name_optional& SimFlowCompoundEqmt_UnitaryLoopEqmt_FurnaceHeatOnly::
