...
#ifndef SIM_INTERNAL_LOAD_EQUIPMENT_GAS_PROCESS_HXX
#define SIM_INTERNAL_LOAD_EQUIPMENT_GAS_PROCESS_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimInternalLoad_Equipment_Gas_Process;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class SimInternalLoad_Equipment_Gas_Process: public ::schema::simxml::ResourcesGeneral::SimInternalLoad_Equipment
      {
        public:
        ...
        SimInternalLoad_Equipment_Gas_Process (const RefId_type&);
        ...
        virtual SimInternalLoad_Equipment_Gas_Process*
...
#endif // SIM_INTERNAL_LOAD_EQUIPMENT_GAS_PROCESS_HXX
