...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowPlant_SolarDevice_SolarPhotoVoltaicThermal: public ::schema::simxml::MepModel::SimFlowPlant_SolarDevice
      {
        public:
        // ActiveAreaRatio
        //
        ...
        //
        typedef ::xml_schema::string SolarCollectPerf_PVTherm_Smpl_Name_type;
        typedef ::xsd::cxx::tree::optional< SolarCollectPerf_PVTherm_Smpl_Name_type > SolarCollectPerf_PVTherm_Smpl_Name_optional;
        typedef ::xsd::cxx::tree::traits< SolarCollectPerf_PVTherm_Smpl_Name_type, char > SolarCollectPerf_PVTherm_Smpl_Name_traits;

        const SolarCollectPerf_PVTherm_Smpl_Name_optional&
        SolarCollectPerf_PVTherm_Smpl_Name () const;

        SolarCollectPerf_PVTherm_Smpl_Name_optional&
        SolarCollectPerf_PVTherm_Smpl_Name ();
        ...
        void
        SolarCollectPerf_PVTherm_Smpl_Name (::std::auto_ptr< SolarCollectPerf_PVTherm_Smpl_Name_type > p);
        ...
        SolarCollectPerf_PVTherm_Smpl_Name_optional SolarCollectPerf_PVTherm_Smpl_Name_;
