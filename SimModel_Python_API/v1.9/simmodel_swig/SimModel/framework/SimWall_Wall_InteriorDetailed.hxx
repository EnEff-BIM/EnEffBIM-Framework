...
#ifndef SIM_WALL_WALL_INTERIOR_DETAILED_HXX
#define SIM_WALL_WALL_INTERIOR_DETAILED_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimWall_Wall_InteriorDetailed;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimWall_Wall_InteriorDetailed: public ::schema::simxml::BuildingModel::SimWall_Wall
      {
        public:
        ...
        SimWall_Wall_InteriorDetailed (const RefId_type&);
        ...
        virtual SimWall_Wall_InteriorDetailed*
...
#endif // SIM_WALL_WALL_INTERIOR_DETAILED_HXX
