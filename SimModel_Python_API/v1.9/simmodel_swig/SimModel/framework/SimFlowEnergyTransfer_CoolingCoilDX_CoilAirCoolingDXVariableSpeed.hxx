...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_CoolingCoilDX_CoilAirCoolingDXVariableSpeed: public ::schema::simxml::MepModel::SimFlowEnergyTransfer_CoolingCoilDX
      {
        public:
        ...
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate_type;
        typedef ::xsd::cxx::tree::optional< SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate_type > SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate_type, char > SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate_traits;

        const SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate_optional&
        SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate () const;

        SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate_optional&
        SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate ();
        ...
        void
        SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate (::std::auto_ptr< SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate_type > p);

        // SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool_type;
        typedef ::xsd::cxx::tree::optional< SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool_type > SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool_type, char > SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool_traits;

        const SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool_optional&
        SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool () const;

        SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool_optional&
        SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool ();
        ...
        void
        SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool (::std::auto_ptr< SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool_type > p);
        ...
        SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate_optional SimFlowEnergyTrans_Speed_1_10_RefUnitRatedCondensAirFlowRate_;
        SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool_optional SimFlowEnergyTrans_Speed_1_10_RefUnitRatedPadEffectOfEvapPreCool_;
