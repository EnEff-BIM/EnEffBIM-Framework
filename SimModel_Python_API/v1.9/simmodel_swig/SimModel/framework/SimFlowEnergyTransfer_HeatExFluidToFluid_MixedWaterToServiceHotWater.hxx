...
#ifndef SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_MIXED_WATER_TO_SERVICE_HOT_WATER_HXX
#define SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_MIXED_WATER_TO_SERVICE_HOT_WATER_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatExFluidToFluid_MixedWaterToServiceHotWater;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatExFluidToFluid_MixedWaterToServiceHotWater: public ::schema::simxml::MepModel::SimFlowEnergyTransfer_HeatExFluidToFluid
      {
        public:
        ...
        SimFlowEnergyTransfer_HeatExFluidToFluid_MixedWaterToServiceHotWater (const RefId_type&);
        ...
        virtual SimFlowEnergyTransfer_HeatExFluidToFluid_MixedWaterToServiceHotWater*
...
#endif // SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_MIXED_WATER_TO_SERVICE_HOT_WATER_HXX
