...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowCompoundEqmt_VirtualSupplySubsystems_CoilSystem_Cooling_Water_HeatExchangerAssisted: public ::schema::simxml::MepModel::SimFlowCompoundEqmt_VirtualSupplySubsystems
      {
        public:
