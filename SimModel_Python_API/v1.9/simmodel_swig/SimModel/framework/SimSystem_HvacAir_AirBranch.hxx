...
#ifndef SIM_SYSTEM_HVAC_AIR_AIR_BRANCH_HXX
#define SIM_SYSTEM_HVAC_AIR_AIR_BRANCH_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimSystem_HvacAir_AirBranch: public ::schema::simxml::BuildingModel::SimSystem_HvacAir
      {
        public:
        // SimSys_MaxFlowRate
        //
        ...
        SimSystem_HvacAir_AirBranch (const RefId_type&);
        ...
        virtual SimSystem_HvacAir_AirBranch*
...
#endif // SIM_SYSTEM_HVAC_AIR_AIR_BRANCH_HXX
