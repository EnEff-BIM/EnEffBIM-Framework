...
#ifndef SIM_MATERIAL_LAYER_SET_GLAZING_LAYER_SET_GLASS_DOOR_HXX
#define SIM_MATERIAL_LAYER_SET_GLAZING_LAYER_SET_GLASS_DOOR_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class SimMaterialLayerSet_GlazingLayerSet_GlassDoor: public ::schema::simxml::ResourcesGeneral::SimMaterialLayerSet_GlazingLayerSet
      {
        public:
        // SimMatLayerSet_Name
        //
        ...
        void
        T24DoorCertMethod (::std::auto_ptr< T24DoorCertMethod_type > p);
        ...
        void
        T24DoorOpenType (::std::auto_ptr< T24DoorOpenType_type > p);
        ...
        void
        T24DoorType (::std::auto_ptr< T24DoorType_type > p);

        // Constructors.
        //
        SimMaterialLayerSet_GlazingLayerSet_GlassDoor ();

        SimMaterialLayerSet_GlazingLayerSet_GlassDoor (const RefId_type&);
        ...
        virtual SimMaterialLayerSet_GlazingLayerSet_GlassDoor*
        ...
        T24DoorCertMethod_optional T24DoorCertMethod_;
        T24DoorOpenType_optional T24DoorOpenType_;
        T24DoorType_optional T24DoorType_;
      };
    }
  }
}
...
#endif // SIM_MATERIAL_LAYER_SET_GLAZING_LAYER_SET_GLASS_DOOR_HXX
