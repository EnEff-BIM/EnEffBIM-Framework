...
#ifndef SIM_FLOW_PLANT_CHILLER_CHILLER_VAPOR_COMPRESSION_COMBUSTION_TURBINE_HXX
#define SIM_FLOW_PLANT_CHILLER_CHILLER_VAPOR_COMPRESSION_COMBUSTION_TURBINE_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowPlant_Chiller_ChillerVaporCompressionCombustionTurbine: public ::schema::simxml::MepModel::SimFlowPlant_Chiller
      {
        public:
        // SimFlowPlant_Name
        //
        ...
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimFlowPlant_Coef_1_3_FuelInputCurveList_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_Coef_1_3_FuelInputCurveList_type > SimFlowPlant_Coef_1_3_FuelInputCurveList_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_Coef_1_3_FuelInputCurveList_type, char > SimFlowPlant_Coef_1_3_FuelInputCurveList_traits;

        const SimFlowPlant_Coef_1_3_FuelInputCurveList_optional&
        SimFlowPlant_Coef_1_3_FuelInputCurveList () const;

        SimFlowPlant_Coef_1_3_FuelInputCurveList_optional&
        SimFlowPlant_Coef_1_3_FuelInputCurveList ();
        ...
        void
        SimFlowPlant_Coef_1_3_FuelInputCurveList (::std::auto_ptr< SimFlowPlant_Coef_1_3_FuelInputCurveList_type > p);

        // SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList_type > SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList_type, char > SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList_traits;

        const SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList_optional&
        SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList () const;

        SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList_optional&
        SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList ();
        ...
        void
        SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList (::std::auto_ptr< SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList_type > p);

        // SimFlowPlant_Coef_1_3_ExhFlowCurveList
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimFlowPlant_Coef_1_3_ExhFlowCurveList_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_Coef_1_3_ExhFlowCurveList_type > SimFlowPlant_Coef_1_3_ExhFlowCurveList_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_Coef_1_3_ExhFlowCurveList_type, char > SimFlowPlant_Coef_1_3_ExhFlowCurveList_traits;

        const SimFlowPlant_Coef_1_3_ExhFlowCurveList_optional&
        SimFlowPlant_Coef_1_3_ExhFlowCurveList () const;

        SimFlowPlant_Coef_1_3_ExhFlowCurveList_optional&
        SimFlowPlant_Coef_1_3_ExhFlowCurveList ();
        ...
        void
        SimFlowPlant_Coef_1_3_ExhFlowCurveList (::std::auto_ptr< SimFlowPlant_Coef_1_3_ExhFlowCurveList_type > p);

        // SimFlowPlant_Coef_1_3_ExhGasTempCurveList
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimFlowPlant_Coef_1_3_ExhGasTempCurveList_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_Coef_1_3_ExhGasTempCurveList_type > SimFlowPlant_Coef_1_3_ExhGasTempCurveList_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_Coef_1_3_ExhGasTempCurveList_type, char > SimFlowPlant_Coef_1_3_ExhGasTempCurveList_traits;

        const SimFlowPlant_Coef_1_3_ExhGasTempCurveList_optional&
        SimFlowPlant_Coef_1_3_ExhGasTempCurveList () const;

        SimFlowPlant_Coef_1_3_ExhGasTempCurveList_optional&
        SimFlowPlant_Coef_1_3_ExhGasTempCurveList ();
        ...
        void
        SimFlowPlant_Coef_1_3_ExhGasTempCurveList (::std::auto_ptr< SimFlowPlant_Coef_1_3_ExhGasTempCurveList_type > p);

        // SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList_type > SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList_type, char > SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList_traits;

        const SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList_optional&
        SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList () const;

        SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList_optional&
        SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList ();
        ...
        void
        SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList (::std::auto_ptr< SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList_type > p);

        // SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList_type > SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList_type, char > SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList_traits;

        const SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList_optional&
        SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList () const;

        SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList_optional&
        SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList ();
        ...
        void
        SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList (::std::auto_ptr< SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList_type > p);
        ...
        //
        typedef ::xml_schema::double_ SimFlowPlant_GasTurbineEngineCap_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_GasTurbineEngineCap_type > SimFlowPlant_GasTurbineEngineCap_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_GasTurbineEngineCap_type, char, ::xsd::cxx::tree::schema_type::double_ > SimFlowPlant_GasTurbineEngineCap_traits;

        const SimFlowPlant_GasTurbineEngineCap_optional&
        SimFlowPlant_GasTurbineEngineCap () const;

        SimFlowPlant_GasTurbineEngineCap_optional&
        SimFlowPlant_GasTurbineEngineCap ();
        ...
        //
        typedef ::xml_schema::double_ SimFlowPlant_DesignSteamSaturTemp_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_DesignSteamSaturTemp_type > SimFlowPlant_DesignSteamSaturTemp_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_DesignSteamSaturTemp_type, char, ::xsd::cxx::tree::schema_type::double_ > SimFlowPlant_DesignSteamSaturTemp_traits;

        const SimFlowPlant_DesignSteamSaturTemp_optional&
        SimFlowPlant_DesignSteamSaturTemp () const;

        SimFlowPlant_DesignSteamSaturTemp_optional&
        SimFlowPlant_DesignSteamSaturTemp ();
        ...
        SimFlowPlant_Chiller_ChillerVaporCompressionCombustionTurbine (const RefId_type&);
        ...
        virtual SimFlowPlant_Chiller_ChillerVaporCompressionCombustionTurbine*
        ...
        SimFlowPlant_Coef_1_3_FuelInputCurveList_optional SimFlowPlant_Coef_1_3_FuelInputCurveList_;
        SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList_optional SimFlowPlant_Coef_1_3_TempBasedFuelInputCurveList_;
        SimFlowPlant_Coef_1_3_ExhFlowCurveList_optional SimFlowPlant_Coef_1_3_ExhFlowCurveList_;
        SimFlowPlant_Coef_1_3_ExhGasTempCurveList_optional SimFlowPlant_Coef_1_3_ExhGasTempCurveList_;
        SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList_optional SimFlowPlant_Coef_1_3_TempBasedExhGasTempCurveList_;
        SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList_optional SimFlowPlant_Coef_1_3_RecovLubeHeatCurveList_;
        SimFlowPlant_CoefUFactorTimesAreaCurve_1_2_optional SimFlowPlant_CoefUFactorTimesAreaCurve_1_2_;
        SimFlowPlant_GasTurbineEngineCap_optional SimFlowPlant_GasTurbineEngineCap_;
        SimFlowPlant_DesignSteamSaturTemp_optional SimFlowPlant_DesignSteamSaturTemp_;
...
#endif // SIM_FLOW_PLANT_CHILLER_CHILLER_VAPOR_COMPRESSION_COMBUSTION_TURBINE_HXX
