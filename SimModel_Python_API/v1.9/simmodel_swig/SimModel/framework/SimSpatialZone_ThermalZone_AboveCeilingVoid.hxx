...
#ifndef SIM_SPATIAL_ZONE_THERMAL_ZONE_ABOVE_CEILING_VOID_HXX
#define SIM_SPATIAL_ZONE_THERMAL_ZONE_ABOVE_CEILING_VOID_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimSpatialZone_ThermalZone_AboveCeilingVoid;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimSpatialZone_ThermalZone_AboveCeilingVoid: public ::schema::simxml::BuildingModel::SimSpatialZone_ThermalZone
      {
        public:
        ...
        SimSpatialZone_ThermalZone_AboveCeilingVoid (const RefId_type&);
        ...
        virtual SimSpatialZone_ThermalZone_AboveCeilingVoid*
...
#endif // SIM_SPATIAL_ZONE_THERMAL_ZONE_ABOVE_CEILING_VOID_HXX
