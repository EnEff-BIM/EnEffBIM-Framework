...
#ifndef SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_SERVICE_HOT_WATER_TO_HOT_WATER_HXX
#define SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_SERVICE_HOT_WATER_TO_HOT_WATER_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatExFluidToFluid_ServiceHotWaterToHotWater;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatExFluidToFluid_ServiceHotWaterToHotWater: public ::schema::simxml::MepModel::SimFlowEnergyTransfer_HeatExFluidToFluid
      {
        public:
        ...
        SimFlowEnergyTransfer_HeatExFluidToFluid_ServiceHotWaterToHotWater (const RefId_type&);
        ...
        virtual SimFlowEnergyTransfer_HeatExFluidToFluid_ServiceHotWaterToHotWater*
...
#endif // SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_SERVICE_HOT_WATER_TO_HOT_WATER_HXX
