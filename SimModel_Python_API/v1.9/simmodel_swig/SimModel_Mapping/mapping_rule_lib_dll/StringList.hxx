...
namespace namespaces
{
  namespace Sim
  {
    namespace DataMap
    {
      class __declspec(dllexport) StringList: public ::xml_schema::simple_type,
...
namespace namespaces
{
  namespace Sim
  {
    ...
    {
      void
      operator<< (::xercesc::DOMElement&, const StringList&);

      void
      operator<< (::xercesc::DOMAttr&, const StringList&);
