...
class SimObjectDefinition(SimRoot):
    ...
    def SelectedPropertyGroups(self, *args):
        return _base.SimObjectDefinition_SelectedPropertyGroups(self, *args)

    def IsTemplateObject(self, *args):
        return _base.SimObjectDefinition_IsTemplateObject(self, *args)
...
class SimBldgModelParams(SimResourceObject):
    ...
    def LocalPlacementCoordinates(self, *args):
        return _base.SimBldgModelParams_LocalPlacementCoordinates(self, *args)
