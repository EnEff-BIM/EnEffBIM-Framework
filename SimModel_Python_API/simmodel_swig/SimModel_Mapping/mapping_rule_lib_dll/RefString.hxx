...
#ifndef REF_STRING_HXX
#define REF_STRING_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace DataMap
    {
      class __declspec(dllexport) RefString: public ::xml_schema::string
      {
        public:
        // RefId
        //
        ...
        RefString (const char*);

        RefString (const ::std::string&);

        RefString (const ::xml_schema::string&);
...
namespace namespaces
{
  namespace Sim
  {
    ...
    {
      void
      operator<< (::xercesc::DOMElement&, const RefString&);
    }
  }
}
