...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      ...
      const SimResultsVariables::Unit_String_optional& SimResultsVariables::
      Unit_String () const
      {
        return this->Unit_String_;
      }

      SimResultsVariables::Unit_String_optional& SimResultsVariables::
      Unit_String ()
      {
        return this->Unit_String_;
      }
      ...
      void SimResultsVariables::
      Unit_String (const Unit_String_type& x)
      {
        this->Unit_String_.set (x);
      }

      void SimResultsVariables::
      Unit_String (const Unit_String_optional& x)
      {
        this->Unit_String_ = x;
      }

      void SimResultsVariables::
      Unit_String (::std::auto_ptr< Unit_String_type > x)
      {
        this->Unit_String_.set (x);
      }
      ...
      const SimResultsVariables::TimeStep_String_optional& SimResultsVariables::
      TimeStep_String () const
      {
        return this->TimeStep_String_;
      }

      SimResultsVariables::TimeStep_String_optional& SimResultsVariables::
      TimeStep_String ()
      {
        return this->TimeStep_String_;
      }
  ...
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      ...
      : ::schema::simxml::ResourcesGeneral::SimResultsVisualization (x, f, c),
        ...
        Unit_String_ (x.Unit_String_, f, this),
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // VariableName
          //
          if (n.name () == "VariableName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // VariableType
          //
          if (n.name () == "VariableType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // LegendName
          //
          if (n.name () == "LegendName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimulationRun
          //
          if (n.name () == "SimulationRun" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // KeyValue
          //
          if (n.name () == "KeyValue" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ReportVariableDDIndex
          //
          if (n.name () == "ReportVariableDDIndex" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // FillColor
          //
          if (n.name () == "FillColor" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // FillColorTransparency
          //
          if (n.name () == "FillColorTransparency" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // BorderColor
          //
          if (n.name () == "BorderColor" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ShowLabels
          //
          if (n.name () == "ShowLabels" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
            if (!this->ShowLabels_)
            {
          ...
          // Environment
          //
          if (n.name () == "Environment" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // AlternativeName
          //
          if (n.name () == "AlternativeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ConfigurationName
          //
          if (n.name () == "ConfigurationName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // RunName
          //
          if (n.name () == "RunName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          if (n.name () == "Unit_String" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
            ...
            if (!this->Unit_String_)
            {
              this->Unit_String_.set (r);
              continue;
            }
          }
          ...
          // LegendText
          //
          if (n.name () == "LegendText" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // Area
          //
          if (n.name () == "Area" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
      ...
      operator= (const SimResultsVariables& x)
      {
        if (this != &x)
        {
          ...
          this->Unit_String_ = x.Unit_String_;
