...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      // SimFlowPlant_HeatPump
      // 

      const SimFlowPlant_HeatPump::Representation_optional& SimFlowPlant_HeatPump::
      Representation () const
      {
        return this->Representation_;
      }

      SimFlowPlant_HeatPump::Representation_optional& SimFlowPlant_HeatPump::
      Representation ()
      {
        return this->Representation_;
      }

      void SimFlowPlant_HeatPump::
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowPlant_HeatPump::
      SimFlowPlant_HeatPump (const RefId_type& RefId)
      ...
      SimFlowPlant_HeatPump::
      SimFlowPlant_HeatPump (const SimFlowPlant_HeatPump& x,
                             ::xml_schema::flags f,
      ...
      SimFlowPlant_HeatPump::
      SimFlowPlant_HeatPump (const ::xercesc::DOMElement& e,
                             ::xml_schema::flags f,
                             ::xml_schema::container* c)
      ...
      SimFlowPlant_HeatPump* SimFlowPlant_HeatPump::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowPlant_HeatPump (*this, f, c);
      }

      SimFlowPlant_HeatPump& SimFlowPlant_HeatPump::
      operator= (const SimFlowPlant_HeatPump& x)
      {
        if (this != &x)
        {
