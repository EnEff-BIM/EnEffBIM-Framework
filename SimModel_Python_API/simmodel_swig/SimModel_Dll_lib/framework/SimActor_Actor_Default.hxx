...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class SimActor_Actor_Default: public ::schema::simxml::ResourcesGeneral::SimActor_Actor
      {
        public:
        // ActorPersonAndOrganization
        //
        typedef ::xml_schema::idref ActorPersonAndOrganization_type;
        typedef ::xsd::cxx::tree::optional< ActorPersonAndOrganization_type > ActorPersonAndOrganization_optional;
