...
#ifndef SIM_SLAB_FLOOR_HXX
#define SIM_SLAB_FLOOR_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class __declspec(dllexport) SimSlab_Floor: public ::schema::simxml::BuildingModel::SimSlab
      {
        public:
        // Name
        //
        ...
        SimSlab_Floor (const RefId_type&);
