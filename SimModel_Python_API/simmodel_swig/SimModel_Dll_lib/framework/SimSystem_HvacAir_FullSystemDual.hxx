...
#ifndef SIM_SYSTEM_HVAC_AIR_FULL_SYSTEM_DUAL_HXX
#define SIM_SYSTEM_HVAC_AIR_FULL_SYSTEM_DUAL_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimSystem_HvacAir_FullSystemDual;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimSystem_HvacAir_FullSystemDual: public ::schema::simxml::BuildingModel::SimSystem_HvacAir
      {
        public:
        // SimSys_ContListName
        //
        ...
        SimSystem_HvacAir_FullSystemDual (const RefId_type&);
        ...
        virtual SimSystem_HvacAir_FullSystemDual*
...
#endif // SIM_SYSTEM_HVAC_AIR_FULL_SYSTEM_DUAL_HXX
