...
#ifndef SIM_CONTROLLER_HXX
#define SIM_CONTROLLER_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class __declspec(dllexport) SimController: public ::schema::simxml::SimModelCore::SimDistributionControlElement
      {
        public:
        // Representation
        //
        ...
        SimController (const RefId_type&);
