...
#ifndef SIM_FLOW_FITTING_FLOW_FITTING_PROXY_DEMAND_PROXY_AIR_LOOP_HXX
#define SIM_FLOW_FITTING_FLOW_FITTING_PROXY_DEMAND_PROXY_AIR_LOOP_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowFitting_FlowFittingProxy_DemandProxy_AirLoop;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowFitting_FlowFittingProxy_DemandProxy_AirLoop: public ::schema::simxml::MepModel::SimFlowFitting_FlowFittingProxy
      {
        public:
        // SimFlowFitting_Name
        //
        ...
        SimFlowFitting_FlowFittingProxy_DemandProxy_AirLoop (const RefId_type&);
        ...
        virtual SimFlowFitting_FlowFittingProxy_DemandProxy_AirLoop*
...
#endif // SIM_FLOW_FITTING_FLOW_FITTING_PROXY_DEMAND_PROXY_AIR_LOOP_HXX
