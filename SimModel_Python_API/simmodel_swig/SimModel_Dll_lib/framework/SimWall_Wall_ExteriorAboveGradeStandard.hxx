...
#ifndef SIM_WALL_WALL_EXTERIOR_ABOVE_GRADE_STANDARD_HXX
#define SIM_WALL_WALL_EXTERIOR_ABOVE_GRADE_STANDARD_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimWall_Wall_ExteriorAboveGradeStandard;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimWall_Wall_ExteriorAboveGradeStandard: public ::schema::simxml::BuildingModel::SimWall_Wall
      {
        public:
        ...
        typedef ::xsd::cxx::tree::optional< SimWall_Name_type > SimWall_Name_optional;
        ...
        SimWall_Wall_ExteriorAboveGradeStandard (const RefId_type&);
        ...
        virtual SimWall_Wall_ExteriorAboveGradeStandard*
...
#endif // SIM_WALL_WALL_EXTERIOR_ABOVE_GRADE_STANDARD_HXX
