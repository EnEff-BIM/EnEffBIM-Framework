...
#ifndef SIM_SPATIAL_STRUCTURE_ELEMENT_HXX
#define SIM_SPATIAL_STRUCTURE_ELEMENT_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimSpatialStructureElement;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace SimModelCore
    {
      class __declspec(dllexport) SimSpatialStructureElement: public ::schema::simxml::SimModelCore::SimObject
      {
        public:
        // LongName
        //
        ...
        void
        LongName (::std::auto_ptr< LongName_type > p);
        ...
        SimSpatialStructureElement (const RefId_type&);
        ...
        virtual SimSpatialStructureElement*
...
#endif // SIM_SPATIAL_STRUCTURE_ELEMENT_HXX
