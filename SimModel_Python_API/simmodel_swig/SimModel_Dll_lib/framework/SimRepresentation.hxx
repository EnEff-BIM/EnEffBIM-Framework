...
#ifndef SIM_REPRESENTATION_HXX
#define SIM_REPRESENTATION_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace SimModelCore
    {
      class __declspec(dllexport) SimRepresentation: public ::schema::simxml::SimModelCore::SimResourceObject
      {
        public:
        ...
        RepresentationContext_optional&
        RepresentationContext ();
        ...
        void
        RepresentationContext (::std::auto_ptr< RepresentationContext_type > p);
        ...
        RepresentationIdentifier_optional&
        RepresentationIdentifier ();
        ...
        void
        RepresentationIdentifier (::std::auto_ptr< RepresentationIdentifier_type > p);
        ...
        void
        RepresentationType (::std::auto_ptr< RepresentationType_type > p);

        // RepresentationItems
        //
        typedef ::xml_schema::idrefs RepresentationItems_type;
        typedef ::xsd::cxx::tree::optional< RepresentationItems_type > RepresentationItems_optional;
        typedef ::xsd::cxx::tree::traits< RepresentationItems_type, char > RepresentationItems_traits;

        const RepresentationItems_optional&
        RepresentationItems () const;

        RepresentationItems_optional&
        RepresentationItems ();
        ...
        void
        RepresentationItems (::std::auto_ptr< RepresentationItems_type > p);

        // Constructors.
        //
        SimRepresentation ();

        SimRepresentation (const RefId_type&);
        ...
        protected:
        RepresentationContext_optional RepresentationContext_;
        RepresentationIdentifier_optional RepresentationIdentifier_;
        RepresentationType_optional RepresentationType_;
        RepresentationItems_optional RepresentationItems_;
      };
    }
  }
}
