...
#ifndef SIM_INTERNAL_LOAD_EQUIPMENT_HXX
#define SIM_INTERNAL_LOAD_EQUIPMENT_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimInternalLoad_Equipment;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimInternalLoad_Equipment: public ::schema::simxml::ResourcesGeneral::SimInternalLoad
      {
        public:
        ...
        SimInternalLoad_Equipment (const RefId_type&);
        ...
        virtual SimInternalLoad_Equipment*
...
#endif // SIM_INTERNAL_LOAD_EQUIPMENT_HXX
