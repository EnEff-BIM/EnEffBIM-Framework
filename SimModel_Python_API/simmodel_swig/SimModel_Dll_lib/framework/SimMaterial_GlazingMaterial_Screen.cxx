...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      ...
      const SimMaterial_GlazingMaterial_Screen::SimMaterial_Name_optional& SimMaterial_GlazingMaterial_Screen::
      SimMaterial_Name () const
      {
        return this->SimMaterial_Name_;
      }

      SimMaterial_GlazingMaterial_Screen::SimMaterial_Name_optional& SimMaterial_GlazingMaterial_Screen::
      SimMaterial_Name ()
      {
        return this->SimMaterial_Name_;
      }
    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimMaterial_ReflectedBeamTransAccountingMeth
          //
          if (n.name () == "SimMaterial_ReflectedBeamTransAccountingMeth" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimMaterial_DiffuseSolarReflect
          //
          if (n.name () == "SimMaterial_DiffuseSolarReflect" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimMaterial_DiffuseVisReflect
          //
          if (n.name () == "SimMaterial_DiffuseVisReflect" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimMaterial_ThermalHemisphEmis
          //
          if (n.name () == "SimMaterial_ThermalHemisphEmis" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimMaterial_ScreenMatlSpacing
          //
          if (n.name () == "SimMaterial_ScreenMatlSpacing" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimMaterial_ScreenMatlDiam
          //
          if (n.name () == "SimMaterial_ScreenMatlDiam" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimMaterial_ScreenToGlassDist
          //
          if (n.name () == "SimMaterial_ScreenToGlassDist" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimMaterial_AngleResForScreenTransOutputMap
          //
          if (n.name () == "SimMaterial_AngleResForScreenTransOutputMap" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
