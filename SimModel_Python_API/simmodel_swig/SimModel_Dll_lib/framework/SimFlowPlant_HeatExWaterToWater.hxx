...
#ifndef SIM_FLOW_PLANT_HEAT_EX_WATER_TO_WATER_HXX
#define SIM_FLOW_PLANT_HEAT_EX_WATER_TO_WATER_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowPlant_HeatExWaterToWater;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowPlant_HeatExWaterToWater: public ::schema::simxml::MepModel::SimFlowPlant
      {
        public:
        ...
        SimFlowPlant_HeatExWaterToWater (const RefId_type&);
        ...
        virtual SimFlowPlant_HeatExWaterToWater*
...
#endif // SIM_FLOW_PLANT_HEAT_EX_WATER_TO_WATER_HXX
