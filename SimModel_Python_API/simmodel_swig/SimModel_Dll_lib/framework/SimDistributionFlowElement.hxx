...
#ifndef SIM_DISTRIBUTION_FLOW_ELEMENT_HXX
#define SIM_DISTRIBUTION_FLOW_ELEMENT_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimDistributionFlowElement;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace SimModelCore
    {
      class __declspec(dllexport) SimDistributionFlowElement: public ::schema::simxml::SimModelCore::SimDistributionElement
      {
        public:
        // ControlledBy
        //
        typedef ::xml_schema::idrefs ControlledBy_type;
        typedef ::xsd::cxx::tree::optional< ControlledBy_type > ControlledBy_optional;
        typedef ::xsd::cxx::tree::traits< ControlledBy_type, char > ControlledBy_traits;

        const ControlledBy_optional&
        ControlledBy () const;

        ControlledBy_optional&
        ControlledBy ();
        ...
        void
        ControlledBy (::std::auto_ptr< ControlledBy_type > p);
        ...
        SimDistributionFlowElement (const RefId_type&);
        ...
        virtual SimDistributionFlowElement*
        ...
        protected:
        ControlledBy_optional ControlledBy_;
        _3dLength_optional _3dLength_;
        _3dWidth_optional _3dWidth_;
        _3dHeight_optional _3dHeight_;
      };
    }
  }
}
...
#endif // SIM_DISTRIBUTION_FLOW_ELEMENT_HXX
