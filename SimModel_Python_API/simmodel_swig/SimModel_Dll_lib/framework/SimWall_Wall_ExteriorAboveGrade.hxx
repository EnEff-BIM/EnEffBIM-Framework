...
#ifndef SIM_WALL_WALL_EXTERIOR_ABOVE_GRADE_HXX
#define SIM_WALL_WALL_EXTERIOR_ABOVE_GRADE_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimWall_Wall_ExteriorAboveGrade;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class __declspec(dllexport) SimWall_Wall_ExteriorAboveGrade: public ::schema::simxml::BuildingModel::SimWall_Wall
      {
        public:
        ...
        SimWall_Wall_ExteriorAboveGrade (const RefId_type&);
        ...
        virtual SimWall_Wall_ExteriorAboveGrade*
...
#endif // SIM_WALL_WALL_EXTERIOR_ABOVE_GRADE_HXX
