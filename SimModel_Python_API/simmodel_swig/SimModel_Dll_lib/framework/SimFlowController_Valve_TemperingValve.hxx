...
#ifndef SIM_FLOW_CONTROLLER_VALVE_TEMPERING_VALVE_HXX
#define SIM_FLOW_CONTROLLER_VALVE_TEMPERING_VALVE_HXX
...
#include "simflowcontroller_valve.hxx"
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class __declspec(dllexport) SimFlowController_Valve_TemperingValve: public ::schema::simxml::MepModel::SimFlowController_Valve
      {
        public:
        // SimFlowCntrl_Name
        //
        ...
        SimFlowCntrl_InNodeName_optional&
        SimFlowCntrl_InNodeName ();
        ...
        void
        SimFlowCntrl_InNodeName (::std::auto_ptr< SimFlowCntrl_InNodeName_type > p);
        ...
        SimFlowCntrl_OutNodeName_optional&
        SimFlowCntrl_OutNodeName ();
        ...
        void
        SimFlowCntrl_OutNodeName (::std::auto_ptr< SimFlowCntrl_OutNodeName_type > p);
        ...
        SimFlowCntrl_Stream2SrcNodeName_optional&
        SimFlowCntrl_Stream2SrcNodeName ();
        ...
        void
        SimFlowCntrl_Stream2SrcNodeName (::std::auto_ptr< SimFlowCntrl_Stream2SrcNodeName_type > p);
        ...
        SimFlowCntrl_TempSetpointNodeName_optional&
        SimFlowCntrl_TempSetpointNodeName ();
        ...
        void
        SimFlowCntrl_TempSetpointNodeName (::std::auto_ptr< SimFlowCntrl_TempSetpointNodeName_type > p);
        ...
        SimFlowCntrl_PumpOutletNodeName_optional&
        SimFlowCntrl_PumpOutletNodeName ();
        ...
        void
        SimFlowCntrl_PumpOutletNodeName (::std::auto_ptr< SimFlowCntrl_PumpOutletNodeName_type > p);

        // Constructors.
        //
        SimFlowController_Valve_TemperingValve ();

        SimFlowController_Valve_TemperingValve (const RefId_type&);
        ...
        virtual SimFlowController_Valve_TemperingValve*
        ...
        SimFlowCntrl_InNodeName_optional SimFlowCntrl_InNodeName_;
        SimFlowCntrl_OutNodeName_optional SimFlowCntrl_OutNodeName_;
        SimFlowCntrl_Stream2SrcNodeName_optional SimFlowCntrl_Stream2SrcNodeName_;
        SimFlowCntrl_TempSetpointNodeName_optional SimFlowCntrl_TempSetpointNodeName_;
        SimFlowCntrl_PumpOutletNodeName_optional SimFlowCntrl_PumpOutletNodeName_;
      };
    }
  }
}
...
#endif // SIM_FLOW_CONTROLLER_VALVE_TEMPERING_VALVE_HXX
