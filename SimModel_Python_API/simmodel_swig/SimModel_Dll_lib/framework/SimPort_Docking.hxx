...
#ifndef SIM_PORT_DOCKING_HXX
#define SIM_PORT_DOCKING_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class SimPort_Docking: public ::schema::simxml::ResourcesGeneral::SimPort
      {
        public:
        // ObjectType
        //
        ...
        SimPort_Docking (const RefId_type&);
