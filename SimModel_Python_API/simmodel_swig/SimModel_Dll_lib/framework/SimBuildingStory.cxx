    ...
    namespace BuildingModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // BuildingStoryElevation
          //
          if (n.name () == "BuildingStoryElevation" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // BuildingStoryIsEntranceLevel
          //
          if (n.name () == "BuildingStoryIsEntranceLevel" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // BuildingStoryIsAboveGrade
          //
          if (n.name () == "BuildingStoryIsAboveGrade" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // BuildingStoryGrossFloorAreaPlanned
          //
          if (n.name () == "BuildingStoryGrossFloorAreaPlanned" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // BuildingStoryHeight
          //
          if (n.name () == "BuildingStoryHeight" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // BuildingStoryPerimeter
          //
          if (n.name () == "BuildingStoryPerimeter" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // BuildingStoryGrossFloorArea
          //
          if (n.name () == "BuildingStoryGrossFloorArea" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // BuildingStoryGrossVolume
          //
          if (n.name () == "BuildingStoryGrossVolume" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // BldgStoryInSpatialContainer
          //
          if (n.name () == "BldgStoryInSpatialContainer" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // BuildingStoryNumber
          //
          if (n.name () == "BuildingStoryNumber" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
          ...
          // IsTopFloor
          //
          if (n.name () == "IsTopFloor" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
            if (!this->IsTopFloor_)
            {
          ...
          // IsBottomFloor
          //
          if (n.name () == "IsBottomFloor" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/BuildingModel")
          {
