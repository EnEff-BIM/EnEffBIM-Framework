...
#ifndef SIM_APP_OBJ_NAME_DEFAULT_HXX
#define SIM_APP_OBJ_NAME_DEFAULT_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimAppObjNameDefault: public ::schema::simxml::SimModelCore::SimAppDefault
      {
        public:
        ...
        void
        DefaultForObjectType (::std::auto_ptr< DefaultForObjectType_type > p);
        ...
        void
        NameString1 (::std::auto_ptr< NameString1_type > p);
        ...
        void
        NameString2 (::std::auto_ptr< NameString2_type > p);
        ...
        void
        IndexType1 (::std::auto_ptr< IndexType1_type > p);
        ...
        void
        IndexType2 (::std::auto_ptr< IndexType2_type > p);
        ...
        void
        LastUsedIndex1 (::std::auto_ptr< LastUsedIndex1_type > p);
        ...
        void
        LastUsedIndex2 (::std::auto_ptr< LastUsedIndex2_type > p);

        // Constructors.
        //
        SimAppObjNameDefault ();

        SimAppObjNameDefault (const RefId_type&);
        ...
        protected:
        DefaultForObjectType_optional DefaultForObjectType_;
        NameString1_optional NameString1_;
        NameString2_optional NameString2_;
        IndexType1_optional IndexType1_;
        IndexType2_optional IndexType2_;
        LastUsedIndex1_optional LastUsedIndex1_;
        LastUsedIndex2_optional LastUsedIndex2_;
      };
    }
  }
}
...
#endif // SIM_APP_OBJ_NAME_DEFAULT_HXX
