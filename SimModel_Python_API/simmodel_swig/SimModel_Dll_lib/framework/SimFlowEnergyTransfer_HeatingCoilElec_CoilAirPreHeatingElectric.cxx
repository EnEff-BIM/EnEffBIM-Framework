...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowEnergyTransfer_HeatingCoilElec_CoilAirPreHeatingElectric::SimFlowEnergyTrans_NomCap_optional& SimFlowEnergyTransfer_HeatingCoilElec_CoilAirPreHeatingElectric::
      SimFlowEnergyTrans_NomCap () const
      {
        return this->SimFlowEnergyTrans_NomCap_;
      }

      SimFlowEnergyTransfer_HeatingCoilElec_CoilAirPreHeatingElectric::SimFlowEnergyTrans_NomCap_optional& SimFlowEnergyTransfer_HeatingCoilElec_CoilAirPreHeatingElectric::
      ...
      const SimFlowEnergyTransfer_HeatingCoilElec_CoilAirPreHeatingElectric::SimFlowEnergyTrans_Efficiency_optional& SimFlowEnergyTransfer_HeatingCoilElec_CoilAirPreHeatingElectric::
      SimFlowEnergyTrans_Efficiency () const
      {
        return this->SimFlowEnergyTrans_Efficiency_;
      }

      SimFlowEnergyTransfer_HeatingCoilElec_CoilAirPreHeatingElectric::SimFlowEnergyTrans_Efficiency_optional& SimFlowEnergyTransfer_HeatingCoilElec_CoilAirPreHeatingElectric::
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowEnergyTransfer_HeatingCoilElec_CoilAirPreHeatingElectric* SimFlowEnergyTransfer_HeatingCoilElec_CoilAirPreHeatingElectric::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowEnergyTransfer_HeatingCoilElec_CoilAirPreHeatingElectric (*this, f, c);
      }
