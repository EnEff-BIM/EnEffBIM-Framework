...
#ifndef SIM_MATERIAL_OPAQUE_MATERIAL_AIR_GAP_HXX
#define SIM_MATERIAL_OPAQUE_MATERIAL_AIR_GAP_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimMaterial_OpaqueMaterial_AirGap: public ::schema::simxml::ResourcesGeneral::SimMaterial_OpaqueMaterial
      {
        public:
        // SimMaterial_Name
        //
        ...
        SimMaterial_OpaqueMaterial_AirGap (const RefId_type&);
        ...
        virtual SimMaterial_OpaqueMaterial_AirGap*
...
#endif // SIM_MATERIAL_OPAQUE_MATERIAL_AIR_GAP_HXX
