...
#ifndef SIM_FLOW_PLANT_HEAT_PUMP_GROUND_SOURCE_HXX
#define SIM_FLOW_PLANT_HEAT_PUMP_GROUND_SOURCE_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowPlant_HeatPump_GroundSource: public ::schema::simxml::MepModel::SimFlowPlant_HeatPump
      {
        public:
        ...
        SimFlowPlant_HeatPump_GroundSource (const RefId_type&);

        SimFlowPlant_HeatPump_GroundSource (const ::xercesc::DOMElement& e,
                                            ::xml_schema::flags f = 0,
                                            ::xml_schema::container* c = 0);

        SimFlowPlant_HeatPump_GroundSource (const SimFlowPlant_HeatPump_GroundSource& x,
                                            ::xml_schema::flags f = 0,
                                            ::xml_schema::container* c = 0);

        virtual SimFlowPlant_HeatPump_GroundSource*
        _clone (::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0) const;

        SimFlowPlant_HeatPump_GroundSource&
        operator= (const SimFlowPlant_HeatPump_GroundSource& x);
...
#endif // SIM_FLOW_PLANT_HEAT_PUMP_GROUND_SOURCE_HXX
