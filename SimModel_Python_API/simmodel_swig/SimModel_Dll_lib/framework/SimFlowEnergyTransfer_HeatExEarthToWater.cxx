...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      // SimFlowEnergyTransfer_HeatExEarthToWater
      // 

      const SimFlowEnergyTransfer_HeatExEarthToWater::SimFlowEnergyTrans_Name_optional& SimFlowEnergyTransfer_HeatExEarthToWater::
      SimFlowEnergyTrans_Name () const
      {
        return this->SimFlowEnergyTrans_Name_;
      }

      SimFlowEnergyTransfer_HeatExEarthToWater::SimFlowEnergyTrans_Name_optional& SimFlowEnergyTransfer_HeatExEarthToWater::
      SimFlowEnergyTrans_Name ()
      {
        return this->SimFlowEnergyTrans_Name_;
      }

      void SimFlowEnergyTransfer_HeatExEarthToWater::
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowEnergyTransfer_HeatExEarthToWater::
      SimFlowEnergyTransfer_HeatExEarthToWater (const RefId_type& RefId)
      ...
      SimFlowEnergyTransfer_HeatExEarthToWater::
      SimFlowEnergyTransfer_HeatExEarthToWater (const SimFlowEnergyTransfer_HeatExEarthToWater& x,
                                                ::xml_schema::flags f,
      ...
      SimFlowEnergyTransfer_HeatExEarthToWater::
      SimFlowEnergyTransfer_HeatExEarthToWater (const ::xercesc::DOMElement& e,
                                                ::xml_schema::flags f,
                                                ::xml_schema::container* c)
      ...
      SimFlowEnergyTransfer_HeatExEarthToWater* SimFlowEnergyTransfer_HeatExEarthToWater::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowEnergyTransfer_HeatExEarthToWater (*this, f, c);
      }

      SimFlowEnergyTransfer_HeatExEarthToWater& SimFlowEnergyTransfer_HeatExEarthToWater::
      operator= (const SimFlowEnergyTransfer_HeatExEarthToWater& x)
      {
        if (this != &x)
        {
