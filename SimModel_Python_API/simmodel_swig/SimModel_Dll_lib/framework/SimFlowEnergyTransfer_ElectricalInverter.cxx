...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowEnergyTransfer_ElectricalInverter::SimFlowEnergyTrans_Name_optional& SimFlowEnergyTransfer_ElectricalInverter::
      SimFlowEnergyTrans_Name () const
      {
        return this->SimFlowEnergyTrans_Name_;
      }

      SimFlowEnergyTransfer_ElectricalInverter::SimFlowEnergyTrans_Name_optional& SimFlowEnergyTransfer_ElectricalInverter::
