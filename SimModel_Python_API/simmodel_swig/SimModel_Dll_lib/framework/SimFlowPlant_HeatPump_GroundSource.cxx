...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowPlant_HeatPump_GroundSource::T24HeatRejectFanType_optional& SimFlowPlant_HeatPump_GroundSource::
      T24HeatRejectFanType () const
      {
        return this->T24HeatRejectFanType_;
      }

      SimFlowPlant_HeatPump_GroundSource::T24HeatRejectFanType_optional& SimFlowPlant_HeatPump_GroundSource::
      ...
      SimFlowPlant_HeatPump_GroundSource::T24ConstructStatus2_optional& SimFlowPlant_HeatPump_GroundSource::
      T24ConstructStatus2 ()
      {
        return this->T24ConstructStatus2_;
      }
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowPlant_HeatPump_GroundSource* SimFlowPlant_HeatPump_GroundSource::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowPlant_HeatPump_GroundSource (*this, f, c);
      }
