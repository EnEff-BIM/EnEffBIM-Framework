...
#ifndef SIM_OBJECT_HXX
#define SIM_OBJECT_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace SimModelCore
    {
      class __declspec(dllexport) SimObject: public ::schema::simxml::SimModelCore::SimObjectDefinition
      {
        public:
        // TypeDefinition
        //
