...
#ifndef SIM_REFRIGERATION_SYSTEM_ELEMENT_HXX
#define SIM_REFRIGERATION_SYSTEM_ELEMENT_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimRefrigerationSystemElement;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimRefrigerationSystemElement: public ::schema::simxml::SimModelCore::SimDistributionFlowElement
      {
        public:
        // Representation
        //
        ...
        SimRefrigerationSystemElement (const RefId_type&);
        ...
        virtual SimRefrigerationSystemElement*
...
#endif // SIM_REFRIGERATION_SYSTEM_ELEMENT_HXX
