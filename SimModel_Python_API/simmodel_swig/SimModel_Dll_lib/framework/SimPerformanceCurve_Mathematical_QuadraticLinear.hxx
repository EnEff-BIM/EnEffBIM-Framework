...
#ifndef SIM_PERFORMANCE_CURVE_MATHEMATICAL_QUADRATIC_LINEAR_HXX
#define SIM_PERFORMANCE_CURVE_MATHEMATICAL_QUADRATIC_LINEAR_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeometry
    {
      class SimPerformanceCurve_Mathematical_QuadraticLinear: public ::schema::simxml::ResourcesGeometry::SimPerformanceCurve_Mathematical
      {
        public:
        ...
        //
        typedef ::xml_schema::double_ SimPerfCurve_Coeff5_X_y_type;
        typedef ::xsd::cxx::tree::optional< SimPerfCurve_Coeff5_X_y_type > SimPerfCurve_Coeff5_X_y_optional;
        typedef ::xsd::cxx::tree::traits< SimPerfCurve_Coeff5_X_y_type, char, ::xsd::cxx::tree::schema_type::double_ > SimPerfCurve_Coeff5_X_y_traits;

        const SimPerfCurve_Coeff5_X_y_optional&
        SimPerfCurve_Coeff5_X_y () const;

        SimPerfCurve_Coeff5_X_y_optional&
        SimPerfCurve_Coeff5_X_y ();
        ...
        //
        typedef ::xml_schema::double_ SimPerfCurve_Coeff6_X_2_Y_type;
        typedef ::xsd::cxx::tree::optional< SimPerfCurve_Coeff6_X_2_Y_type > SimPerfCurve_Coeff6_X_2_Y_optional;
        typedef ::xsd::cxx::tree::traits< SimPerfCurve_Coeff6_X_2_Y_type, char, ::xsd::cxx::tree::schema_type::double_ > SimPerfCurve_Coeff6_X_2_Y_traits;

        const SimPerfCurve_Coeff6_X_2_Y_optional&
        SimPerfCurve_Coeff6_X_2_Y () const;

        SimPerfCurve_Coeff6_X_2_Y_optional&
        SimPerfCurve_Coeff6_X_2_Y ();
        ...
        SimPerformanceCurve_Mathematical_QuadraticLinear (const RefId_type&);
        ...
        virtual SimPerformanceCurve_Mathematical_QuadraticLinear*
        ...
        SimPerfCurve_Coeff5_X_y_optional SimPerfCurve_Coeff5_X_y_;
        SimPerfCurve_Coeff6_X_2_Y_optional SimPerfCurve_Coeff6_X_2_Y_;
      };
    }
  }
}
...
#endif // SIM_PERFORMANCE_CURVE_MATHEMATICAL_QUADRATIC_LINEAR_HXX
