...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      ...
      const SimMaterial_OpaqueMaterial_Default::SimMaterial_Name_optional& SimMaterial_OpaqueMaterial_Default::
      SimMaterial_Name () const
      {
        return this->SimMaterial_Name_;
      }

      SimMaterial_OpaqueMaterial_Default::SimMaterial_Name_optional& SimMaterial_OpaqueMaterial_Default::
      SimMaterial_Name ()
      {
        return this->SimMaterial_Name_;
      }
    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimMaterial_Density
          //
          if (n.name () == "SimMaterial_Density" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimMaterial_SpecificHeat
          //
          if (n.name () == "SimMaterial_SpecificHeat" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
