...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowEnergyTransfer_HeatingCoilWater::SimFlowEnergyTrans_Name_optional& SimFlowEnergyTransfer_HeatingCoilWater::
      SimFlowEnergyTrans_Name () const
      {
        return this->SimFlowEnergyTrans_Name_;
      }

      SimFlowEnergyTransfer_HeatingCoilWater::SimFlowEnergyTrans_Name_optional& SimFlowEnergyTransfer_HeatingCoilWater::
      SimFlowEnergyTrans_Name ()
      {
        return this->SimFlowEnergyTrans_Name_;
      }

      void SimFlowEnergyTransfer_HeatingCoilWater::
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowEnergyTransfer_HeatingCoilWater::
      SimFlowEnergyTransfer_HeatingCoilWater (const RefId_type& RefId)
      ...
      SimFlowEnergyTransfer_HeatingCoilWater::
      SimFlowEnergyTransfer_HeatingCoilWater (const SimFlowEnergyTransfer_HeatingCoilWater& x,
                                              ::xml_schema::flags f,
      ...
      SimFlowEnergyTransfer_HeatingCoilWater::
      SimFlowEnergyTransfer_HeatingCoilWater (const ::xercesc::DOMElement& e,
                                              ::xml_schema::flags f,
                                              ::xml_schema::container* c)
      ...
      SimFlowEnergyTransfer_HeatingCoilWater* SimFlowEnergyTransfer_HeatingCoilWater::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowEnergyTransfer_HeatingCoilWater (*this, f, c);
      }
