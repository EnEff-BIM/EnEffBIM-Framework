...
#ifndef T24INFILTR_MTHD_HXX
#define T24INFILTR_MTHD_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class T24InfiltrMthd: public ::xml_schema::type
      {
        public:
        // stringItem
        //
        ...
        T24InfiltrMthd (const ::xercesc::DOMElement& e,
                        ::xml_schema::flags f = 0,
                        ::xml_schema::container* c = 0);

        T24InfiltrMthd (const T24InfiltrMthd& x,
                        ::xml_schema::flags f = 0,
                        ::xml_schema::container* c = 0);

        virtual T24InfiltrMthd*
        _clone (::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0) const;

        T24InfiltrMthd&
        operator= (const T24InfiltrMthd& x);
