...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowController_Damper_Exhaust::SimFlowCntrl_Name_optional& SimFlowController_Damper_Exhaust::
      SimFlowCntrl_Name () const
      {
        return this->SimFlowCntrl_Name_;
      }

      SimFlowController_Damper_Exhaust::SimFlowCntrl_Name_optional& SimFlowController_Damper_Exhaust::
      SimFlowCntrl_Name ()
      {
        return this->SimFlowCntrl_Name_;
      }
