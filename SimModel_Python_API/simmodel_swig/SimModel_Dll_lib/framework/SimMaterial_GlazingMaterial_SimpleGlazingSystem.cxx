    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimMaterial_UFactor
          //
          if (n.name () == "SimMaterial_UFactor" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimMaterial_SolarHeatGainCoef
          //
          if (n.name () == "SimMaterial_SolarHeatGainCoef" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
