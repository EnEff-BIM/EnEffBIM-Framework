...
#ifndef SIM_MATERIAL_LAYER_SET_OPAQUE_LAYER_SET_WALL_HXX
#define SIM_MATERIAL_LAYER_SET_OPAQUE_LAYER_SET_WALL_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimMaterialLayerSet_OpaqueLayerSet_Wall: public ::schema::simxml::ResourcesGeneral::SimMaterialLayerSet_OpaqueLayerSet
      {
        public:
        ...
        SimMaterialLayerSet_OpaqueLayerSet_Wall (const RefId_type&);
        ...
        virtual SimMaterialLayerSet_OpaqueLayerSet_Wall*
...
#endif // SIM_MATERIAL_LAYER_SET_OPAQUE_LAYER_SET_WALL_HXX
