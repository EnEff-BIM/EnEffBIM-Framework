...
#ifndef SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_MIXED_WATER_TO_HOT_WATER_HXX
#define SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_MIXED_WATER_TO_HOT_WATER_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatExFluidToFluid_MixedWaterToHotWater;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatExFluidToFluid_MixedWaterToHotWater: public ::schema::simxml::MepModel::SimFlowEnergyTransfer_HeatExFluidToFluid
      {
        public:
        ...
        SimFlowEnergyTransfer_HeatExFluidToFluid_MixedWaterToHotWater (const RefId_type&);
        ...
        virtual SimFlowEnergyTransfer_HeatExFluidToFluid_MixedWaterToHotWater*
...
#endif // SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_MIXED_WATER_TO_HOT_WATER_HXX
