...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowFitting_Splitter_CondenserSplitter::SimFlowFitting_Name_optional& SimFlowFitting_Splitter_CondenserSplitter::
      SimFlowFitting_Name () const
      {
        return this->SimFlowFitting_Name_;
      }

      SimFlowFitting_Splitter_CondenserSplitter::SimFlowFitting_Name_optional& SimFlowFitting_Splitter_CondenserSplitter::
      SimFlowFitting_Name ()
      {
        return this->SimFlowFitting_Name_;
      }
