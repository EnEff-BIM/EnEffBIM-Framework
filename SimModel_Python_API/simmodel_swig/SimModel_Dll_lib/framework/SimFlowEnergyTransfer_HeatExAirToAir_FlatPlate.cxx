...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowEnergyTransfer_HeatExAirToAir_FlatPlate::SimFlowEnergyTrans_NomElecPwr_optional& SimFlowEnergyTransfer_HeatExAirToAir_FlatPlate::
      SimFlowEnergyTrans_NomElecPwr () const
      {
        return this->SimFlowEnergyTrans_NomElecPwr_;
      }

      SimFlowEnergyTransfer_HeatExAirToAir_FlatPlate::SimFlowEnergyTrans_NomElecPwr_optional& SimFlowEnergyTransfer_HeatExAirToAir_FlatPlate::
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowEnergyTrans_FlowArrangementType
          //
          if (n.name () == "SimFlowEnergyTrans_FlowArrangementType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_RatioSupplyToSecondHAVal
          //
          if (n.name () == "SimFlowEnergyTrans_RatioSupplyToSecondHAVal" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_NomSupplyAirInletTemp
          //
          if (n.name () == "SimFlowEnergyTrans_NomSupplyAirInletTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_NomSupplyAirOutletTemp
          //
          if (n.name () == "SimFlowEnergyTrans_NomSupplyAirOutletTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_NomSecondAirFlowRate
          //
          if (n.name () == "SimFlowEnergyTrans_NomSecondAirFlowRate" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_NomSecondAirInletTemp
          //
          if (n.name () == "SimFlowEnergyTrans_NomSecondAirInletTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowEnergyTrans_SecondAirOutletNodeName
          //
          if (n.name () == "SimFlowEnergyTrans_SecondAirOutletNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
