...
#ifndef SIM_CARTESIAN_TRANSFORM_OPERATOR_HXX
#define SIM_CARTESIAN_TRANSFORM_OPERATOR_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimCartesianTransformOperator;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeometry
    {
      class __declspec(dllexport) SimCartesianTransformOperator: public ::schema::simxml::SimModelCore::SimRepresentationItem
      {
        public:
        // Axis1
        //
        ...
        void
        LocalOrigin (::std::auto_ptr< LocalOrigin_type > p);
        ...
        SimCartesianTransformOperator (const RefId_type&);
        ...
        virtual SimCartesianTransformOperator*
        ...
        LocalOrigin_optional LocalOrigin_;
...
#endif // SIM_CARTESIAN_TRANSFORM_OPERATOR_HXX
