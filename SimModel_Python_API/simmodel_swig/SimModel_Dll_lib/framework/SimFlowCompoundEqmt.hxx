...
#ifndef SIM_FLOW_COMPOUND_EQMT_HXX
#define SIM_FLOW_COMPOUND_EQMT_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowCompoundEqmt: public ::schema::simxml::MepModel::SimFlowEnergyConverter
      {
        public:
        // Representation
        //
        ...
        typedef ::xsd::cxx::tree::optional< IsSingleZone_type > IsSingleZone_optional;
        ...
        typedef ::xsd::cxx::tree::optional< Is3Phase_type > Is3Phase_optional;
        ...
        SimFlowCompoundEqmt (const RefId_type&);
...
#endif // SIM_FLOW_COMPOUND_EQMT_HXX
