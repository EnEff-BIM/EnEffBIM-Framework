...
#ifndef SIM_MATERIAL_GLAZING_MATERIAL_GAS_HXX
#define SIM_MATERIAL_GLAZING_MATERIAL_GAS_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimMaterial_GlazingMaterial_Gas: public ::schema::simxml::ResourcesGeneral::SimMaterial_GlazingMaterial
      {
        public:
        // SimMaterial_Thick
        //
        ...
        SimMaterial_GlazingMaterial_Gas (const RefId_type&);
        ...
        virtual SimMaterial_GlazingMaterial_Gas*
...
#endif // SIM_MATERIAL_GLAZING_MATERIAL_GAS_HXX
