...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class __declspec(dllexport) SimProject: public ::schema::simxml::SimModelCore::SimSpatialStructureElement
      {
        public:
        // Name
        //
        ...
        // T24ProjectTeam
        //
        typedef ::xml_schema::idrefs T24ProjectTeam_type;
        typedef ::xsd::cxx::tree::optional< T24ProjectTeam_type > T24ProjectTeam_optional;
        typedef ::xsd::cxx::tree::traits< T24ProjectTeam_type, char > T24ProjectTeam_traits;

        const T24ProjectTeam_optional&
        ...
        ParentDesignAltForViews_optional&
        ParentDesignAltForViews ();
        ...
        void
        ParentDesignAltForViews (::std::auto_ptr< ParentDesignAltForViews_type > p);
