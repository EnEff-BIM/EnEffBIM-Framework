...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimSensor_TemperatureSensor_WetBulb::SimSensor_Name_optional& SimSensor_TemperatureSensor_WetBulb::
      SimSensor_Name () const
      {
        return this->SimSensor_Name_;
      }

      SimSensor_TemperatureSensor_WetBulb::SimSensor_Name_optional& SimSensor_TemperatureSensor_WetBulb::
      SimSensor_Name ()
      {
        return this->SimSensor_Name_;
      }
