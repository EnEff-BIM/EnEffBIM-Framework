...
#ifndef SIM_MATERIAL_LAYER_SET_OPAQUE_LAYER_SET_FLOOR_HXX
#define SIM_MATERIAL_LAYER_SET_OPAQUE_LAYER_SET_FLOOR_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimMaterialLayerSet_OpaqueLayerSet_Floor: public ::schema::simxml::ResourcesGeneral::SimMaterialLayerSet_OpaqueLayerSet
      {
        public:
        ...
        SimMaterialLayerSet_OpaqueLayerSet_Floor (const RefId_type&);
        ...
        virtual SimMaterialLayerSet_OpaqueLayerSet_Floor*
...
#endif // SIM_MATERIAL_LAYER_SET_OPAQUE_LAYER_SET_FLOOR_HXX
