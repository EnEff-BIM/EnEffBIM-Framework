...
#ifndef SIM_SLAB_ROOF_SLAB_HXX
#define SIM_SLAB_ROOF_SLAB_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class __declspec(dllexport) SimSlab_RoofSlab: public ::schema::simxml::BuildingModel::SimSlab
      {
        public:
        // Name
        //
        ...
        SimSlab_RoofSlab (const RefId_type&);
