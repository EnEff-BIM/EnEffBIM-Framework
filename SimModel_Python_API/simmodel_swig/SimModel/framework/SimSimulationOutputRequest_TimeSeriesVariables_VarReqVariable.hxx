...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class SimSimulationOutputRequest_TimeSeriesVariables_VarReqVariable: public ::schema::simxml::ResourcesGeneral::SimSimulationOutputRequest_TimeSeriesVariables
      {
        public:
