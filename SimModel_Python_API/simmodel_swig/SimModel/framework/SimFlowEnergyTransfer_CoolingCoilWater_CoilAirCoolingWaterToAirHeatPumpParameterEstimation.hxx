...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_CoolingCoilWater_CoilAirCoolingWaterToAirHeatPumpParameterEstimation: public ::schema::simxml::MepModel::SimFlowEnergyTransfer_CoolingCoilWater
      {
        public:
