...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class SimResultsVariables: public ::schema::simxml::ResourcesGeneral::SimResultsVisualization
      {
        public:
        // VariableName
        //
        ...
        typedef ::xsd::cxx::tree::traits< Unit_String_type, char > Unit_String_traits;

        const Unit_String_optional&
        Unit_String () const;

        Unit_String_optional&
        Unit_String ();
        ...
        void
        Unit_String (::std::auto_ptr< Unit_String_type > p);
        ...
        Unit_String_optional Unit_String_;
