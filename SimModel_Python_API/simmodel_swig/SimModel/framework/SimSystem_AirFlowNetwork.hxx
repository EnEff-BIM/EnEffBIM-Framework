...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimSystem_AirFlowNetwork: public ::schema::simxml::BuildingModel::SimSystem
      {
        public:
        ...
        //
        typedef ::xml_schema::string SimSys_HtSelectLocalWindPressCalc_type;
        typedef ::xsd::cxx::tree::optional< SimSys_HtSelectLocalWindPressCalc_type > SimSys_HtSelectLocalWindPressCalc_optional;
        typedef ::xsd::cxx::tree::traits< SimSys_HtSelectLocalWindPressCalc_type, char > SimSys_HtSelectLocalWindPressCalc_traits;

        const SimSys_HtSelectLocalWindPressCalc_optional&
        SimSys_HtSelectLocalWindPressCalc () const;

        SimSys_HtSelectLocalWindPressCalc_optional&
        SimSys_HtSelectLocalWindPressCalc ();
        ...
        void
        SimSys_HtSelectLocalWindPressCalc (::std::auto_ptr< SimSys_HtSelectLocalWindPressCalc_type > p);
        ...
        SimSys_HtSelectLocalWindPressCalc_optional SimSys_HtSelectLocalWindPressCalc_;
