    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimulationConfiguration
          //
          if (n.name () == "SimulationConfiguration" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimulationStatus
          //
          if (n.name () == "SimulationStatus" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // RunStartDateTime
          //
          if (n.name () == "RunStartDateTime" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // RunEndDateTime
          //
          if (n.name () == "RunEndDateTime" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ResultsURL
          //
          if (n.name () == "ResultsURL" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SimulationProcessID
          //
          if (n.name () == "SimulationProcessID" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
