...
#ifndef SIM_WALL_OTHER_SIDE_COEFFICIENTS_DETAILED_HXX
#define SIM_WALL_OTHER_SIDE_COEFFICIENTS_DETAILED_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimWall_OtherSideCoefficients_Detailed: public ::schema::simxml::BuildingModel::SimWall_OtherSideCoefficients
      {
        public:
        ...
        SimWall_OtherSideCoefficients_Detailed (const RefId_type&);
        ...
        virtual SimWall_OtherSideCoefficients_Detailed*
...
#endif // SIM_WALL_OTHER_SIDE_COEFFICIENTS_DETAILED_HXX
