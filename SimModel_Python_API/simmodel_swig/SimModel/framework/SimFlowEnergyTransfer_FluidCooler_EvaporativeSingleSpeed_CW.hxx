...
#ifndef SIM_FLOW_ENERGY_TRANSFER_FLUID_COOLER_EVAPORATIVE_SINGLE_SPEED_CW_HXX
#define SIM_FLOW_ENERGY_TRANSFER_FLUID_COOLER_EVAPORATIVE_SINGLE_SPEED_CW_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_FluidCooler_EvaporativeSingleSpeed_CW: public ::schema::simxml::MepModel::SimFlowEnergyTransfer_FluidCooler
      {
        public:
        ...
        SimFlowEnergyTransfer_FluidCooler_EvaporativeSingleSpeed_CW (const RefId_type&);
        ...
        virtual SimFlowEnergyTransfer_FluidCooler_EvaporativeSingleSpeed_CW*
...
#endif // SIM_FLOW_ENERGY_TRANSFER_FLUID_COOLER_EVAPORATIVE_SINGLE_SPEED_CW_HXX
