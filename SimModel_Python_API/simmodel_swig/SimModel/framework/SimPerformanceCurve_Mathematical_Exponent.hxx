...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeometry
    {
      class SimPerformanceCurve_Mathematical_Exponent: public ::schema::simxml::ResourcesGeometry::SimPerformanceCurve_Mathematical
      {
        public:
        ...
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimPerfCurve_Coeff_1_3_Const_type;
