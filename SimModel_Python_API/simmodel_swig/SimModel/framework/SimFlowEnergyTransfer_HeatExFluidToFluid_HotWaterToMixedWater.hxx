...
#ifndef SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_HOT_WATER_TO_MIXED_WATER_HXX
#define SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_HOT_WATER_TO_MIXED_WATER_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatExFluidToFluid_HotWaterToMixedWater;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatExFluidToFluid_HotWaterToMixedWater: public ::schema::simxml::MepModel::SimFlowEnergyTransfer_HeatExFluidToFluid
      {
        public:
        ...
        SimFlowEnergyTransfer_HeatExFluidToFluid_HotWaterToMixedWater (const RefId_type&);
        ...
        virtual SimFlowEnergyTransfer_HeatExFluidToFluid_HotWaterToMixedWater*
...
#endif // SIM_FLOW_ENERGY_TRANSFER_HEAT_EX_FLUID_TO_FLUID_HOT_WATER_TO_MIXED_WATER_HXX
