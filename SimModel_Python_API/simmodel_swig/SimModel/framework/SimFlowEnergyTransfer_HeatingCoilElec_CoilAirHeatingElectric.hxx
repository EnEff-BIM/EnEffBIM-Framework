...
#ifndef SIM_FLOW_ENERGY_TRANSFER_HEATING_COIL_ELEC_COIL_AIR_HEATING_ELECTRIC_HXX
#define SIM_FLOW_ENERGY_TRANSFER_HEATING_COIL_ELEC_COIL_AIR_HEATING_ELECTRIC_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatingCoilElec_CoilAirHeatingElectric: public ::schema::simxml::MepModel::SimFlowEnergyTransfer_HeatingCoilElec
      {
        public:
        ...
        SimFlowEnergyTransfer_HeatingCoilElec_CoilAirHeatingElectric (const RefId_type&);
        ...
        virtual SimFlowEnergyTransfer_HeatingCoilElec_CoilAirHeatingElectric*
...
#endif // SIM_FLOW_ENERGY_TRANSFER_HEATING_COIL_ELEC_COIL_AIR_HEATING_ELECTRIC_HXX
