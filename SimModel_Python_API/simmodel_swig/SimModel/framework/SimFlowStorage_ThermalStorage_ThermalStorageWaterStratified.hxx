...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowStorage_ThermalStorage_ThermalStorageWaterStratified: public ::schema::simxml::MepModel::SimFlowStorage_ThermalStorage
      {
        public:
        // SimFlowSto_TankVol
        //
        ...
        //
        typedef ::schema::simxml::SimModelCore::doubleList SimFlowSto_NodeAddLossCoef_1_10_type;
