    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // TemplateGeneralSimParams
          //
          if (n.name () == "TemplateGeneralSimParams" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateRunPeriod
          //
          if (n.name () == "TemplateRunPeriod" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateSpecialDays
          //
          if (n.name () == "TemplateSpecialDays" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateDaylightSavings
          //
          if (n.name () == "TemplateDaylightSavings" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SurfaceConvectionAlgorithmInside
          //
          if (n.name () == "SurfaceConvectionAlgorithmInside" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SurfaceConvectionAlgorithmOutside
          //
          if (n.name () == "SurfaceConvectionAlgorithmOutside" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateHeatBalanceAlgorithm
          //
          if (n.name () == "TemplateHeatBalanceAlgorithm" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateZoneAirHeatBalAlgorithm
          //
          if (n.name () == "TemplateZoneAirHeatBalAlgorithm" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateGroundHeatTransfer
          //
          if (n.name () == "TemplateGroundHeatTransfer" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateSurfaceTypeConvCoeff
          //
          if (n.name () == "TemplateSurfaceTypeConvCoeff" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateParametricSetValue
          //
          if (n.name () == "TemplateParametricSetValue" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateParametricLogic
          //
          if (n.name () == "TemplateParametricLogic" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateParametricPerformRun
          //
          if (n.name () == "TemplateParametricPerformRun" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateParametricFileNameSuffix
          //
          if (n.name () == "TemplateParametricFileNameSuffix" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TemplateGlobalSizingParams
          //
          if (n.name () == "TemplateGlobalSizingParams" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
