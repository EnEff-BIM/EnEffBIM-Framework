    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // PanelType
          //
          if (n.name () == "PanelType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TopLeftExtension
          //
          if (n.name () == "TopLeftExtension" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // BottomRightExtension
          //
          if (n.name () == "BottomRightExtension" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // DistanceFromWinEdge
          //
          if (n.name () == "DistanceFromWinEdge" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TiltAngleFromDoorWindow
          //
          if (n.name () == "TiltAngleFromDoorWindow" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ShadedWindowParams
          //
          if (n.name () == "ShadedWindowParams" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
