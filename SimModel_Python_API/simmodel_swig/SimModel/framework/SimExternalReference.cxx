    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // RelatedObjects
          //
          if (n.name () == "RelatedObjects" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // DocumentID
          //
          if (n.name () == "DocumentID" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // IntendedUse
          //
          if (n.name () == "IntendedUse" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // Scope
          //
          if (n.name () == "Scope" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // Revision
          //
          if (n.name () == "Revision" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // DocumentOwner
          //
          if (n.name () == "DocumentOwner" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
