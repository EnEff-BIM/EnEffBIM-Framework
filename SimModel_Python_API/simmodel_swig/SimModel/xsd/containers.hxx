  ...
  namespace cxx
  {
    namespace tree
    {
      ...
      public:
        ...
        get () const
        {
		  /*if(std::is_same<T, xml_schema::decimal>::value)
		  {
			  return (double)x_;
		  }

		  if(std::is_same<T, xml_schema::double_>::value)
		  {
			  return (double)x_;
		  }

		  if(std::is_same<T, xml_schema::float_>::value)
		  {
			  return (double)x_;
		  }*/
		...
		T getValue()
		{
		  ...
		  else if(std::is_same<T, xml_schema::double_>::value)
		  {
			  //return 2;
			  return (double)x_;
		  }
		  else if(std::is_same<T, xml_schema::float_>::value)
		  {
			  //return 3;
			  return (double)x_;
		  }
