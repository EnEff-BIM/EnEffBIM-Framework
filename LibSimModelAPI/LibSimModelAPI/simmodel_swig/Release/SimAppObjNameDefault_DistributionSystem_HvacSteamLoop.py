...
class SimAppObjNameDefault_DistributionSystem_HvacSteamLoop_sequence(base.sequence_common):
    ...
    def detach(self, position, r, erase=True):
        return _SimAppObjNameDefault_DistributionSystem_HvacSteamLoop.SimAppObjNameDefault_DistributionSystem_HvacSteamLoop_sequence_detach(self, position, r, erase)

    def swap(self, x):
        return _SimAppObjNameDefault_DistributionSystem_HvacSteamLoop.SimAppObjNameDefault_DistributionSystem_HvacSteamLoop_sequence_swap(self, x)
    __swig_destroy__ = _SimAppObjNameDefault_DistributionSystem_HvacSteamLoop.delete_SimAppObjNameDefault_DistributionSystem_HvacSteamLoop_sequence
    __del__ = lambda self: None
SimAppObjNameDefault_DistributionSystem_HvacSteamLoop_sequence_swigregister = _SimAppObjNameDefault_DistributionSystem_HvacSteamLoop.SimAppObjNameDefault_DistributionSystem_HvacSteamLoop_sequence_swigregister
SimAppObjNameDefault_DistributionSystem_HvacSteamLoop_sequence_swigregister(SimAppObjNameDefault_DistributionSystem_HvacSteamLoop_sequence)
