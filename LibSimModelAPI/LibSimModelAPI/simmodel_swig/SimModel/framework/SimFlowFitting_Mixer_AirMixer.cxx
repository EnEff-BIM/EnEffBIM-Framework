...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowFitting_Mixer_AirMixer::SimFlowFitting_Name_optional& SimFlowFitting_Mixer_AirMixer::
      SimFlowFitting_Name () const
      {
        return this->SimFlowFitting_Name_;
      }

      SimFlowFitting_Mixer_AirMixer::SimFlowFitting_Name_optional& SimFlowFitting_Mixer_AirMixer::
      SimFlowFitting_Name ()
      {
        return this->SimFlowFitting_Name_;
      }
