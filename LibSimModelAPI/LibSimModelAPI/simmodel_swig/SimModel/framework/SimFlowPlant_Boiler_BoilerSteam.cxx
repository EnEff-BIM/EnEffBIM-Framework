...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowPlant_Boiler_BoilerSteam::SimFlowPlant_Name_optional& SimFlowPlant_Boiler_BoilerSteam::
      SimFlowPlant_Name () const
      {
        return this->SimFlowPlant_Name_;
      }

      SimFlowPlant_Boiler_BoilerSteam::SimFlowPlant_Name_optional& SimFlowPlant_Boiler_BoilerSteam::
      SimFlowPlant_Name ()
      {
        return this->SimFlowPlant_Name_;
      }
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowPlant_MaxOperatPressure
          //
          if (n.name () == "SimFlowPlant_MaxOperatPressure" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_TheoreticalEff
          //
          if (n.name () == "SimFlowPlant_TheoreticalEff" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_DesignOutletSteamTemp
          //
          if (n.name () == "SimFlowPlant_DesignOutletSteamTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList
          //
          if (n.name () == "SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_SteamOutletNodeName
          //
          if (n.name () == "SimFlowPlant_SteamOutletNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
