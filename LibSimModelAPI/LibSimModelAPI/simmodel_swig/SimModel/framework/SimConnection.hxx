...
#ifndef SIM_CONNECTION_HXX
#define SIM_CONNECTION_HXX
  ...
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class SimConnection: public ::schema::simxml::SimModelCore::SimResourceObject
      {
        ...
        void
        RealizingElement (::std::auto_ptr< RealizingElement_type > p);
        ...
        void
        SourcePort (::std::auto_ptr< SourcePort_type > p);
        ...
        void
        TargetPort (::std::auto_ptr< TargetPort_type > p);

        // Constructors.
        //
        SimConnection ();

        SimConnection (const RefId_type&);
        ...
        RealizingElement_optional RealizingElement_;
        SourcePort_optional SourcePort_;
        TargetPort_optional TargetPort_;
      };
    }
  }
}
