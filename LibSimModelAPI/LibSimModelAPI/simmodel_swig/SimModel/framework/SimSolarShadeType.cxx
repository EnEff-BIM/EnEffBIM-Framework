...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      ...
      const SimSolarShadeType::RepresentationMaps_optional& SimSolarShadeType::
      RepresentationMaps () const
      {
        return this->RepresentationMaps_;
      }

      SimSolarShadeType::RepresentationMaps_optional& SimSolarShadeType::
      RepresentationMaps ()
      {
        return this->RepresentationMaps_;
      }

      void SimSolarShadeType::
      ...
      const SimSolarShadeType::Tag_optional& SimSolarShadeType::
      Tag () const
      {
        return this->Tag_;
      }

      SimSolarShadeType::Tag_optional& SimSolarShadeType::
      Tag ()
      {
        return this->Tag_;
      }
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      ...
      SimSolarShadeType::
      SimSolarShadeType (const RefId_type& RefId)
      ...
      SimSolarShadeType::
      SimSolarShadeType (const SimSolarShadeType& x,
                         ::xml_schema::flags f,
      ...
      SimSolarShadeType::
      SimSolarShadeType (const ::xercesc::DOMElement& e,
                         ::xml_schema::flags f,
                         ::xml_schema::container* c)
      ...
      SimSolarShadeType* SimSolarShadeType::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimSolarShadeType (*this, f, c);
      }

      SimSolarShadeType& SimSolarShadeType::
      operator= (const SimSolarShadeType& x)
      {
        if (this != &x)
        {
