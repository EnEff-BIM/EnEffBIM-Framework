    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SpaceNumber
          //
          if (n.name () == "SpaceNumber" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SpaceName
          //
          if (n.name () == "SpaceName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // FlipX
          //
          if (n.name () == "FlipX" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
            if (!this->FlipX_)
            {
          ...
          // FlipY
          //
          if (n.name () == "FlipY" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
            if (!this->FlipY_)
            {
          ...
          // IsPerimeterSpace
          //
          if (n.name () == "IsPerimeterSpace" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // SpaceType
          //
          if (n.name () == "SpaceType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
