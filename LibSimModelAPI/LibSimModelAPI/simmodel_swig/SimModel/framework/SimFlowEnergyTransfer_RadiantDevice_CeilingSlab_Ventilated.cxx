...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowEnergyTransfer_RadiantDevice_CeilingSlab_Ventilated::SimFlowEnergyTrans_Name_optional& SimFlowEnergyTransfer_RadiantDevice_CeilingSlab_Ventilated::
      SimFlowEnergyTrans_Name () const
      {
        return this->SimFlowEnergyTrans_Name_;
      }

      SimFlowEnergyTransfer_RadiantDevice_CeilingSlab_Ventilated::SimFlowEnergyTrans_Name_optional& SimFlowEnergyTransfer_RadiantDevice_CeilingSlab_Ventilated::
