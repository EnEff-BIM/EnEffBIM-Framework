...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      // SimController_SupplyAir
      // 

      const SimController_SupplyAir::SimCntrl_Name_optional& SimController_SupplyAir::
      SimCntrl_Name () const
      {
        return this->SimCntrl_Name_;
      }

      SimController_SupplyAir::SimCntrl_Name_optional& SimController_SupplyAir::
      SimCntrl_Name ()
      {
        return this->SimCntrl_Name_;
      }

      void SimController_SupplyAir::
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimController_SupplyAir::
      SimController_SupplyAir (const RefId_type& RefId)
      ...
      SimController_SupplyAir::
      SimController_SupplyAir (const SimController_SupplyAir& x,
                               ::xml_schema::flags f,
      ...
      SimController_SupplyAir::
      SimController_SupplyAir (const ::xercesc::DOMElement& e,
                               ::xml_schema::flags f,
                               ::xml_schema::container* c)
      ...
      SimController_SupplyAir* SimController_SupplyAir::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimController_SupplyAir (*this, f, c);
      }

      SimController_SupplyAir& SimController_SupplyAir::
      operator= (const SimController_SupplyAir& x)
      {
        if (this != &x)
        {
