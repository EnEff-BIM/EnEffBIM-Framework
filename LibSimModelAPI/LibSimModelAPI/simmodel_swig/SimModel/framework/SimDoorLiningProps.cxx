    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // ThresholdDepth
          //
          if (n.name () == "ThresholdDepth" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ThresholdThickness
          //
          if (n.name () == "ThresholdThickness" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // TransomOffset
          //
          if (n.name () == "TransomOffset" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // LiningOffset
          //
          if (n.name () == "LiningOffset" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // ThresholdOffset
          //
          if (n.name () == "ThresholdOffset" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // CasingThickness
          //
          if (n.name () == "CasingThickness" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
          ...
          // CasingDepth
          //
          if (n.name () == "CasingDepth" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeneral")
          {
