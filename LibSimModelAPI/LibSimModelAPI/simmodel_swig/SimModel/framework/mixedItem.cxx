    ...
    namespace SimModelCore
    {
             ...
             ::xml_schema::flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // booleanItem
          //
          if (n.name () == "booleanItem" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/SimModelCore")
          {
          ...
          // doubleItem
          //
          if (n.name () == "doubleItem" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/SimModelCore")
          {
            if (!this->doubleItem_)
            {
          ...
          // integerItem
          //
          if (n.name () == "integerItem" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/SimModelCore")
          {
          ...
          // logicalItem
          //
          if (n.name () == "logicalItem" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/SimModelCore")
          {
