...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowCompoundEqmt_UnitaryZoneEqmt_UnitVentialtor::SimFlowCompEqmt_Name_optional& SimFlowCompoundEqmt_UnitaryZoneEqmt_UnitVentialtor::
      SimFlowCompEqmt_Name () const
      {
        return this->SimFlowCompEqmt_Name_;
      }

      SimFlowCompoundEqmt_UnitaryZoneEqmt_UnitVentialtor::SimFlowCompEqmt_Name_optional& SimFlowCompoundEqmt_UnitaryZoneEqmt_UnitVentialtor::
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowCompEqmt_OutdrAirCntlType
          //
          if (n.name () == "SimFlowCompEqmt_OutdrAirCntlType" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MinOutdrAirFlowRate
          //
          if (n.name () == "SimFlowCompEqmt_MinOutdrAirFlowRate" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MinOutdrAirSchedName
          //
          if (n.name () == "SimFlowCompEqmt_MinOutdrAirSchedName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MaxOutdrAirFractOrTempSchedName
          //
          if (n.name () == "SimFlowCompEqmt_MaxOutdrAirFractOrTempSchedName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_ExhAirNodeName
          //
          if (n.name () == "SimFlowCompEqmt_ExhAirNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_MixedAirNodeName
          //
          if (n.name () == "SimFlowCompEqmt_MixedAirNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowCompEqmt_CoilOption
          //
          if (n.name () == "SimFlowCompEqmt_CoilOption" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
