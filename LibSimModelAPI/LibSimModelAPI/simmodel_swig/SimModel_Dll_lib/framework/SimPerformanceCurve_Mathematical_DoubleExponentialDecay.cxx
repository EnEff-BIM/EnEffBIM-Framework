...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeometry
    {
      ...
      const SimPerformanceCurve_Mathematical_DoubleExponentialDecay::SimPerfCurve_InputUnitTypeForX_optional& SimPerformanceCurve_Mathematical_DoubleExponentialDecay::
      SimPerfCurve_InputUnitTypeForX () const
      {
        return this->SimPerfCurve_InputUnitTypeForX_;
      }

      SimPerformanceCurve_Mathematical_DoubleExponentialDecay::SimPerfCurve_InputUnitTypeForX_optional& SimPerformanceCurve_Mathematical_DoubleExponentialDecay::
    ...
    namespace ResourcesGeometry
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimPerfCurve_Coeff3C4
          //
          if (n.name () == "SimPerfCurve_Coeff3C4" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
          ...
          // SimPerfCurve_Coeff3C5
          //
          if (n.name () == "SimPerfCurve_Coeff3C5" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/ResourcesGeometry")
          {
