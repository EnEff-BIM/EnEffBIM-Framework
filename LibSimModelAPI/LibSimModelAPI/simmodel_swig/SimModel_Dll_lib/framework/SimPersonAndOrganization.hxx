...
#ifndef SIM_PERSON_AND_ORGANIZATION_HXX
#define SIM_PERSON_AND_ORGANIZATION_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimPersonAndOrganization;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimPersonAndOrganization: public ::schema::simxml::SimModelCore::SimActorDefinition
      {
        public:
        // ThePerson
        //
        ...
        SimPersonAndOrganization (const RefId_type&);
        ...
        virtual SimPersonAndOrganization*
...
#endif // SIM_PERSON_AND_ORGANIZATION_HXX
