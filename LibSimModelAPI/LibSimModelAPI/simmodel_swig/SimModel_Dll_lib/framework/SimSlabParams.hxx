...
#ifndef SIM_SLAB_PARAMS_HXX
#define SIM_SLAB_PARAMS_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimSlabParams: public ::schema::simxml::SimModelCore::SimBldgModelParams
      {
        public:
        // DimensionX
        //
        ...
        SimSlabParams (const RefId_type&);
        ...
        SlabElevation_optional SlabElevation_;
