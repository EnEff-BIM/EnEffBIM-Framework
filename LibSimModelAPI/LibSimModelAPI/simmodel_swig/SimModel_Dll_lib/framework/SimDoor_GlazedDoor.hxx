...
#ifndef SIM_DOOR_GLAZED_DOOR_HXX
#define SIM_DOOR_GLAZED_DOOR_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimDoor_GlazedDoor: public ::schema::simxml::BuildingModel::SimDoor
      {
        public:
        // DoorTypeTag
        //
        ...
        SimDoor_GlazedDoor (const RefId_type&);
...
#endif // SIM_DOOR_GLAZED_DOOR_HXX
