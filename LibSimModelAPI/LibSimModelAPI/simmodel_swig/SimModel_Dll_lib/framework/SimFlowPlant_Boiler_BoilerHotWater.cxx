...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      const SimFlowPlant_Boiler_BoilerHotWater::SimFlowPlant_Name_optional& SimFlowPlant_Boiler_BoilerHotWater::
      SimFlowPlant_Name () const
      {
        return this->SimFlowPlant_Name_;
      }

      SimFlowPlant_Boiler_BoilerHotWater::SimFlowPlant_Name_optional& SimFlowPlant_Boiler_BoilerHotWater::
      SimFlowPlant_Name ()
      {
        return this->SimFlowPlant_Name_;
      }
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      ...
      SimFlowPlant_Boiler_BoilerHotWater::
      SimFlowPlant_Boiler_BoilerHotWater ()
      : ::schema::simxml::MepModel::SimFlowPlant_Boiler (),
      ...
      : ::schema::simxml::MepModel::SimFlowPlant_Boiler (RefId),
        SimFlowPlant_Name_ (this),
        SimFlowPlant_FuelType_ (this),
        SimFlowPlant_NomCap_ (this),
        SimFlowPlant_NomThermalEff_ (this),
      ...
      : ::schema::simxml::MepModel::SimFlowPlant_Boiler (x, f, c),
      ...
      SimFlowPlant_Boiler_BoilerHotWater (const ::xercesc::DOMElement& e,
                                          ::xml_schema::flags f,
                                          ::xml_schema::container* c)
      : ::schema::simxml::MepModel::SimFlowPlant_Boiler (e, f | ::xml_schema::flags::base, c),
        SimFlowPlant_Name_ (this),
        SimFlowPlant_FuelType_ (this),
        SimFlowPlant_NomCap_ (this),
        SimFlowPlant_NomThermalEff_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::schema::simxml::MepModel::SimFlowPlant_Boiler::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowPlant_NomThermalEff
          //
          if (n.name () == "SimFlowPlant_NomThermalEff" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_EfficiencyCurveTempEvaluationVar
          //
          if (n.name () == "SimFlowPlant_EfficiencyCurveTempEvaluationVar" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_NrmlizedBoilerEffCurveName
          //
          if (n.name () == "SimFlowPlant_NrmlizedBoilerEffCurveName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_DesignWaterOutletTemp
          //
          if (n.name () == "SimFlowPlant_DesignWaterOutletTemp" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_BoilerWaterInletNodeName
          //
          if (n.name () == "SimFlowPlant_BoilerWaterInletNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_BoilerWaterOutletNodeName
          //
          if (n.name () == "SimFlowPlant_BoilerWaterOutletNodeName" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_WaterOutletUpTempLimit
          //
          if (n.name () == "SimFlowPlant_WaterOutletUpTempLimit" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_BoilerFlowMode
          //
          if (n.name () == "SimFlowPlant_BoilerFlowMode" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
          ...
          // SimFlowPlant_ParasiticElecLoad
          //
          if (n.name () == "SimFlowPlant_ParasiticElecLoad" && n.namespace_ () == "http://d-alchemy.com/schema/simxml/MepModel")
          {
      ...
      operator= (const SimFlowPlant_Boiler_BoilerHotWater& x)
      {
        if (this != &x)
        {
          static_cast< ::schema::simxml::MepModel::SimFlowPlant_Boiler& > (*this) = x;
