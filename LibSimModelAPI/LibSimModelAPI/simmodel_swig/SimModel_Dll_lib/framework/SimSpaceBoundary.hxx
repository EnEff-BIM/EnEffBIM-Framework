...
#ifndef SIM_SPACE_BOUNDARY_HXX
#define SIM_SPACE_BOUNDARY_HXX
  ...
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class SimSpaceBoundary: public ::schema::simxml::SimModelCore::SimResourceObject
      {
        ...
        void
        RelatingSpace (::std::auto_ptr< RelatingSpace_type > p);
        ...
        OthersideSpaceBoundary_optional&
        OthersideSpaceBoundary ();
        ...
        void
        OthersideSpaceBoundary (::std::auto_ptr< OthersideSpaceBoundary_type > p);

        // ChildSpaceBoundaries
        //
        typedef ::xml_schema::idrefs ChildSpaceBoundaries_type;
        typedef ::xsd::cxx::tree::optional< ChildSpaceBoundaries_type > ChildSpaceBoundaries_optional;
        typedef ::xsd::cxx::tree::traits< ChildSpaceBoundaries_type, char > ChildSpaceBoundaries_traits;

        const ChildSpaceBoundaries_optional&
        ChildSpaceBoundaries () const;

        ChildSpaceBoundaries_optional&
        ChildSpaceBoundaries ();
        ...
        SimSpaceBoundary (const RefId_type&);
        ...
        protected:
        RelatingSpace_optional RelatingSpace_;
