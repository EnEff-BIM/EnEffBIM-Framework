...
#ifndef SIM_BLDG_MODEL_PARAMS_HXX
#define SIM_BLDG_MODEL_PARAMS_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace SimModelCore
    {
      class __declspec(dllexport) SimBldgModelParams: public ::schema::simxml::SimModelCore::SimResourceObject
      {
        public:
        // ObjectIndex
        //
        ...
        void
        ObjectName (::std::auto_ptr< ObjectName_type > p);

        // IsAutoGenerated
        //
        typedef ::xml_schema::boolean IsAutoGenerated_type;
        typedef ::xsd::cxx::tree::optional< IsAutoGenerated_type > IsAutoGenerated_optional;
        typedef ::xsd::cxx::tree::traits< IsAutoGenerated_type, char > IsAutoGenerated_traits;

        const IsAutoGenerated_optional&
        IsAutoGenerated () const;

        IsAutoGenerated_optional&
        IsAutoGenerated ();
        ...
        LocalPlacementRotation_optional&
        LocalPlacementRotation ();
        ...
        SimBldgModelParams (const RefId_type&);
        ...
        protected:
        ObjectIndex_optional ObjectIndex_;
        ObjectName_optional ObjectName_;
        IsAutoGenerated_optional IsAutoGenerated_;
        ...
        XDirectionZ_optional XDirectionZ_;
      };
    }
  }
}
...
#endif // SIM_BLDG_MODEL_PARAMS_HXX
