...
#ifndef SIM_APP_LIBRARY_DEFAULT_HXX
#define SIM_APP_LIBRARY_DEFAULT_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimAppLibraryDefault: public ::schema::simxml::SimModelCore::SimAppDefault
      {
        public:
        ...
        DefaultforLibraryType_optional&
        DefaultforLibraryType ();
        ...
        void
        DefaultforLibraryType (::std::auto_ptr< DefaultforLibraryType_type > p);
        ...
        DefaultPreferenceIndex_optional&
        DefaultPreferenceIndex ();
        ...
        void
        LibraryLocation (::std::auto_ptr< LibraryLocation_type > p);
        ...
        void
        LibraryName (::std::auto_ptr< LibraryName_type > p);

        // Constructors.
        //
        SimAppLibraryDefault ();

        SimAppLibraryDefault (const RefId_type&);
        ...
        protected:
        DefaultforLibraryType_optional DefaultforLibraryType_;
        DefaultPreferenceIndex_optional DefaultPreferenceIndex_;
        LibraryLocation_optional LibraryLocation_;
        LibraryName_optional LibraryName_;
      };
    }
  }
}
...
#endif // SIM_APP_LIBRARY_DEFAULT_HXX
