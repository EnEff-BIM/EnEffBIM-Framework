...
#ifndef SIM_CONTROLLER_SUPPLY_WATER_HXX
#define SIM_CONTROLLER_SUPPLY_WATER_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimController_SupplyWater;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class __declspec(dllexport) SimController_SupplyWater: public ::schema::simxml::MepModel::SimController
      {
        public:
        // SimCntrl_Name
        //
        ...
        SimController_SupplyWater (const RefId_type&);
        ...
        virtual SimController_SupplyWater*
...
#endif // SIM_CONTROLLER_SUPPLY_WATER_HXX
