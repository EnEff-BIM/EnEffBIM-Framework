...
#ifndef SIM_ADDRESS_POSTAL_HXX
#define SIM_ADDRESS_POSTAL_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimAddress_Postal: public ::schema::simxml::ResourcesGeneral::SimAddress
      {
        public:
        // InternalLocation
        //
        ...
        // AddressLines
        //
        typedef ::schema::simxml::ResourcesGeneral::AddressLines AddressLines_type;
        typedef ::xsd::cxx::tree::optional< AddressLines_type > AddressLines_optional;
        typedef ::xsd::cxx::tree::traits< AddressLines_type, char > AddressLines_traits;

        const AddressLines_optional&
        AddressLines () const;

        AddressLines_optional&
        AddressLines ();
        ...
        void
        AddressLines (::std::auto_ptr< AddressLines_type > p);
        ...
        SimAddress_Postal (const RefId_type&);
        ...
        AddressLines_optional AddressLines_;
