...
#ifndef SIM_SLAB_CEILING_HXX
#define SIM_SLAB_CEILING_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimSlab_Ceiling: public ::schema::simxml::BuildingModel::SimSlab
      {
        public:
        // Name
        //
        ...
        SimSlab_Ceiling (const RefId_type&);
