...
#ifndef SIM_SLAB_DEFAULT_HXX
#define SIM_SLAB_DEFAULT_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class __declspec(dllexport) SimSlab_Default: public ::schema::simxml::BuildingModel::SimSlab
      {
        public:
        // Name
        //
        ...
        SimSlab_Default (const RefId_type&);
