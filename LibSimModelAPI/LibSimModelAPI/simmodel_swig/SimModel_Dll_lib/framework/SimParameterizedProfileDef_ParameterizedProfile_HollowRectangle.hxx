...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeometry
    {
      class SimParameterizedProfileDef_ParameterizedProfile_HollowRectangle: public ::schema::simxml::ResourcesGeometry::SimParameterizedProfileDef_ParameterizedProfile
      {
        public:
        // XDim
        //
