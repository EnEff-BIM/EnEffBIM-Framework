...
#ifndef SIM_GEOM_BOOLEAN_RESULT_HXX
#define SIM_GEOM_BOOLEAN_RESULT_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeometry
    {
      class __declspec(dllexport) SimGeomBooleanResult: public ::schema::simxml::SimModelCore::SimGeometricRepresentationItem
      {
        public:
        // Operator
        //
        ...
        void
        Operator (::std::auto_ptr< Operator_type > p);
        ...
        void
        FirstOperand (::std::auto_ptr< FirstOperand_type > p);
        ...
        void
        SecondOperand (::std::auto_ptr< SecondOperand_type > p);

        // Constructors.
        //
        SimGeomBooleanResult ();

        SimGeomBooleanResult (const RefId_type&);
        ...
        protected:
        Operator_optional Operator_;
        FirstOperand_optional FirstOperand_;
        SecondOperand_optional SecondOperand_;
      };
    }
  }
}
...
#endif // SIM_GEOM_BOOLEAN_RESULT_HXX
