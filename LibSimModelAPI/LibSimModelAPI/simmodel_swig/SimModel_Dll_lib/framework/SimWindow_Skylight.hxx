...
#ifndef SIM_WINDOW_SKYLIGHT_HXX
#define SIM_WINDOW_SKYLIGHT_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimWindow_Skylight: public ::schema::simxml::BuildingModel::SimWindow
      {
        public:
        // SimWindow_Name
        //
        ...
        SimWindow_Skylight (const RefId_type&);
