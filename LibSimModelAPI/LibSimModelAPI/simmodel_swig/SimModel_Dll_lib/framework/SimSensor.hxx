...
#ifndef SIM_SENSOR_HXX
#define SIM_SENSOR_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class __declspec(dllexport) SimSensor: public ::schema::simxml::SimModelCore::SimDistributionControlElement
      {
        public:
        // Representation
        //
