...
#ifndef SIM_MATERIAL_LAYER_HXX
#define SIM_MATERIAL_LAYER_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimMaterialLayer: public ::schema::simxml::SimModelCore::SimResourceObject
      {
        public:
        // LayerMaterial
        //
        ...
        void
        LayerMaterial (::std::auto_ptr< LayerMaterial_type > p);
        ...
        // IsVentilated
        //
        typedef ::schema::simxml::SimModelCore::logical IsVentilated_type;
        ...
        void
        MaterialLayerName (::std::auto_ptr< MaterialLayerName_type > p);

        // Constructors.
        //
        SimMaterialLayer ();

        SimMaterialLayer (const RefId_type&);
        ...
        protected:
        LayerMaterial_optional LayerMaterial_;
        LayerThickness_optional LayerThickness_;
        IsVentilated_optional IsVentilated_;
        MaterialLayerName_optional MaterialLayerName_;
      };
    }
  }
}
