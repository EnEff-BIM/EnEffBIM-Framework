...
#ifndef SIM_MATERIAL_LAYER_SET_OPAQUE_LAYER_SET_CEILING_HXX
#define SIM_MATERIAL_LAYER_SET_OPAQUE_LAYER_SET_CEILING_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimMaterialLayerSet_OpaqueLayerSet_Ceiling: public ::schema::simxml::ResourcesGeneral::SimMaterialLayerSet_OpaqueLayerSet
      {
        public:
        ...
        SimMaterialLayerSet_OpaqueLayerSet_Ceiling (const RefId_type&);
        ...
        virtual SimMaterialLayerSet_OpaqueLayerSet_Ceiling*
...
#endif // SIM_MATERIAL_LAYER_SET_OPAQUE_LAYER_SET_CEILING_HXX
