...
#ifndef SIM_WALL_WALL_EXTERIOR_ABOVE_GRADE_DETAILED_HXX
#define SIM_WALL_WALL_EXTERIOR_ABOVE_GRADE_DETAILED_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimWall_Wall_ExteriorAboveGradeDetailed;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace BuildingModel
    {
      class SimWall_Wall_ExteriorAboveGradeDetailed: public ::schema::simxml::BuildingModel::SimWall_Wall
      {
        public:
        ...
        SimWall_Wall_ExteriorAboveGradeDetailed (const RefId_type&);
        ...
        virtual SimWall_Wall_ExteriorAboveGradeDetailed*
...
#endif // SIM_WALL_WALL_EXTERIOR_ABOVE_GRADE_DETAILED_HXX
