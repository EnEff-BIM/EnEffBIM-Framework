...
#ifndef SIM_FLOW_PLANT_HEAT_PUMP_HXX
#define SIM_FLOW_PLANT_HEAT_PUMP_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace MepModel
    {
      class SimFlowPlant_HeatPump: public ::schema::simxml::MepModel::SimFlowPlant
      {
        public:
        // Representation
        //
        ...
        SimFlowPlant_HeatPump (const RefId_type&);
...
#endif // SIM_FLOW_PLANT_HEAT_PUMP_HXX
