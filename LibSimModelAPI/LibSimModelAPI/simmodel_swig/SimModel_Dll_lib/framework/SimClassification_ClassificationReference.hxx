...
#ifndef SIM_CLASSIFICATION_CLASSIFICATION_REFERENCE_HXX
#define SIM_CLASSIFICATION_CLASSIFICATION_REFERENCE_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimClassification_ClassificationReference;
    }
  }
}
  ...
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimClassification_ClassificationReference: public ::schema::simxml::ResourcesGeneral::SimClassification
      {
        ...
        SimClassification_ClassificationReference (const RefId_type&);
        ...
        virtual SimClassification_ClassificationReference*
...
#endif // SIM_CLASSIFICATION_CLASSIFICATION_REFERENCE_HXX
