...
#ifndef SIM_TIME_SERIES_SCHEDULE_WEEK_HXX
#define SIM_TIME_SERIES_SCHEDULE_WEEK_HXX
...
namespace schema
{
  namespace simxml
  {
    ...
    {
      class SimTimeSeriesSchedule_Week;
    }
  }
}
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimTimeSeriesSchedule_Week: public ::schema::simxml::ResourcesGeneral::SimTimeSeriesSchedule
      {
        public:
        ...
        void
        T24SchedDayAllDayRef (::std::auto_ptr< T24SchedDayAllDayRef_type > p);
        ...
        void
        T24SchedDayWkdaysRef (::std::auto_ptr< T24SchedDayWkdaysRef_type > p);
        ...
        void
        T24SchedDayWkEndsRef (::std::auto_ptr< T24SchedDayWkEndsRef_type > p);

        // Constructors.
        //
        SimTimeSeriesSchedule_Week ();

        SimTimeSeriesSchedule_Week (const RefId_type&);
        ...
        virtual SimTimeSeriesSchedule_Week*
        ...
        T24SchedDayAllDayRef_optional T24SchedDayAllDayRef_;
        T24SchedDayWkdaysRef_optional T24SchedDayWkdaysRef_;
        T24SchedDayWkEndsRef_optional T24SchedDayWkEndsRef_;
      };
    }
  }
}
...
#endif // SIM_TIME_SERIES_SCHEDULE_WEEK_HXX
