...
#ifndef SIM_ADDRESS_HXX
#define SIM_ADDRESS_HXX
...
namespace schema
{
  namespace simxml
  {
    namespace ResourcesGeneral
    {
      class __declspec(dllexport) SimAddress: public ::schema::simxml::SimModelCore::SimResourceObject
      {
        public:
        // Purpose
        //
        ...
        void
        UserDefinedPurpose (::std::auto_ptr< UserDefinedPurpose_type > p);

        // Constructors.
        //
        SimAddress ();

        SimAddress (const RefId_type&);
        ...
        UserDefinedPurpose_optional UserDefinedPurpose_;
      };
    }
  }
}
