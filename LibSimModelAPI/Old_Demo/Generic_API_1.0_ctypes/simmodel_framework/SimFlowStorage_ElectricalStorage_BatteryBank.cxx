...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      : ::namespaces::Sim::MepModel::SimFlowStorage_ElectricalStorage (RefId),
      ...
      : ::namespaces::Sim::MepModel::SimFlowStorage_ElectricalStorage (x, f, c),
      ...
      SimFlowStorage_ElectricalStorage_BatteryBank (const ::xercesc::DOMElement& e,
                                                    ::xml_schema::flags f,
                                                    ::xml_schema::container* c)
      : ::namespaces::Sim::MepModel::SimFlowStorage_ElectricalStorage (e, f | ::xml_schema::flags::base, c),
        SimFlowSto_RadiativeFract_ (this),
        SimFlowSto_NumberBatteryModsinParallel_ (this),
        SimFlowSto_NumberBatteryModsinSeries_ (this),
        SimFlowSto_MaxModCap_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::MepModel::SimFlowStorage_ElectricalStorage::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowSto_RadiativeFract
          //
          if (n.name () == "SimFlowSto_RadiativeFract" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_NumberBatteryModsinParallel
          //
          if (n.name () == "SimFlowSto_NumberBatteryModsinParallel" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_NumberBatteryModsinSeries
          //
          if (n.name () == "SimFlowSto_NumberBatteryModsinSeries" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_MaxModCap
          //
          if (n.name () == "SimFlowSto_MaxModCap" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_InitialFractionalStateChrg
          //
          if (n.name () == "SimFlowSto_InitialFractionalStateChrg" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_FractionAvailChrgCap
          //
          if (n.name () == "SimFlowSto_FractionAvailChrgCap" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_ChangeRatefromBoundChrgtoAvailChrg
          //
          if (n.name () == "SimFlowSto_ChangeRatefromBoundChrgtoAvailChrg" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_FullyChrgdModOpenCircVoltage
          //
          if (n.name () == "SimFlowSto_FullyChrgdModOpenCircVoltage" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_FullyDischargedModOpenCircVoltage
          //
          if (n.name () == "SimFlowSto_FullyDischargedModOpenCircVoltage" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_VoltChangeCurveNameCharging
          //
          if (n.name () == "SimFlowSto_VoltChangeCurveNameCharging" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_VoltChangeCurveNameDischarging
          //
          if (n.name () == "SimFlowSto_VoltChangeCurveNameDischarging" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_ModInternalElec
          //
          if (n.name () == "SimFlowSto_ModInternalElec" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_MaxModDischargingCurrent
          //
          if (n.name () == "SimFlowSto_MaxModDischargingCurrent" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_ModCut_offVoltage
          //
          if (n.name () == "SimFlowSto_ModCut_offVoltage" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_ModChrgRateLimit
          //
          if (n.name () == "SimFlowSto_ModChrgRateLimit" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_BatteryLifeCalculation
          //
          if (n.name () == "SimFlowSto_BatteryLifeCalculation" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_NumberCycleBins
          //
          if (n.name () == "SimFlowSto_NumberCycleBins" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSto_BatteryLifeCurveName
          //
          if (n.name () == "SimFlowSto_BatteryLifeCurveName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
      ...
      operator= (const SimFlowStorage_ElectricalStorage_BatteryBank& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::MepModel::SimFlowStorage_ElectricalStorage& > (*this) = x;
