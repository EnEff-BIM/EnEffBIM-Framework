...
#ifndef SIM_FLOW_PLANT_CHILLER_ABSORPTION_HXX
#define SIM_FLOW_PLANT_CHILLER_ABSORPTION_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowPlant_Chiller_Absorption: public ::namespaces::Sim::MepModel::SimFlowPlant_Chiller
      {
        public:
        // SimFlowPlant_NomCap
        //
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList_type > SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList_type, char > SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList_traits;

        const SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList_optional&
        SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList () const;

        SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList_optional&
        SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList ();
        ...
        void
        SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList (::std::auto_ptr< SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList_type > p);

        // SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList_type > SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList_type, char > SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList_traits;

        const SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList_optional&
        SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList () const;

        SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList_optional&
        SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList ();
        ...
        void
        SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList (::std::auto_ptr< SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList_type > p);

        // Constructors.
        //
        SimFlowPlant_Chiller_Absorption (const RefId_type&);
        ...
        virtual SimFlowPlant_Chiller_Absorption*
        ...
        SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList_optional SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList_;
        SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList_optional SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList_;
      };
    }
  }
}
...
#endif // SIM_FLOW_PLANT_CHILLER_ABSORPTION_HXX
