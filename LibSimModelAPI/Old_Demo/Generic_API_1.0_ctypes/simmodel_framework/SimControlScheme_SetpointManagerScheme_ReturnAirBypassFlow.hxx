...
#ifndef SIM_CONTROL_SCHEME_SETPOINT_MANAGER_SCHEME_RETURN_AIR_BYPASS_FLOW_HXX
#define SIM_CONTROL_SCHEME_SETPOINT_MANAGER_SCHEME_RETURN_AIR_BYPASS_FLOW_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      class SimControlScheme_SetpointManagerScheme_ReturnAirBypassFlow: public ::namespaces::Sim::ResourcesGeneral::SimControlScheme_SetpointManagerScheme
      {
        public:
        // SimCntrlSchm_Name
        //
        ...
        //
        typedef ::xml_schema::idref SimCntrlSchm_TempSetpointSchedName_type;
        typedef ::xsd::cxx::tree::optional< SimCntrlSchm_TempSetpointSchedName_type > SimCntrlSchm_TempSetpointSchedName_optional;
        typedef ::xsd::cxx::tree::traits< SimCntrlSchm_TempSetpointSchedName_type, char > SimCntrlSchm_TempSetpointSchedName_traits;

        const SimCntrlSchm_TempSetpointSchedName_optional&
        SimCntrlSchm_TempSetpointSchedName () const;

        SimCntrlSchm_TempSetpointSchedName_optional&
        SimCntrlSchm_TempSetpointSchedName ();
        ...
        void
        SimCntrlSchm_TempSetpointSchedName (::std::auto_ptr< SimCntrlSchm_TempSetpointSchedName_type > p);

        // Constructors.
        //
        SimControlScheme_SetpointManagerScheme_ReturnAirBypassFlow (const RefId_type&);
        ...
        virtual SimControlScheme_SetpointManagerScheme_ReturnAirBypassFlow*
        ...
        SimCntrlSchm_TempSetpointSchedName_optional SimCntrlSchm_TempSetpointSchedName_;
      };
    }
  }
}
...
#endif // SIM_CONTROL_SCHEME_SETPOINT_MANAGER_SCHEME_RETURN_AIR_BYPASS_FLOW_HXX
