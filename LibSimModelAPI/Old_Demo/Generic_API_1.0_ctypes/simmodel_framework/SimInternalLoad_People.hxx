...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      class SimInternalLoad_People: public ::namespaces::Sim::ResourcesGeneral::SimInternalLoad
      {
        public:
        ...
        //
        typedef ::namespaces::Sim::ResourcesGeneral::SimInternalLoad_ThermalComfortModel_1_5_Type SimInternalLoad_ThermalComfortModel_1_5_Type_type;
