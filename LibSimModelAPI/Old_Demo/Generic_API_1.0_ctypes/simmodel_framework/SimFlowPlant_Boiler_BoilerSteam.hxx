...
#ifndef SIM_FLOW_PLANT_BOILER_BOILER_STEAM_HXX
#define SIM_FLOW_PLANT_BOILER_BOILER_STEAM_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowPlant_Boiler_BoilerSteam: public ::namespaces::Sim::MepModel::SimFlowPlant_Boiler
      {
        public:
        ...
        //
        typedef ::xml_schema::double_ SimFlowPlant_MaxOperatPressure_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_MaxOperatPressure_type > SimFlowPlant_MaxOperatPressure_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_MaxOperatPressure_type, char, ::xsd::cxx::tree::schema_type::double_ > SimFlowPlant_MaxOperatPressure_traits;

        const SimFlowPlant_MaxOperatPressure_optional&
        SimFlowPlant_MaxOperatPressure () const;

        SimFlowPlant_MaxOperatPressure_optional&
        SimFlowPlant_MaxOperatPressure ();
        ...
        //
        typedef ::xml_schema::double_ SimFlowPlant_TheoreticalEff_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_TheoreticalEff_type > SimFlowPlant_TheoreticalEff_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_TheoreticalEff_type, char, ::xsd::cxx::tree::schema_type::double_ > SimFlowPlant_TheoreticalEff_traits;

        const SimFlowPlant_TheoreticalEff_optional&
        SimFlowPlant_TheoreticalEff () const;

        SimFlowPlant_TheoreticalEff_optional&
        SimFlowPlant_TheoreticalEff ();
        ...
        //
        typedef ::xml_schema::double_ SimFlowPlant_DesignOutletSteamTemp_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_DesignOutletSteamTemp_type > SimFlowPlant_DesignOutletSteamTemp_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_DesignOutletSteamTemp_type, char, ::xsd::cxx::tree::schema_type::double_ > SimFlowPlant_DesignOutletSteamTemp_traits;

        const SimFlowPlant_DesignOutletSteamTemp_optional&
        SimFlowPlant_DesignOutletSteamTemp () const;

        SimFlowPlant_DesignOutletSteamTemp_optional&
        SimFlowPlant_DesignOutletSteamTemp ();
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList_type > SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList_type, char > SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList_traits;

        const SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList_optional&
        SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList () const;

        SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList_optional&
        SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList ();
        ...
        void
        SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList (::std::auto_ptr< SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList_type > p);

        // SimFlowPlant_SteamOutletNodeName
        //
        typedef ::xml_schema::string SimFlowPlant_SteamOutletNodeName_type;
        typedef ::xsd::cxx::tree::optional< SimFlowPlant_SteamOutletNodeName_type > SimFlowPlant_SteamOutletNodeName_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowPlant_SteamOutletNodeName_type, char > SimFlowPlant_SteamOutletNodeName_traits;

        const SimFlowPlant_SteamOutletNodeName_optional&
        SimFlowPlant_SteamOutletNodeName () const;

        SimFlowPlant_SteamOutletNodeName_optional&
        SimFlowPlant_SteamOutletNodeName ();
        ...
        void
        SimFlowPlant_SteamOutletNodeName (::std::auto_ptr< SimFlowPlant_SteamOutletNodeName_type > p);

        // Constructors.
        //
        SimFlowPlant_Boiler_BoilerSteam (const RefId_type&);
        ...
        virtual SimFlowPlant_Boiler_BoilerSteam*
        ...
        SimFlowPlant_MaxOperatPressure_optional SimFlowPlant_MaxOperatPressure_;
        SimFlowPlant_TheoreticalEff_optional SimFlowPlant_TheoreticalEff_;
        SimFlowPlant_DesignOutletSteamTemp_optional SimFlowPlant_DesignOutletSteamTemp_;
        SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList_optional SimFlowPlant_Coef_1_3_FuelUseFuncPartLoadRatioCurveList_;
        SimFlowPlant_SteamOutletNodeName_optional SimFlowPlant_SteamOutletNodeName_;
      };
    }
  }
}
...
#endif // SIM_FLOW_PLANT_BOILER_BOILER_STEAM_HXX
