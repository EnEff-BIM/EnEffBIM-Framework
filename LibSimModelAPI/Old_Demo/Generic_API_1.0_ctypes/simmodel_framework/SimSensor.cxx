...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      const SimSensor::SimSensor_Name_optional& SimSensor::
      SimSensor_Name () const
      {
        return this->SimSensor_Name_;
      }

      SimSensor::SimSensor_Name_optional& SimSensor::
      SimSensor_Name ()
      {
        return this->SimSensor_Name_;
      }
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimSensor_Name
          //
          if (n.name () == "SimSensor_Name" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
