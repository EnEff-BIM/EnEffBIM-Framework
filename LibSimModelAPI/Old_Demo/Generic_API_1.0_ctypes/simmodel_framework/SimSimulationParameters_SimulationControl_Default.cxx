    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimSimParams_DoZoneSizingCalc
          //
          if (n.name () == "SimSimParams_DoZoneSizingCalc" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_DoSysSizingCalc
          //
          if (n.name () == "SimSimParams_DoSysSizingCalc" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_DoPlantSizingCalc
          //
          if (n.name () == "SimSimParams_DoPlantSizingCalc" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_RunSimForSizingPeriods
          //
          if (n.name () == "SimSimParams_RunSimForSizingPeriods" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_RunSimForWeatherFileRunPeriods
          //
          if (n.name () == "SimSimParams_RunSimForWeatherFileRunPeriods" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // Version_VersionIdentifier
          //
          if (n.name () == "Version_VersionIdentifier" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ShadowCalc_CalcFreq
          //
          if (n.name () == "ShadowCalc_CalcFreq" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ShadowCalc_MaxFiguresShadowOverlapCalcs
          //
          if (n.name () == "ShadowCalc_MaxFiguresShadowOverlapCalcs" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ShadowCalc_PolygonClippingAlgorithm
          //
          if (n.name () == "ShadowCalc_PolygonClippingAlgorithm" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ShadowCalc_SkyDiffuseModAlgo
          //
          if (n.name () == "ShadowCalc_SkyDiffuseModAlgo" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ZoneCapacitanceMult_ResearchSpecial_TempCapacityMult
          //
          if (n.name () == "ZoneCapacitanceMult_ResearchSpecial_TempCapacityMult" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ZoneCapacitanceMult_ResearchSpecial_HumidCapacityMult
          //
          if (n.name () == "ZoneCapacitanceMult_ResearchSpecial_HumidCapacityMult" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ZoneCapacitanceMult_ResearchSpecial_CO2CapacityMult
          //
          if (n.name () == "ZoneCapacitanceMult_ResearchSpecial_CO2CapacityMult" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ZoneCapacitanceMult_ResearchSpecial_GenContamCapMult
          //
          if (n.name () == "ZoneCapacitanceMult_ResearchSpecial_GenContamCapMult" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ZoneAirContamBalance_CO2Concentration
          //
          if (n.name () == "ZoneAirContamBalance_CO2Concentration" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ZoneAirContamBalance_OutdrCO2ScheduleName
          //
          if (n.name () == "ZoneAirContamBalance_OutdrCO2ScheduleName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ZoneAirContamBalance_GenContamConcentration
          //
          if (n.name () == "ZoneAirContamBalance_GenContamConcentration" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ZoneAirContamBalance_OutdoorGenContamSchedName
          //
          if (n.name () == "ZoneAirContamBalance_OutdoorGenContamSchedName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // Timestep_NumTimestepsPerHour
          //
          if (n.name () == "Timestep_NumTimestepsPerHour" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ConvLimits_MinSysTimestep
          //
          if (n.name () == "ConvLimits_MinSysTimestep" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ConvLimits_MaxHVACIterations
          //
          if (n.name () == "ConvLimits_MaxHVACIterations" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ConvLimits_MinPlantIterations
          //
          if (n.name () == "ConvLimits_MinPlantIterations" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ConvLimits_MaxPlantIterations
          //
          if (n.name () == "ConvLimits_MaxPlantIterations" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ProgramControl_NumberofThreadsAllowed
          //
          if (n.name () == "ProgramControl_NumberofThreadsAllowed" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
