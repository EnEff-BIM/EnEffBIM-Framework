    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // OverallLength
          //
          if (n.name () == "OverallLength" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TopRailWidth
          //
          if (n.name () == "TopRailWidth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TopRailDepth
          //
          if (n.name () == "TopRailDepth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // StileLength
          //
          if (n.name () == "StileLength" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // StileWidth
          //
          if (n.name () == "StileWidth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->StileWidth_)
            {
          ...
          // StileLengthSpacing
          //
          if (n.name () == "StileLengthSpacing" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // BaseRailWidth
          //
          if (n.name () == "BaseRailWidth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // BaseRailDepth
          //
          if (n.name () == "BaseRailDepth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
