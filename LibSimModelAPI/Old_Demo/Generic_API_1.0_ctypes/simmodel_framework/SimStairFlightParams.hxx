...
#ifndef SIM_STAIR_FLIGHT_PARAMS_HXX
#define SIM_STAIR_FLIGHT_PARAMS_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      class SimStairFlightParams: public ::namespaces::Sim::ResourcesGeneral::SimBldgModelParams
      {
        public:
        // Length
        //
        ...
        // OverallRise
        //
        typedef ::xml_schema::double_ OverallRise_type;
        typedef ::xsd::cxx::tree::optional< OverallRise_type > OverallRise_optional;
        typedef ::xsd::cxx::tree::traits< OverallRise_type, char, ::xsd::cxx::tree::schema_type::double_ > OverallRise_traits;

        const OverallRise_optional&
        OverallRise () const;

        OverallRise_optional&
        OverallRise ();
        ...
        // Constructors.
        //
        SimStairFlightParams (const RefId_type&);
        ...
        OverallRise_optional OverallRise_;
...
#endif // SIM_STAIR_FLIGHT_PARAMS_HXX
