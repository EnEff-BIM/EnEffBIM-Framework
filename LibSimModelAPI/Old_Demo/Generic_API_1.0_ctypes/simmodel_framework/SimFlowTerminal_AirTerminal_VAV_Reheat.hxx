...
#ifndef SIM_FLOW_TERMINAL_AIR_TERMINAL_VAV_REHEAT_HXX
#define SIM_FLOW_TERMINAL_AIR_TERMINAL_VAV_REHEAT_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowTerminal_AirTerminal_VAV_Reheat: public ::namespaces::Sim::MepModel::SimFlowTerminal_AirTerminal
      {
        public:
        ...
        //
        typedef ::xml_schema::string SimFlowTerm_ZoneMinAirFlowInputMeth_type;
        typedef ::xsd::cxx::tree::optional< SimFlowTerm_ZoneMinAirFlowInputMeth_type > SimFlowTerm_ZoneMinAirFlowInputMeth_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowTerm_ZoneMinAirFlowInputMeth_type, char > SimFlowTerm_ZoneMinAirFlowInputMeth_traits;

        const SimFlowTerm_ZoneMinAirFlowInputMeth_optional&
        SimFlowTerm_ZoneMinAirFlowInputMeth () const;

        SimFlowTerm_ZoneMinAirFlowInputMeth_optional&
        SimFlowTerm_ZoneMinAirFlowInputMeth ();
        ...
        void
        SimFlowTerm_ZoneMinAirFlowInputMeth (::std::auto_ptr< SimFlowTerm_ZoneMinAirFlowInputMeth_type > p);

        // SimFlowTerm_ConstMinAirFlowFract
        //
        typedef ::xml_schema::double_ SimFlowTerm_ConstMinAirFlowFract_type;
        typedef ::xsd::cxx::tree::optional< SimFlowTerm_ConstMinAirFlowFract_type > SimFlowTerm_ConstMinAirFlowFract_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowTerm_ConstMinAirFlowFract_type, char, ::xsd::cxx::tree::schema_type::double_ > SimFlowTerm_ConstMinAirFlowFract_traits;

        const SimFlowTerm_ConstMinAirFlowFract_optional&
        SimFlowTerm_ConstMinAirFlowFract () const;

        SimFlowTerm_ConstMinAirFlowFract_optional&
        SimFlowTerm_ConstMinAirFlowFract ();
        ...
        //
        typedef ::xml_schema::double_ SimFlowTerm_FixedMinAirFlowRate_type;
        typedef ::xsd::cxx::tree::optional< SimFlowTerm_FixedMinAirFlowRate_type > SimFlowTerm_FixedMinAirFlowRate_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowTerm_FixedMinAirFlowRate_type, char, ::xsd::cxx::tree::schema_type::double_ > SimFlowTerm_FixedMinAirFlowRate_traits;

        const SimFlowTerm_FixedMinAirFlowRate_optional&
        SimFlowTerm_FixedMinAirFlowRate () const;

        SimFlowTerm_FixedMinAirFlowRate_optional&
        SimFlowTerm_FixedMinAirFlowRate ();
        ...
        //
        typedef ::xml_schema::idref SimFlowTerm_MinAirFlowFractSchedName_type;
        typedef ::xsd::cxx::tree::optional< SimFlowTerm_MinAirFlowFractSchedName_type > SimFlowTerm_MinAirFlowFractSchedName_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowTerm_MinAirFlowFractSchedName_type, char > SimFlowTerm_MinAirFlowFractSchedName_traits;

        const SimFlowTerm_MinAirFlowFractSchedName_optional&
        SimFlowTerm_MinAirFlowFractSchedName () const;

        SimFlowTerm_MinAirFlowFractSchedName_optional&
        SimFlowTerm_MinAirFlowFractSchedName ();
        ...
        void
        SimFlowTerm_MinAirFlowFractSchedName (::std::auto_ptr< SimFlowTerm_MinAirFlowFractSchedName_type > p);
        ...
        //
        typedef ::xml_schema::string SimFlowTerm_DamperHeatingAction_type;
        typedef ::xsd::cxx::tree::optional< SimFlowTerm_DamperHeatingAction_type > SimFlowTerm_DamperHeatingAction_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowTerm_DamperHeatingAction_type, char > SimFlowTerm_DamperHeatingAction_traits;

        const SimFlowTerm_DamperHeatingAction_optional&
        SimFlowTerm_DamperHeatingAction () const;

        SimFlowTerm_DamperHeatingAction_optional&
        SimFlowTerm_DamperHeatingAction ();
        ...
        void
        SimFlowTerm_DamperHeatingAction (::std::auto_ptr< SimFlowTerm_DamperHeatingAction_type > p);

        // SimFlowTerm_MaxFlowPerZoneFloorAreaDuringReheat
        //
        typedef ::xml_schema::double_ SimFlowTerm_MaxFlowPerZoneFloorAreaDuringReheat_type;
        typedef ::xsd::cxx::tree::optional< SimFlowTerm_MaxFlowPerZoneFloorAreaDuringReheat_type > SimFlowTerm_MaxFlowPerZoneFloorAreaDuringReheat_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowTerm_MaxFlowPerZoneFloorAreaDuringReheat_type, char, ::xsd::cxx::tree::schema_type::double_ > SimFlowTerm_MaxFlowPerZoneFloorAreaDuringReheat_traits;

        const SimFlowTerm_MaxFlowPerZoneFloorAreaDuringReheat_optional&
        SimFlowTerm_MaxFlowPerZoneFloorAreaDuringReheat () const;

        SimFlowTerm_MaxFlowPerZoneFloorAreaDuringReheat_optional&
        SimFlowTerm_MaxFlowPerZoneFloorAreaDuringReheat ();
        ...
        //
        typedef ::xml_schema::double_ SimFlowTerm_MaxFlowFractDuringReheat_type;
        typedef ::xsd::cxx::tree::optional< SimFlowTerm_MaxFlowFractDuringReheat_type > SimFlowTerm_MaxFlowFractDuringReheat_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowTerm_MaxFlowFractDuringReheat_type, char, ::xsd::cxx::tree::schema_type::double_ > SimFlowTerm_MaxFlowFractDuringReheat_traits;

        const SimFlowTerm_MaxFlowFractDuringReheat_optional&
        SimFlowTerm_MaxFlowFractDuringReheat () const;

        SimFlowTerm_MaxFlowFractDuringReheat_optional&
        SimFlowTerm_MaxFlowFractDuringReheat ();
        ...
        // Constructors.
        //
        SimFlowTerminal_AirTerminal_VAV_Reheat (const RefId_type&);
        ...
        virtual SimFlowTerminal_AirTerminal_VAV_Reheat*
        ...
        SimFlowTerm_ZoneMinAirFlowInputMeth_optional SimFlowTerm_ZoneMinAirFlowInputMeth_;
        SimFlowTerm_ConstMinAirFlowFract_optional SimFlowTerm_ConstMinAirFlowFract_;
        SimFlowTerm_FixedMinAirFlowRate_optional SimFlowTerm_FixedMinAirFlowRate_;
        SimFlowTerm_MinAirFlowFractSchedName_optional SimFlowTerm_MinAirFlowFractSchedName_;
        ...
        SimFlowTerm_DamperHeatingAction_optional SimFlowTerm_DamperHeatingAction_;
        SimFlowTerm_MaxFlowPerZoneFloorAreaDuringReheat_optional SimFlowTerm_MaxFlowPerZoneFloorAreaDuringReheat_;
        SimFlowTerm_MaxFlowFractDuringReheat_optional SimFlowTerm_MaxFlowFractDuringReheat_;
      };
    }
  }
}
...
#endif // SIM_FLOW_TERMINAL_AIR_TERMINAL_VAV_REHEAT_HXX
