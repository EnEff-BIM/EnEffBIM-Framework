...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowCompoundEqmt_UnitaryLoopEqmt_HP_AirToAirMultiSpeed: public ::namespaces::Sim::MepModel::SimFlowCompoundEqmt_UnitaryLoopEqmt
      {
        public:
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowCompEqmt_SpeedSupplyAirFlowRateDuringHeatingOp_1_4_type;
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowCompEqmt_SpeedSupplyAirFlowRateDuringCoolingOp_1_4_type;
