...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      const SimWindowLiningProps::GlobalId_optional& SimWindowLiningProps::
      GlobalId () const
      {
        return this->GlobalId_;
      }

      SimWindowLiningProps::GlobalId_optional& SimWindowLiningProps::
      GlobalId ()
      {
        return this->GlobalId_;
      }
      ...
      const SimWindowLiningProps::OwnerHistory_optional& SimWindowLiningProps::
      OwnerHistory () const
      {
        return this->OwnerHistory_;
      }

      SimWindowLiningProps::OwnerHistory_optional& SimWindowLiningProps::
      OwnerHistory ()
      {
        return this->OwnerHistory_;
      }
    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // MullionThickness
          //
          if (n.name () == "MullionThickness" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // FirstTransomOffset
          //
          if (n.name () == "FirstTransomOffset" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SecondTransomOffset
          //
          if (n.name () == "SecondTransomOffset" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // FirstMullionOffset
          //
          if (n.name () == "FirstMullionOffset" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SecondMullionOffset
          //
          if (n.name () == "SecondMullionOffset" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
