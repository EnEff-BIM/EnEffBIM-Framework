...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      class SimBuildingStory: public ::namespaces::Sim::BuildingModel::SimSpatialStructureElement
      {
        public:
        // Name
        //
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::logical BuildingStoryIsAboveGrade_type;
        ...
        typedef ::xsd::cxx::tree::optional< BuildingStoryHeight_type > BuildingStoryHeight_optional;
