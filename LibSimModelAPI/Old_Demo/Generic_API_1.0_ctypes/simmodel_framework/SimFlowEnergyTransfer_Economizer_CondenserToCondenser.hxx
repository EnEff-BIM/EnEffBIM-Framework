...
#ifndef SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_CONDENSER_TO_CONDENSER_HXX
#define SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_CONDENSER_TO_CONDENSER_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_Economizer_CondenserToCondenser: public ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_Economizer
      {
        public:
        ...
        // Constructors.
        //
        SimFlowEnergyTransfer_Economizer_CondenserToCondenser (const RefId_type&);

        SimFlowEnergyTransfer_Economizer_CondenserToCondenser (const ::xercesc::DOMElement& e,
                                                               ::xml_schema::flags f = 0,
                                                               ::xml_schema::container* c = 0);

        SimFlowEnergyTransfer_Economizer_CondenserToCondenser (const SimFlowEnergyTransfer_Economizer_CondenserToCondenser& x,
                                                               ::xml_schema::flags f = 0,
                                                               ::xml_schema::container* c = 0);

        virtual SimFlowEnergyTransfer_Economizer_CondenserToCondenser*
        _clone (::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0) const;

        SimFlowEnergyTransfer_Economizer_CondenserToCondenser&
        operator= (const SimFlowEnergyTransfer_Economizer_CondenserToCondenser& x);
...
#endif // SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_CONDENSER_TO_CONDENSER_HXX
