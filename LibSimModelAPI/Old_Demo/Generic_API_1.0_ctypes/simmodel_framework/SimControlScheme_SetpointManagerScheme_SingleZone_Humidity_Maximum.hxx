...
#ifndef SIM_CONTROL_SCHEME_SETPOINT_MANAGER_SCHEME_SINGLE_ZONE_HUMIDITY_MAXIMUM_HXX
#define SIM_CONTROL_SCHEME_SETPOINT_MANAGER_SCHEME_SINGLE_ZONE_HUMIDITY_MAXIMUM_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      class SimControlScheme_SetpointManagerScheme_SingleZone_Humidity_Maximum: public ::namespaces::Sim::ResourcesGeneral::SimControlScheme_SetpointManagerScheme
      {
        public:
        // SimCntrlSchm_Name
        //
        ...
        //
        typedef ::xml_schema::string SimCntrlSchm_CntlZoneAirNodeName_type;
        typedef ::xsd::cxx::tree::optional< SimCntrlSchm_CntlZoneAirNodeName_type > SimCntrlSchm_CntlZoneAirNodeName_optional;
        typedef ::xsd::cxx::tree::traits< SimCntrlSchm_CntlZoneAirNodeName_type, char > SimCntrlSchm_CntlZoneAirNodeName_traits;

        const SimCntrlSchm_CntlZoneAirNodeName_optional&
        SimCntrlSchm_CntlZoneAirNodeName () const;

        SimCntrlSchm_CntlZoneAirNodeName_optional&
        SimCntrlSchm_CntlZoneAirNodeName ();
        ...
        void
        SimCntrlSchm_CntlZoneAirNodeName (::std::auto_ptr< SimCntrlSchm_CntlZoneAirNodeName_type > p);

        // Constructors.
        //
        SimControlScheme_SetpointManagerScheme_SingleZone_Humidity_Maximum (const RefId_type&);
        ...
        virtual SimControlScheme_SetpointManagerScheme_SingleZone_Humidity_Maximum*
        ...
        SimCntrlSchm_CntlZoneAirNodeName_optional SimCntrlSchm_CntlZoneAirNodeName_;
      };
    }
  }
}
...
#endif // SIM_CONTROL_SCHEME_SETPOINT_MANAGER_SCHEME_SINGLE_ZONE_HUMIDITY_MAXIMUM_HXX
