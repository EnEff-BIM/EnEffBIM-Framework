...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      ...
      : ::namespaces::Sim::BuildingModel::SimProject_Project (RefId)
      {
      }
      ...
      : ::namespaces::Sim::BuildingModel::SimProject_Project (x, f, c)
      {
      }
      ...
      SimProject_Project_DesignAlternative (const ::xercesc::DOMElement& e,
                                            ::xml_schema::flags f,
                                            ::xml_schema::container* c)
      : ::namespaces::Sim::BuildingModel::SimProject_Project (e, f, c)
      {
      }
