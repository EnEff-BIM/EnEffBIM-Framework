...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      const SimControlScheme_AvailabilityManagerScheme_HybridVentilation::SimCntrlSchm_ZoneVentObjName_optional& SimControlScheme_AvailabilityManagerScheme_HybridVentilation::
      SimCntrlSchm_ZoneVentObjName () const
      {
        return this->SimCntrlSchm_ZoneVentObjName_;
      }

      SimControlScheme_AvailabilityManagerScheme_HybridVentilation::SimCntrlSchm_ZoneVentObjName_optional& SimControlScheme_AvailabilityManagerScheme_HybridVentilation::
      ...
      {
        this->SimCntrlSchm_ZoneVentObjName_.set (x);
      }

      void SimControlScheme_AvailabilityManagerScheme_HybridVentilation::
      SimCntrlSchm_ZoneVentObjName (const SimCntrlSchm_ZoneVentObjName_optional& x)
      {
        this->SimCntrlSchm_ZoneVentObjName_ = x;
      }

      void SimControlScheme_AvailabilityManagerScheme_HybridVentilation::
      SimCntrlSchm_ZoneVentObjName (::std::auto_ptr< SimCntrlSchm_ZoneVentObjName_type > x)
      {
        this->SimCntrlSchm_ZoneVentObjName_.set (x);
      }
    }
  ...
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimControlScheme_AvailabilityManagerScheme (RefId),
        ...
        SimCntrlSchm_ZoneVentObjName_ (this)
      {
      }
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimControlScheme_AvailabilityManagerScheme (x, f, c),
        ...
        SimCntrlSchm_ZoneVentObjName_ (x.SimCntrlSchm_ZoneVentObjName_, f, this)
      {
      }
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimCntrlSchm_CntlledZoneName
          //
          if (n.name () == "SimCntrlSchm_CntlledZoneName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_VentCntlModeSchedName
          //
          if (n.name () == "SimCntrlSchm_VentCntlModeSchedName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_UseWeatherFileRaindics
          //
          if (n.name () == "SimCntrlSchm_UseWeatherFileRaindics" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_MaxWindSpd
          //
          if (n.name () == "SimCntrlSchm_MaxWindSpd" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_MinOutdrTemp
          //
          if (n.name () == "SimCntrlSchm_MinOutdrTemp" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_MaxOutdrTemp
          //
          if (n.name () == "SimCntrlSchm_MaxOutdrTemp" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_MinOutdrEnthalpy
          //
          if (n.name () == "SimCntrlSchm_MinOutdrEnthalpy" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_MaxOutdrEnthalpy
          //
          if (n.name () == "SimCntrlSchm_MaxOutdrEnthalpy" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_MinOutdrDewpoint
          //
          if (n.name () == "SimCntrlSchm_MinOutdrDewpoint" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_MaxOutdrDewpoint
          //
          if (n.name () == "SimCntrlSchm_MaxOutdrDewpoint" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_MinOutdrVentAirSchedName
          //
          if (n.name () == "SimCntrlSchm_MinOutdrVentAirSchedName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_OpngFactorFuncWindSpeedCurveName
          //
          if (n.name () == "SimCntrlSchm_OpngFactorFuncWindSpeedCurveName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_AirflowNetCntlTypeSchedName
          //
          if (n.name () == "SimCntrlSchm_AirflowNetCntlTypeSchedName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_SimpleAirflowCntlTypeSchedName
          //
          if (n.name () == "SimCntrlSchm_SimpleAirflowCntlTypeSchedName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCntrlSchm_ZoneVentObjName
          //
          if (n.name () == "SimCntrlSchm_ZoneVentObjName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            ::std::auto_ptr< SimCntrlSchm_ZoneVentObjName_type > r (
              SimCntrlSchm_ZoneVentObjName_traits::create (i, f, this));

            if (!this->SimCntrlSchm_ZoneVentObjName_)
            {
              this->SimCntrlSchm_ZoneVentObjName_.set (r);
              continue;
            }
          }
      ...
      operator= (const SimControlScheme_AvailabilityManagerScheme_HybridVentilation& x)
      {
        if (this != &x)
        {
          ...
          this->SimCntrlSchm_ZoneVentObjName_ = x.SimCntrlSchm_ZoneVentObjName_;
        }
