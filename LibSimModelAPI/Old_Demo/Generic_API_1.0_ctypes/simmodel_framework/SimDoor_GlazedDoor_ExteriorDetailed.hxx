...
#ifndef SIM_DOOR_GLAZED_DOOR_EXTERIOR_DETAILED_HXX
#define SIM_DOOR_GLAZED_DOOR_EXTERIOR_DETAILED_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      class SimDoor_GlazedDoor_ExteriorDetailed: public ::namespaces::Sim::BuildingModel::SimDoor_GlazedDoor
      {
        public:
        // DoorTypeTag
        //
        ...
        // SimDoor_SurfType
        //
        typedef ::xml_schema::string SimDoor_SurfType_type;
        typedef ::xsd::cxx::tree::optional< SimDoor_SurfType_type > SimDoor_SurfType_optional;
        typedef ::xsd::cxx::tree::traits< SimDoor_SurfType_type, char > SimDoor_SurfType_traits;

        const SimDoor_SurfType_optional&
        SimDoor_SurfType () const;

        SimDoor_SurfType_optional&
        SimDoor_SurfType ();
        ...
        void
        SimDoor_SurfType (::std::auto_ptr< SimDoor_SurfType_type > p);
        ...
        //
        typedef ::xml_schema::double_ SimDoor_ViewFactToGnd_type;
        typedef ::xsd::cxx::tree::optional< SimDoor_ViewFactToGnd_type > SimDoor_ViewFactToGnd_optional;
        typedef ::xsd::cxx::tree::traits< SimDoor_ViewFactToGnd_type, char, ::xsd::cxx::tree::schema_type::double_ > SimDoor_ViewFactToGnd_traits;

        const SimDoor_ViewFactToGnd_optional&
        SimDoor_ViewFactToGnd () const;

        SimDoor_ViewFactToGnd_optional&
        SimDoor_ViewFactToGnd ();
        ...
        //
        typedef ::xml_schema::idref SimDoor_ShadingContName_type;
        typedef ::xsd::cxx::tree::optional< SimDoor_ShadingContName_type > SimDoor_ShadingContName_optional;
        typedef ::xsd::cxx::tree::traits< SimDoor_ShadingContName_type, char > SimDoor_ShadingContName_traits;

        const SimDoor_ShadingContName_optional&
        SimDoor_ShadingContName () const;

        SimDoor_ShadingContName_optional&
        SimDoor_ShadingContName ();
        ...
        void
        SimDoor_ShadingContName (::std::auto_ptr< SimDoor_ShadingContName_type > p);

        // SimDoor_FrmAndDivName
        //
        typedef ::xml_schema::idref SimDoor_FrmAndDivName_type;
        typedef ::xsd::cxx::tree::optional< SimDoor_FrmAndDivName_type > SimDoor_FrmAndDivName_optional;
        typedef ::xsd::cxx::tree::traits< SimDoor_FrmAndDivName_type, char > SimDoor_FrmAndDivName_traits;

        const SimDoor_FrmAndDivName_optional&
        SimDoor_FrmAndDivName () const;

        SimDoor_FrmAndDivName_optional&
        SimDoor_FrmAndDivName ();
        ...
        void
        SimDoor_FrmAndDivName (::std::auto_ptr< SimDoor_FrmAndDivName_type > p);
        ...
        // SimDoor_NumbVerts
        //
        typedef ::xml_schema::double_ SimDoor_NumbVerts_type;
        typedef ::xsd::cxx::tree::optional< SimDoor_NumbVerts_type > SimDoor_NumbVerts_optional;
        typedef ::xsd::cxx::tree::traits< SimDoor_NumbVerts_type, char, ::xsd::cxx::tree::schema_type::double_ > SimDoor_NumbVerts_traits;

        const SimDoor_NumbVerts_optional&
        SimDoor_NumbVerts () const;

        SimDoor_NumbVerts_optional&
        SimDoor_NumbVerts ();
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimDoor_VertexXCoord_1_4_type;
        typedef ::xsd::cxx::tree::optional< SimDoor_VertexXCoord_1_4_type > SimDoor_VertexXCoord_1_4_optional;
        typedef ::xsd::cxx::tree::traits< SimDoor_VertexXCoord_1_4_type, char > SimDoor_VertexXCoord_1_4_traits;

        const SimDoor_VertexXCoord_1_4_optional&
        SimDoor_VertexXCoord_1_4 () const;

        SimDoor_VertexXCoord_1_4_optional&
        SimDoor_VertexXCoord_1_4 ();
        ...
        void
        SimDoor_VertexXCoord_1_4 (::std::auto_ptr< SimDoor_VertexXCoord_1_4_type > p);

        // SimDoor_VertexYCoord_1_4
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimDoor_VertexYCoord_1_4_type;
        typedef ::xsd::cxx::tree::optional< SimDoor_VertexYCoord_1_4_type > SimDoor_VertexYCoord_1_4_optional;
        typedef ::xsd::cxx::tree::traits< SimDoor_VertexYCoord_1_4_type, char > SimDoor_VertexYCoord_1_4_traits;

        const SimDoor_VertexYCoord_1_4_optional&
        SimDoor_VertexYCoord_1_4 () const;

        SimDoor_VertexYCoord_1_4_optional&
        SimDoor_VertexYCoord_1_4 ();
        ...
        void
        SimDoor_VertexYCoord_1_4 (::std::auto_ptr< SimDoor_VertexYCoord_1_4_type > p);

        // SimDoor_VertexZCoord_1_4
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimDoor_VertexZCoord_1_4_type;
        typedef ::xsd::cxx::tree::optional< SimDoor_VertexZCoord_1_4_type > SimDoor_VertexZCoord_1_4_optional;
        typedef ::xsd::cxx::tree::traits< SimDoor_VertexZCoord_1_4_type, char > SimDoor_VertexZCoord_1_4_traits;

        const SimDoor_VertexZCoord_1_4_optional&
        SimDoor_VertexZCoord_1_4 () const;

        SimDoor_VertexZCoord_1_4_optional&
        SimDoor_VertexZCoord_1_4 ();
        ...
        void
        SimDoor_VertexZCoord_1_4 (::std::auto_ptr< SimDoor_VertexZCoord_1_4_type > p);
        ...
        // Constructors.
        //
        SimDoor_GlazedDoor_ExteriorDetailed (const RefId_type&);
        ...
        virtual SimDoor_GlazedDoor_ExteriorDetailed*
        ...
        SimDoor_SurfType_optional SimDoor_SurfType_;
        ...
        SimDoor_ViewFactToGnd_optional SimDoor_ViewFactToGnd_;
        SimDoor_ShadingContName_optional SimDoor_ShadingContName_;
        SimDoor_FrmAndDivName_optional SimDoor_FrmAndDivName_;
        SimDoor_Mult_optional SimDoor_Mult_;
        SimDoor_NumbVerts_optional SimDoor_NumbVerts_;
        SimDoor_VertexXCoord_1_4_optional SimDoor_VertexXCoord_1_4_;
        SimDoor_VertexYCoord_1_4_optional SimDoor_VertexYCoord_1_4_;
        SimDoor_VertexZCoord_1_4_optional SimDoor_VertexZCoord_1_4_;
...
#endif // SIM_DOOR_GLAZED_DOOR_EXTERIOR_DETAILED_HXX
