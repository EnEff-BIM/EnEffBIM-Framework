...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      : ::namespaces::Sim::MepModel::SimSensor_GasSensor (RefId),
      ...
      : ::namespaces::Sim::MepModel::SimSensor_GasSensor (x, f, c),
      ...
      SimSensor_GasSensor_CO2Sensor (const ::xercesc::DOMElement& e,
                                     ::xml_schema::flags f,
                                     ::xml_schema::container* c)
      : ::namespaces::Sim::MepModel::SimSensor_GasSensor (e, f | ::xml_schema::flags::base, c),
        SimSensor_Controller_ (this),
        SimSensor_Accuracy_ (this),
        SimSensor_MinSensedValue_ (this),
        SimSensor_MaxSensedValue_ (this)
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::MepModel::SimSensor_GasSensor::parse (p, f);
      ...
      operator= (const SimSensor_GasSensor_CO2Sensor& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::MepModel::SimSensor_GasSensor& > (*this) = x;
