...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      const SimFlowFitting_Mixer_AirMixer::SimFlowFitting_OutletBranchName_optional& SimFlowFitting_Mixer_AirMixer::
      SimFlowFitting_OutletBranchName () const
      {
        return this->SimFlowFitting_OutletBranchName_;
      }

      SimFlowFitting_Mixer_AirMixer::SimFlowFitting_OutletBranchName_optional& SimFlowFitting_Mixer_AirMixer::
      SimFlowFitting_OutletBranchName ()
      {
        return this->SimFlowFitting_OutletBranchName_;
      }

      void SimFlowFitting_Mixer_AirMixer::
      ...
      const SimFlowFitting_Mixer_AirMixer::SimFlowFitting_InletBranch_1_500_Name_optional& SimFlowFitting_Mixer_AirMixer::
      SimFlowFitting_InletBranch_1_500_Name () const
      {
        return this->SimFlowFitting_InletBranch_1_500_Name_;
      }

      SimFlowFitting_Mixer_AirMixer::SimFlowFitting_InletBranch_1_500_Name_optional& SimFlowFitting_Mixer_AirMixer::
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      SimFlowFitting_Mixer_AirMixer::
      SimFlowFitting_Mixer_AirMixer (const RefId_type& RefId)
      ...
      SimFlowFitting_Mixer_AirMixer* SimFlowFitting_Mixer_AirMixer::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowFitting_Mixer_AirMixer (*this, f, c);
      }
