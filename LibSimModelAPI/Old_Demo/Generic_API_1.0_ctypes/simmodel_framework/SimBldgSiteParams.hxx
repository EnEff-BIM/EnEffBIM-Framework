...
#ifndef SIM_BLDG_SITE_PARAMS_HXX
#define SIM_BLDG_SITE_PARAMS_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      class SimBldgSiteParams: public ::namespaces::Sim::ResourcesGeneral::SimBldgModelParams
      {
        public:
        // SiteShape
        //
        ...
        void
        SiteShape (::std::auto_ptr< SiteShape_type > p);
        ...
        // AdjacentSiteParams
        //
        typedef ::xml_schema::idrefs AdjacentSiteParams_type;
        typedef ::xsd::cxx::tree::optional< AdjacentSiteParams_type > AdjacentSiteParams_optional;
        typedef ::xsd::cxx::tree::traits< AdjacentSiteParams_type, char > AdjacentSiteParams_traits;

        const AdjacentSiteParams_optional&
        AdjacentSiteParams () const;

        AdjacentSiteParams_optional&
        AdjacentSiteParams ();
        ...
        void
        AdjacentSiteParams (::std::auto_ptr< AdjacentSiteParams_type > p);

        // SolarObstructionParams
        //
        typedef ::xml_schema::idrefs SolarObstructionParams_type;
        typedef ::xsd::cxx::tree::optional< SolarObstructionParams_type > SolarObstructionParams_optional;
        typedef ::xsd::cxx::tree::traits< SolarObstructionParams_type, char > SolarObstructionParams_traits;

        const SolarObstructionParams_optional&
        SolarObstructionParams () const;

        SolarObstructionParams_optional&
        SolarObstructionParams ();
        ...
        void
        SolarObstructionParams (::std::auto_ptr< SolarObstructionParams_type > p);
        ...
        // Constructors.
        //
        SimBldgSiteParams (const RefId_type&);
        ...
        SiteElevation_optional SiteElevation_;
        ProfilePath_optional ProfilePath_;
        GroundPlaneElevation_optional GroundPlaneElevation_;
        AdjacentSiteParams_optional AdjacentSiteParams_;
        SolarObstructionParams_optional SolarObstructionParams_;
...
#endif // SIM_BLDG_SITE_PARAMS_HXX
