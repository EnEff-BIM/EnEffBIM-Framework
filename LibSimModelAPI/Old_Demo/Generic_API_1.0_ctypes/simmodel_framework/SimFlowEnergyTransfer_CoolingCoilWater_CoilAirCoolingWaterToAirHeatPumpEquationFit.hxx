...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_CoolingCoilWater_CoilAirCoolingWaterToAirHeatPumpEquationFit: public ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_CoolingCoilWater
      {
        public:
        ...
        //
        typedef ::xml_schema::double_ SimFlowEnergyTrans_RatedSensCoolingCap_type;
        typedef ::xsd::cxx::tree::optional< SimFlowEnergyTrans_RatedSensCoolingCap_type > SimFlowEnergyTrans_RatedSensCoolingCap_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowEnergyTrans_RatedSensCoolingCap_type, char, ::xsd::cxx::tree::schema_type::double_ > SimFlowEnergyTrans_RatedSensCoolingCap_traits;

        const SimFlowEnergyTrans_RatedSensCoolingCap_optional&
        SimFlowEnergyTrans_RatedSensCoolingCap () const;

        SimFlowEnergyTrans_RatedSensCoolingCap_optional&
        SimFlowEnergyTrans_RatedSensCoolingCap ();
        ...
        //
        typedef ::xml_schema::double_ SimFlowEnergyTrans_RatedCoolingCoefPerf_type;
        typedef ::xsd::cxx::tree::optional< SimFlowEnergyTrans_RatedCoolingCoefPerf_type > SimFlowEnergyTrans_RatedCoolingCoefPerf_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowEnergyTrans_RatedCoolingCoefPerf_type, char, ::xsd::cxx::tree::schema_type::double_ > SimFlowEnergyTrans_RatedCoolingCoefPerf_traits;

        const SimFlowEnergyTrans_RatedCoolingCoefPerf_optional&
        SimFlowEnergyTrans_RatedCoolingCoefPerf () const;

        SimFlowEnergyTrans_RatedCoolingCoefPerf_optional&
        SimFlowEnergyTrans_RatedCoolingCoefPerf ();
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowEnergyTrans_TotalCoolingCapCoef_1_5_type;
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowEnergyTrans_SensCoolingCapCoef_1_6_type;
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowEnergyTrans_CoolingPwrConsumpCoef_1_5_type;
        ...
        SimFlowEnergyTrans_RatedSensCoolingCap_optional SimFlowEnergyTrans_RatedSensCoolingCap_;
        SimFlowEnergyTrans_RatedCoolingCoefPerf_optional SimFlowEnergyTrans_RatedCoolingCoefPerf_;
