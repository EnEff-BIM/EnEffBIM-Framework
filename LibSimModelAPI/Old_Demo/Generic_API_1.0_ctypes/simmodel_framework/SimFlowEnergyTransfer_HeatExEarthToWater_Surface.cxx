    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowEnergyTrans_ConstructionName
          //
          if (n.name () == "SimFlowEnergyTrans_ConstructionName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_HydronicTubeSpacing
          //
          if (n.name () == "SimFlowEnergyTrans_HydronicTubeSpacing" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_SurfLength
          //
          if (n.name () == "SimFlowEnergyTrans_SurfLength" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_SurfWidth
          //
          if (n.name () == "SimFlowEnergyTrans_SurfWidth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_LowSurfEnvironment
          //
          if (n.name () == "SimFlowEnergyTrans_LowSurfEnvironment" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
