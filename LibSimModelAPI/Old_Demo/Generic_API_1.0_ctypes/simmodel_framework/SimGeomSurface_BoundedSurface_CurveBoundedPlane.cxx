    ...
    namespace ResourcesGeometry
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // OuterBoundary
          //
          if (n.name () == "OuterBoundary" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeometry")
          {
          ...
          // InnerBoundaries
          //
          if (n.name () == "InnerBoundaries" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeometry")
          {
