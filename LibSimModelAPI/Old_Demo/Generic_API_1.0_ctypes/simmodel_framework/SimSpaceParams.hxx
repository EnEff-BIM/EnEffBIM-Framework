...
#ifndef SIM_SPACE_PARAMS_HXX
#define SIM_SPACE_PARAMS_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      class SimSpaceParams: public ::namespaces::Sim::ResourcesGeneral::SimBldgModelParams
      {
        public:
        // SpaceNumber
        //
        ...
        // FlipX
        //
        typedef ::xml_schema::boolean FlipX_type;
        typedef ::xsd::cxx::tree::optional< FlipX_type > FlipX_optional;
        typedef ::xsd::cxx::tree::traits< FlipX_type, char > FlipX_traits;

        const FlipX_optional&
        FlipX () const;
        ...
        // FlipY
        //
        typedef ::xml_schema::boolean FlipY_type;
        typedef ::xsd::cxx::tree::optional< FlipY_type > FlipY_optional;
        typedef ::xsd::cxx::tree::traits< FlipY_type, char > FlipY_traits;

        const FlipY_optional&
        FlipY () const;
        ...
        // IsPerimeterSpace
        //
        typedef ::xml_schema::boolean IsPerimeterSpace_type;
        typedef ::xsd::cxx::tree::optional< IsPerimeterSpace_type > IsPerimeterSpace_optional;
        typedef ::xsd::cxx::tree::traits< IsPerimeterSpace_type, char > IsPerimeterSpace_traits;

        const IsPerimeterSpace_optional&
        IsPerimeterSpace () const;

        IsPerimeterSpace_optional&
        IsPerimeterSpace ();
        ...
        // Constructors.
        //
        SimSpaceParams (const RefId_type&);
        ...
        FlipX_optional FlipX_;
        FlipY_optional FlipY_;
        DimensionX_optional DimensionX_;
        DimensionY_optional DimensionY_;
        DimensionZ_optional DimensionZ_;
        Height_optional Height_;
        BaseElevation_optional BaseElevation_;
        DegreeOfNormal_optional DegreeOfNormal_;
        IsPerimeterSpace_optional IsPerimeterSpace_;
