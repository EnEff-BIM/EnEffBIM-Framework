...
#ifndef SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_MIXED_WATER_TO_MIXED_WATER_HXX
#define SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_MIXED_WATER_TO_MIXED_WATER_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_Economizer_MixedWaterToMixedWater: public ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_Economizer
      {
        public:
        ...
        // Constructors.
        //
        SimFlowEnergyTransfer_Economizer_MixedWaterToMixedWater (const RefId_type&);

        SimFlowEnergyTransfer_Economizer_MixedWaterToMixedWater (const ::xercesc::DOMElement& e,
                                                                 ::xml_schema::flags f = 0,
                                                                 ::xml_schema::container* c = 0);

        SimFlowEnergyTransfer_Economizer_MixedWaterToMixedWater (const SimFlowEnergyTransfer_Economizer_MixedWaterToMixedWater& x,
                                                                 ::xml_schema::flags f = 0,
                                                                 ::xml_schema::container* c = 0);

        virtual SimFlowEnergyTransfer_Economizer_MixedWaterToMixedWater*
        _clone (::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0) const;

        SimFlowEnergyTransfer_Economizer_MixedWaterToMixedWater&
        operator= (const SimFlowEnergyTransfer_Economizer_MixedWaterToMixedWater& x);
...
#endif // SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_MIXED_WATER_TO_MIXED_WATER_HXX
