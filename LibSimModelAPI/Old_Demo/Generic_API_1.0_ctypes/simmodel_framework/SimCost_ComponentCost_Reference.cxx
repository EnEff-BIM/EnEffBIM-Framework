    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimCost_RefBldgLineItemCosts
          //
          if (n.name () == "SimCost_RefBldgLineItemCosts" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_RefBldgMiscCostPerCondArea
          //
          if (n.name () == "SimCost_RefBldgMiscCostPerCondArea" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_RefBldgDesign_EngrFees
          //
          if (n.name () == "SimCost_RefBldgDesign_EngrFees" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_RefBldgContrFee
          //
          if (n.name () == "SimCost_RefBldgContrFee" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_RefBldgContingency
          //
          if (n.name () == "SimCost_RefBldgContingency" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_RefBldgPermitsBonding_Insur
          //
          if (n.name () == "SimCost_RefBldgPermitsBonding_Insur" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_RefBldgCommissioningFee
          //
          if (n.name () == "SimCost_RefBldgCommissioningFee" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_RefBldgRegionalAdjFactor
          //
          if (n.name () == "SimCost_RefBldgRegionalAdjFactor" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
