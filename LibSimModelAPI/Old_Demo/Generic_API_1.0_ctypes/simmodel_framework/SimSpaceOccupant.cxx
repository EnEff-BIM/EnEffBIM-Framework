...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      const SimSpaceOccupant::IfcGlobalID_optional& SimSpaceOccupant::
      IfcGlobalID () const
      {
        return this->IfcGlobalID_;
      }

      SimSpaceOccupant::IfcGlobalID_optional& SimSpaceOccupant::
      IfcGlobalID ()
      {
        return this->IfcGlobalID_;
      }
      ...
      const SimSpaceOccupant::ObjectOwnerHistory_optional& SimSpaceOccupant::
      ObjectOwnerHistory () const
      {
        return this->ObjectOwnerHistory_;
      }

      SimSpaceOccupant::ObjectOwnerHistory_optional& SimSpaceOccupant::
      ObjectOwnerHistory ()
      {
        return this->ObjectOwnerHistory_;
      }
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimActor (RefId),
        IfcGlobalID_ (this),
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimActor (x, f, c),
      ...
      SimSpaceOccupant (const ::xercesc::DOMElement& e,
                        ::xml_schema::flags f,
                        ::xml_schema::container* c)
      : ::namespaces::Sim::ResourcesGeneral::SimActor (e, f | ::xml_schema::flags::base, c),
        IfcGlobalID_ (this),
        ObjectOwnerHistory_ (this),
        SpaceOccOrgAbbrev_ (this),
        SpaceOccOrgName_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::ResourcesGeneral::SimActor::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // IfcGlobalID
          //
          if (n.name () == "IfcGlobalID" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ObjectOwnerHistory
          //
          if (n.name () == "ObjectOwnerHistory" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SpaceOccOrgAbbrev
          //
          if (n.name () == "SpaceOccOrgAbbrev" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SpaceOccOrgName
          //
          if (n.name () == "SpaceOccOrgName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ClassRef_SpaceOccOrgID
          //
          if (n.name () == "ClassRef_SpaceOccOrgID" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ClassRef_SpaceOccSubOrgID
          //
          if (n.name () == "ClassRef_SpaceOccSubOrgID" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ClassRef_SpaceOccOrgBillingID
          //
          if (n.name () == "ClassRef_SpaceOccOrgBillingID" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // AssignedSpaces
          //
          if (n.name () == "AssignedSpaces" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // PredefinedType
          //
          if (n.name () == "PredefinedType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
      ...
      operator= (const SimSpaceOccupant& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::ResourcesGeneral::SimActor& > (*this) = x;
