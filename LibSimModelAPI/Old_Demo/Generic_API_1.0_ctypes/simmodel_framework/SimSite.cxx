...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      ...
      const SimSite::Representation_optional& SimSite::
      Representation () const
      {
        return this->Representation_;
      }

      SimSite::Representation_optional& SimSite::
      Representation ()
      {
        return this->Representation_;
      }
    ...
    namespace BuildingModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // Longitude
          //
          if (n.name () == "Longitude" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // Latitude
          //
          if (n.name () == "Latitude" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SiteReferenceElevation
          //
          if (n.name () == "SiteReferenceElevation" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // BuildableArea
          //
          if (n.name () == "BuildableArea" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // BuildingHeightLimit
          //
          if (n.name () == "BuildingHeightLimit" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SitePerimeter
          //
          if (n.name () == "SitePerimeter" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SiteGrossLandArea
          //
          if (n.name () == "SiteGrossLandArea" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SiteExcavationCutVolume
          //
          if (n.name () == "SiteExcavationCutVolume" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SiteExcavationBackfillVolume
          //
          if (n.name () == "SiteExcavationBackfillVolume" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SiteInSpatialContainer
          //
          if (n.name () == "SiteInSpatialContainer" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // WeatherLocationIDType
          //
          if (n.name () == "WeatherLocationIDType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // DesignDays
          //
          if (n.name () == "DesignDays" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // TimeZone
          //
          if (n.name () == "TimeZone" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
            if (!this->TimeZone_)
            {
          ...
          // LocationsTemplate
          //
          if (n.name () == "LocationsTemplate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
