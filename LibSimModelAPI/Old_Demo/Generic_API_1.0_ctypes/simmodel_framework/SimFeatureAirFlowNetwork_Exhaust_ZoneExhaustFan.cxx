...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeometry
    {
      ...
      : ::namespaces::Sim::ResourcesGeometry::SimFeatureAirFlowNetwork_Exhaust (RefId)
      {
      }
      ...
      : ::namespaces::Sim::ResourcesGeometry::SimFeatureAirFlowNetwork_Exhaust (x, f, c)
      {
      }
      ...
      SimFeatureAirFlowNetwork_Exhaust_ZoneExhaustFan (const ::xercesc::DOMElement& e,
                                                       ::xml_schema::flags f,
                                                       ::xml_schema::container* c)
      : ::namespaces::Sim::ResourcesGeometry::SimFeatureAirFlowNetwork_Exhaust (e, f, c)
      {
      }
