...
#ifndef SIM_GEOM_SURFACE_BOUNDED_SURFACE_CURVE_BOUNDED_PLANE_HXX
#define SIM_GEOM_SURFACE_BOUNDED_SURFACE_CURVE_BOUNDED_PLANE_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeometry
    {
      class SimGeomSurface_BoundedSurface_CurveBoundedPlane: public ::namespaces::Sim::ResourcesGeometry::SimGeomSurface_BoundedSurface
      {
        public:
        // BasisSurface
        //
        ...
        void
        OuterBoundary (::std::auto_ptr< OuterBoundary_type > p);

        // InnerBoundaries
        //
        typedef ::xml_schema::idrefs InnerBoundaries_type;
        typedef ::xsd::cxx::tree::optional< InnerBoundaries_type > InnerBoundaries_optional;
        typedef ::xsd::cxx::tree::traits< InnerBoundaries_type, char > InnerBoundaries_traits;

        const InnerBoundaries_optional&
        InnerBoundaries () const;

        InnerBoundaries_optional&
        InnerBoundaries ();
        ...
        void
        InnerBoundaries (::std::auto_ptr< InnerBoundaries_type > p);

        // Constructors.
        //
        SimGeomSurface_BoundedSurface_CurveBoundedPlane (const RefId_type&);
        ...
        virtual SimGeomSurface_BoundedSurface_CurveBoundedPlane*
        ...
        OuterBoundary_optional OuterBoundary_;
        InnerBoundaries_optional InnerBoundaries_;
      };
    }
  }
}
...
#endif // SIM_GEOM_SURFACE_BOUNDED_SURFACE_CURVE_BOUNDED_PLANE_HXX
