    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimRefrigSysElem_AppTempConstTerm
          //
          if (n.name () == "SimRefrigSysElem_AppTempConstTerm" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_ApproachTempCoef2
          //
          if (n.name () == "SimRefrigSysElem_ApproachTempCoef2" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_ApproachTempCoef3
          //
          if (n.name () == "SimRefrigSysElem_ApproachTempCoef3" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_ApproachTempCoef4
          //
          if (n.name () == "SimRefrigSysElem_ApproachTempCoef4" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_MinCapFactor
          //
          if (n.name () == "SimRefrigSysElem_MinCapFactor" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_MaxCapFactor
          //
          if (n.name () == "SimRefrigSysElem_MaxCapFactor" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_AirInNodeName
          //
          if (n.name () == "SimRefrigSysElem_AirInNodeName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_RatedAirFlowRate
          //
          if (n.name () == "SimRefrigSysElem_RatedAirFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_RatedWaterPumpPwr
          //
          if (n.name () == "SimRefrigSysElem_RatedWaterPumpPwr" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
