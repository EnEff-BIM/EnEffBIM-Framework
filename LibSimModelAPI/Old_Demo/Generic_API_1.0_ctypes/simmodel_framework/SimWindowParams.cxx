    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // WindowType
          //
          if (n.name () == "WindowType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TemplateLibEntryOrMLS
          //
          if (n.name () == "TemplateLibEntryOrMLS" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // WinTopElevation
          //
          if (n.name () == "WinTopElevation" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // WinHeight
          //
          if (n.name () == "WinHeight" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->WinHeight_)
            {
          ...
          // WinWidth
          //
          if (n.name () == "WinWidth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->WinWidth_)
            {
          ...
          // GlassThickness
          //
          if (n.name () == "GlassThickness" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // WinPanelProfiles
          //
          if (n.name () == "WinPanelProfiles" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // WinFrameProfiles
          //
          if (n.name () == "WinFrameProfiles" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
