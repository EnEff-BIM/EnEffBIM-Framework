    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // TemplateLocationProperties
          //
          if (n.name () == "TemplateLocationProperties" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // Terrain
          //
          if (n.name () == "Terrain" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SolarDistribution
          //
          if (n.name () == "SolarDistribution" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TemplateSkyTemperature
          //
          if (n.name () == "TemplateSkyTemperature" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TemplateIDDWeatherStation
          //
          if (n.name () == "TemplateIDDWeatherStation" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // WeatherFilename
          //
          if (n.name () == "WeatherFilename" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TemplateSummerDesignDays
          //
          if (n.name () == "TemplateSummerDesignDays" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TemplateWinterDesignDays
          //
          if (n.name () == "TemplateWinterDesignDays" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TemplateUtilityCosts
          //
          if (n.name () == "TemplateUtilityCosts" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
