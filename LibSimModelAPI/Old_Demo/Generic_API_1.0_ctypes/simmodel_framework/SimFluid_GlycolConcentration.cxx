    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFluid_GlycolType
          //
          if (n.name () == "SimFluid_GlycolType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimFluid_UserDefGlycolName
          //
          if (n.name () == "SimFluid_UserDefGlycolName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimFluid_GlycolConcentration
          //
          if (n.name () == "SimFluid_GlycolConcentration" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
