    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowSeg_DuctLength
          //
          if (n.name () == "SimFlowSeg_DuctLength" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSeg_HydrDiam
          //
          if (n.name () == "SimFlowSeg_HydrDiam" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSeg_CrossSectionArea
          //
          if (n.name () == "SimFlowSeg_CrossSectionArea" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSeg_SurfRough
          //
          if (n.name () == "SimFlowSeg_SurfRough" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSeg_CoeffLocalDynamicLossDuetoFitting
          //
          if (n.name () == "SimFlowSeg_CoeffLocalDynamicLossDuetoFitting" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSeg_OverallHeatTransCoefUFactorFromAirToAir
          //
          if (n.name () == "SimFlowSeg_OverallHeatTransCoefUFactorFromAirToAir" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSeg_OverallMoistTransCoefFromAirToAir
          //
          if (n.name () == "SimFlowSeg_OverallMoistTransCoefFromAirToAir" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
