...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowCompoundEqmt_VirtualSupplySubsystems_CoilSystem_Cooling_DX_HeatExchangerAssisted: public ::namespaces::Sim::MepModel::SimFlowCompoundEqmt_VirtualSupplySubsystems
      {
        public:
