...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      : ::namespaces::Sim::MepModel::SimFlowSegment_Filter (RefId),
      ...
      : ::namespaces::Sim::MepModel::SimFlowSegment_Filter (x, f, c),
      ...
      SimFlowSegment_Filter_Panel (const ::xercesc::DOMElement& e,
                                   ::xml_schema::flags f,
                                   ::xml_schema::container* c)
      : ::namespaces::Sim::MepModel::SimFlowSegment_Filter (e, f | ::xml_schema::flags::base, c),
        SimFlowSeg_DesignPresDrop_ (this),
        SimFlowSeg_Ht_ (this),
        SimFlowSeg_Width_ (this),
        SimFlowSeg_Type_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::MepModel::SimFlowSegment_Filter::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowSeg_Type
          //
          if (n.name () == "SimFlowSeg_Type" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSeg_MaxPresDrop
          //
          if (n.name () == "SimFlowSeg_MaxPresDrop" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowSeg_Grade
          //
          if (n.name () == "SimFlowSeg_Grade" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
      ...
      operator= (const SimFlowSegment_Filter_Panel& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::MepModel::SimFlowSegment_Filter& > (*this) = x;
