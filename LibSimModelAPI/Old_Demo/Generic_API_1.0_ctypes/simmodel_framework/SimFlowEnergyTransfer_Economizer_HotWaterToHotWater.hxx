...
#ifndef SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_HOT_WATER_TO_HOT_WATER_HXX
#define SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_HOT_WATER_TO_HOT_WATER_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_Economizer_HotWaterToHotWater: public ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_Economizer
      {
        public:
        ...
        // Constructors.
        //
        SimFlowEnergyTransfer_Economizer_HotWaterToHotWater (const RefId_type&);

        SimFlowEnergyTransfer_Economizer_HotWaterToHotWater (const ::xercesc::DOMElement& e,
                                                             ::xml_schema::flags f = 0,
                                                             ::xml_schema::container* c = 0);

        SimFlowEnergyTransfer_Economizer_HotWaterToHotWater (const SimFlowEnergyTransfer_Economizer_HotWaterToHotWater& x,
                                                             ::xml_schema::flags f = 0,
                                                             ::xml_schema::container* c = 0);

        virtual SimFlowEnergyTransfer_Economizer_HotWaterToHotWater*
        _clone (::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0) const;

        SimFlowEnergyTransfer_Economizer_HotWaterToHotWater&
        operator= (const SimFlowEnergyTransfer_Economizer_HotWaterToHotWater& x);
...
#endif // SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_HOT_WATER_TO_HOT_WATER_HXX
