    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimRefrigSysElem_SubcoolerType
          //
          if (n.name () == "SimRefrigSysElem_SubcoolerType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_LiqSuctionDesignSubcoolingTempDiff
          //
          if (n.name () == "SimRefrigSysElem_LiqSuctionDesignSubcoolingTempDiff" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_DesignLiqInletTemp
          //
          if (n.name () == "SimRefrigSysElem_DesignLiqInletTemp" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_DesignVaporInletTemp
          //
          if (n.name () == "SimRefrigSysElem_DesignVaporInletTemp" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_CapProvidSys
          //
          if (n.name () == "SimRefrigSysElem_CapProvidSys" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimRefrigSysElem_OutletCntlTemp
          //
          if (n.name () == "SimRefrigSysElem_OutletCntlTemp" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
