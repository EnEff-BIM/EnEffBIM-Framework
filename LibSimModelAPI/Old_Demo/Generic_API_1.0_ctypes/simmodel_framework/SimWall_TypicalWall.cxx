...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      ...
      const SimWall_TypicalWall::ContainedBldgElementArrays_optional& SimWall_TypicalWall::
      ContainedBldgElementArrays () const
      {
        return this->ContainedBldgElementArrays_;
      }

      SimWall_TypicalWall::ContainedBldgElementArrays_optional& SimWall_TypicalWall::
      ContainedBldgElementArrays ()
      {
        return this->ContainedBldgElementArrays_;
      }

      void SimWall_TypicalWall::
      ...
      const SimWall_TypicalWall::Representation_optional& SimWall_TypicalWall::
      Representation () const
      {
        return this->Representation_;
      }

      SimWall_TypicalWall::Representation_optional& SimWall_TypicalWall::
      Representation ()
      {
        return this->Representation_;
      }
...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      ...
      SimWall_TypicalWall::
      SimWall_TypicalWall (const RefId_type& RefId)
      : ::namespaces::Sim::BuildingModel::SimWall (RefId),
      ...
      SimWall_TypicalWall::
      SimWall_TypicalWall (const SimWall_TypicalWall& x,
                           ::xml_schema::flags f,
                           ::xml_schema::container* c)
      : ::namespaces::Sim::BuildingModel::SimWall (x, f, c),
      ...
      SimWall_TypicalWall::
      SimWall_TypicalWall (const ::xercesc::DOMElement& e,
                           ::xml_schema::flags f,
                           ::xml_schema::container* c)
      : ::namespaces::Sim::BuildingModel::SimWall (e, f | ::xml_schema::flags::base, c),
        ContainedBldgElementArrays_ (this),
        Representation_ (this)
      {
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::BuildingModel::SimWall::parse (p, f);
      ...
      SimWall_TypicalWall* SimWall_TypicalWall::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimWall_TypicalWall (*this, f, c);
      }

      SimWall_TypicalWall& SimWall_TypicalWall::
      operator= (const SimWall_TypicalWall& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::BuildingModel::SimWall& > (*this) = x;
