...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      const SimFlowPlant_HeatPump_WaterToWater_ParameterEstimation_Heating::SimFlowPlant_CycleTime_optional& SimFlowPlant_HeatPump_WaterToWater_ParameterEstimation_Heating::
      SimFlowPlant_CycleTime () const
      {
        return this->SimFlowPlant_CycleTime_;
      }

      SimFlowPlant_HeatPump_WaterToWater_ParameterEstimation_Heating::SimFlowPlant_CycleTime_optional& SimFlowPlant_HeatPump_WaterToWater_ParameterEstimation_Heating::
