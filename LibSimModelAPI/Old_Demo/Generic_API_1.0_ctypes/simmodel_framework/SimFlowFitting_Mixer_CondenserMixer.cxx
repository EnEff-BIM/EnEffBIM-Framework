...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      const SimFlowFitting_Mixer_CondenserMixer::SimFlowFitting_OutletBranchName_optional& SimFlowFitting_Mixer_CondenserMixer::
      SimFlowFitting_OutletBranchName () const
      {
        return this->SimFlowFitting_OutletBranchName_;
      }

      SimFlowFitting_Mixer_CondenserMixer::SimFlowFitting_OutletBranchName_optional& SimFlowFitting_Mixer_CondenserMixer::
      SimFlowFitting_OutletBranchName ()
      {
        return this->SimFlowFitting_OutletBranchName_;
      }

      void SimFlowFitting_Mixer_CondenserMixer::
      ...
      const SimFlowFitting_Mixer_CondenserMixer::SimFlowFitting_InletBranch_1_500_Name_optional& SimFlowFitting_Mixer_CondenserMixer::
      SimFlowFitting_InletBranch_1_500_Name () const
      {
        return this->SimFlowFitting_InletBranch_1_500_Name_;
      }

      SimFlowFitting_Mixer_CondenserMixer::SimFlowFitting_InletBranch_1_500_Name_optional& SimFlowFitting_Mixer_CondenserMixer::
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      SimFlowFitting_Mixer_CondenserMixer::
      SimFlowFitting_Mixer_CondenserMixer (const RefId_type& RefId)
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowFitting_OutletBranchName
          //
          if (n.name () == "SimFlowFitting_OutletBranchName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowFitting_InletBranch_1_500_Name
          //
          if (n.name () == "SimFlowFitting_InletBranch_1_500_Name" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
      ...
      SimFlowFitting_Mixer_CondenserMixer* SimFlowFitting_Mixer_CondenserMixer::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimFlowFitting_Mixer_CondenserMixer (*this, f, c);
      }
