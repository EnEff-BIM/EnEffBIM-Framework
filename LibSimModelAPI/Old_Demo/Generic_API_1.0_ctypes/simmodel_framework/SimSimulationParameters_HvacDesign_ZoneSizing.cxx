    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimSimParams_ZoneOrZoneListName
          //
          if (n.name () == "SimSimParams_ZoneOrZoneListName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_ZoneCoolingDesignSupplyAirTempInputMethod
          //
          if (n.name () == "SimSimParams_ZoneCoolingDesignSupplyAirTempInputMethod" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_ZoneCoolDesignSupplyAirTemp
          //
          if (n.name () == "SimSimParams_ZoneCoolDesignSupplyAirTemp" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_ZoneCoolingDesignSupplyAirTempDifference
          //
          if (n.name () == "SimSimParams_ZoneCoolingDesignSupplyAirTempDifference" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_ZoneHeatingDesignSupplyAirTempInputMethod
          //
          if (n.name () == "SimSimParams_ZoneHeatingDesignSupplyAirTempInputMethod" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_ZoneHeatDesignSupplyAirTemp
          //
          if (n.name () == "SimSimParams_ZoneHeatDesignSupplyAirTemp" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_ZoneHeatingDesignSupplyAirTempDifference
          //
          if (n.name () == "SimSimParams_ZoneHeatingDesignSupplyAirTempDifference" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_ZoneCoolDesignSupplyAirHumidRatio
          //
          if (n.name () == "SimSimParams_ZoneCoolDesignSupplyAirHumidRatio" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_ZoneHeatDesignSupplyAirHumidRatio
          //
          if (n.name () == "SimSimParams_ZoneHeatDesignSupplyAirHumidRatio" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_DesignSpecOutdrAirObjName
          //
          if (n.name () == "SimSimParams_DesignSpecOutdrAirObjName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_ZoneHeatingSizingFactor
          //
          if (n.name () == "SimSimParams_ZoneHeatingSizingFactor" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_ZoneCoolingSizingFactor
          //
          if (n.name () == "SimSimParams_ZoneCoolingSizingFactor" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_CoolDesignAirFlowMethod
          //
          if (n.name () == "SimSimParams_CoolDesignAirFlowMethod" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_CoolDesignAirFlowRate
          //
          if (n.name () == "SimSimParams_CoolDesignAirFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_CoolMinAirFlowPerZoneFloorArea
          //
          if (n.name () == "SimSimParams_CoolMinAirFlowPerZoneFloorArea" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_CoolMinAirFlow
          //
          if (n.name () == "SimSimParams_CoolMinAirFlow" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_CoolMinAirFlowFraction
          //
          if (n.name () == "SimSimParams_CoolMinAirFlowFraction" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_HeatDesignAirFlowMethod
          //
          if (n.name () == "SimSimParams_HeatDesignAirFlowMethod" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_HeatDesignAirFlowRate
          //
          if (n.name () == "SimSimParams_HeatDesignAirFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_HeatMaxAirFlowPerZoneFloorArea
          //
          if (n.name () == "SimSimParams_HeatMaxAirFlowPerZoneFloorArea" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_HeatMaxAirFlow
          //
          if (n.name () == "SimSimParams_HeatMaxAirFlow" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_HeatMaxAirFlowFraction
          //
          if (n.name () == "SimSimParams_HeatMaxAirFlowFraction" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_DesignSpecZoneAirDistribObjName
          //
          if (n.name () == "SimSimParams_DesignSpecZoneAirDistribObjName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
