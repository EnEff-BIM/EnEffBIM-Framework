    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimCntrl_DemandCtrlledVentilation
          //
          if (n.name () == "SimCntrl_DemandCtrlledVentilation" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_SystemOutdrAirMethod
          //
          if (n.name () == "SimCntrl_SystemOutdrAirMethod" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_ZoneMaxOutdoorAirFraction
          //
          if (n.name () == "SimCntrl_ZoneMaxOutdoorAirFraction" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_Zone_1_50_Name
          //
          if (n.name () == "SimCntrl_Zone_1_50_Name" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_DesignSpecOutdrAirObjName_1_50
          //
          if (n.name () == "SimCntrl_DesignSpecOutdrAirObjName_1_50" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimCntrl_DesignSpecZoneAirDistribObjName_1_50
          //
          if (n.name () == "SimCntrl_DesignSpecZoneAirDistribObjName_1_50" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
