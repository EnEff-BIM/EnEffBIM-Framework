...
#ifndef SIM_WALL_TYPE_HXX
#define SIM_WALL_TYPE_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      class SimWallType: public ::namespaces::Sim::SimModelCore::SimObjectTypeDefinition
      {
        public:
        // RepresentationMaps
        //
