...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      const SimFlowPlant_HeatPump_WaterToWater_EquationFit_Heating::SimFlowPlant_CycleTime_optional& SimFlowPlant_HeatPump_WaterToWater_EquationFit_Heating::
      SimFlowPlant_CycleTime () const
      {
        return this->SimFlowPlant_CycleTime_;
      }

      SimFlowPlant_HeatPump_WaterToWater_EquationFit_Heating::SimFlowPlant_CycleTime_optional& SimFlowPlant_HeatPump_WaterToWater_EquationFit_Heating::
    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowPlant_RatedHeatingCap
          //
          if (n.name () == "SimFlowPlant_RatedHeatingCap" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowPlant_RatedHeatingPwrConsump
          //
          if (n.name () == "SimFlowPlant_RatedHeatingPwrConsump" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowPlant_HeatingCapCoef_1_5
          //
          if (n.name () == "SimFlowPlant_HeatingCapCoef_1_5" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowPlant_HeatingCompPwrCoef_1_5
          //
          if (n.name () == "SimFlowPlant_HeatingCompPwrCoef_1_5" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
