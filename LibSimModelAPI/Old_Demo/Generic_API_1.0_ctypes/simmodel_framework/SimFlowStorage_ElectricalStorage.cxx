...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      : ::namespaces::Sim::MepModel::SimFlowStorage (RefId),
      ...
      : ::namespaces::Sim::MepModel::SimFlowStorage (x, f, c),
      ...
      SimFlowStorage_ElectricalStorage (const ::xercesc::DOMElement& e,
                                        ::xml_schema::flags f,
                                        ::xml_schema::container* c)
      : ::namespaces::Sim::MepModel::SimFlowStorage (e, f | ::xml_schema::flags::base, c),
        SimFlowSto_AvailSchedName_ (this),
        SimFlowSto_ZoneName_ (this)
      {
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::MepModel::SimFlowStorage::parse (p, f);
      ...
      operator= (const SimFlowStorage_ElectricalStorage& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::MepModel::SimFlowStorage& > (*this) = x;
