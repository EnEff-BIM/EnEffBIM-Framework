...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimSimulationParameters_Algorithm (RefId),
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimSimulationParameters_Algorithm (x, f, c),
      ...
      SimSimulationParameters_Algorithm_HeatBalanceAlgorithm (const ::xercesc::DOMElement& e,
                                                              ::xml_schema::flags f,
                                                              ::xml_schema::container* c)
      : ::namespaces::Sim::ResourcesGeneral::SimSimulationParameters_Algorithm (e, f | ::xml_schema::flags::base, c),
        SimSimParams_SurfTempUpLimit_ (this),
        SimSimParams_MinSurfaceConvectionHeatTransferCoeffValue_ (this),
        SimSimParams_MaxSurfaceConvectionHeatTransferCoeffValue_ (this),
        HeatBalSet_CondFiniteDiff_DiffScheme_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::ResourcesGeneral::SimSimulationParameters_Algorithm::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimSimParams_SurfTempUpLimit
          //
          if (n.name () == "SimSimParams_SurfTempUpLimit" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_MinSurfaceConvectionHeatTransferCoeffValue
          //
          if (n.name () == "SimSimParams_MinSurfaceConvectionHeatTransferCoeffValue" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimSimParams_MaxSurfaceConvectionHeatTransferCoeffValue
          //
          if (n.name () == "SimSimParams_MaxSurfaceConvectionHeatTransferCoeffValue" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // HeatBalSet_CondFiniteDiff_DiffScheme
          //
          if (n.name () == "HeatBalSet_CondFiniteDiff_DiffScheme" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // HeatBalSet_CondFiniteDiff_SpaceDiscretizationConstant
          //
          if (n.name () == "HeatBalSet_CondFiniteDiff_SpaceDiscretizationConstant" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // HeatBalSet_CondFiniteDiff_RelaxationFactor
          //
          if (n.name () == "HeatBalSet_CondFiniteDiff_RelaxationFactor" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // HeatBalSet_CondFiniteDiff_InsideFaceSurfaceTempConvergCriteria
          //
          if (n.name () == "HeatBalSet_CondFiniteDiff_InsideFaceSurfaceTempConvergCriteria" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
      ...
      operator= (const SimSimulationParameters_Algorithm_HeatBalanceAlgorithm& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::ResourcesGeneral::SimSimulationParameters_Algorithm& > (*this) = x;
