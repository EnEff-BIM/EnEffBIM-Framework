...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      : ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_HeatExEarthToWater (RefId),
      ...
      : ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_HeatExEarthToWater (x, f, c),
      ...
      SimFlowEnergyTransfer_HeatExEarthToWater_Vertical (const ::xercesc::DOMElement& e,
                                                         ::xml_schema::flags f,
                                                         ::xml_schema::container* c)
      : ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_HeatExEarthToWater (e, f | ::xml_schema::flags::base, c),
        SimFlowEnergyTrans_InNodeName_ (this),
        SimFlowEnergyTrans_OutNodeName_ (this),
        SimFlowEnergyTrans_MaxFlowRate_ (this),
        SimFlowEnergyTrans_NumBoreHoles_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::MepModel::SimFlowEnergyTransfer_HeatExEarthToWater::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowEnergyTrans_MaxFlowRate
          //
          if (n.name () == "SimFlowEnergyTrans_MaxFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_NumBoreHoles
          //
          if (n.name () == "SimFlowEnergyTrans_NumBoreHoles" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_BoreHoleLength
          //
          if (n.name () == "SimFlowEnergyTrans_BoreHoleLength" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_BoreHoleRadius
          //
          if (n.name () == "SimFlowEnergyTrans_BoreHoleRadius" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_GroundThermalHeatCap
          //
          if (n.name () == "SimFlowEnergyTrans_GroundThermalHeatCap" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_GroundTemp
          //
          if (n.name () == "SimFlowEnergyTrans_GroundTemp" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_DesignFlowRate
          //
          if (n.name () == "SimFlowEnergyTrans_DesignFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_GroutThermalCond
          //
          if (n.name () == "SimFlowEnergyTrans_GroutThermalCond" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_PipeThermalCond
          //
          if (n.name () == "SimFlowEnergyTrans_PipeThermalCond" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_PipeOutDiam
          //
          if (n.name () == "SimFlowEnergyTrans_PipeOutDiam" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_UTubeDist
          //
          if (n.name () == "SimFlowEnergyTrans_UTubeDist" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_PipeThick
          //
          if (n.name () == "SimFlowEnergyTrans_PipeThick" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_MaxLengthSim
          //
          if (n.name () == "SimFlowEnergyTrans_MaxLengthSim" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_GFuncRefRatio
          //
          if (n.name () == "SimFlowEnergyTrans_GFuncRefRatio" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_NumDataPairsTheGFunc
          //
          if (n.name () == "SimFlowEnergyTrans_NumDataPairsTheGFunc" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_GFuncLnTTsVal_1_100
          //
          if (n.name () == "SimFlowEnergyTrans_GFuncLnTTsVal_1_100" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_GFuncGVal_1_100
          //
          if (n.name () == "SimFlowEnergyTrans_GFuncGVal_1_100" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
      ...
      operator= (const SimFlowEnergyTransfer_HeatExEarthToWater_Vertical& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_HeatExEarthToWater& > (*this) = x;
