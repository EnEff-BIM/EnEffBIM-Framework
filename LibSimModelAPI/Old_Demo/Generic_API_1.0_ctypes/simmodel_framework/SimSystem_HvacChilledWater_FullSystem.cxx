...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      ...
      : ::namespaces::Sim::BuildingModel::SimSystem_HvacChilledWater (RefId),
      ...
      : ::namespaces::Sim::BuildingModel::SimSystem_HvacChilledWater (x, f, c),
      ...
      SimSystem_HvacChilledWater_FullSystem (const ::xercesc::DOMElement& e,
                                             ::xml_schema::flags f,
                                             ::xml_schema::container* c)
      : ::namespaces::Sim::BuildingModel::SimSystem_HvacChilledWater (e, f | ::xml_schema::flags::base, c),
        SimSys_AvailMngrListName_ (this),
        SimSys_DemandSideOutNodeName_ (this),
        SimSys_FluidType_ (this),
        SimSys_UserDefFluidType_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::BuildingModel::SimSystem_HvacChilledWater::parse (p, f);
      ...
      operator= (const SimSystem_HvacChilledWater_FullSystem& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::BuildingModel::SimSystem_HvacChilledWater& > (*this) = x;
