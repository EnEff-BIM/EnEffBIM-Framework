...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      const SimSensor_TemperatureSensor_Radiant::SimSensor_Controller_optional& SimSensor_TemperatureSensor_Radiant::
      SimSensor_Controller () const
      {
        return this->SimSensor_Controller_;
      }

      SimSensor_TemperatureSensor_Radiant::SimSensor_Controller_optional& SimSensor_TemperatureSensor_Radiant::
      SimSensor_Controller ()
      {
        return this->SimSensor_Controller_;
      }

      void SimSensor_TemperatureSensor_Radiant::
      ...
      const SimSensor_TemperatureSensor_Radiant::SimSensor_Accuracy_optional& SimSensor_TemperatureSensor_Radiant::
      SimSensor_Accuracy () const
      {
        return this->SimSensor_Accuracy_;
      }

      SimSensor_TemperatureSensor_Radiant::SimSensor_Accuracy_optional& SimSensor_TemperatureSensor_Radiant::
      SimSensor_Accuracy ()
      {
        return this->SimSensor_Accuracy_;
      }
      ...
      const SimSensor_TemperatureSensor_Radiant::SimSensor_MinSensedValue_optional& SimSensor_TemperatureSensor_Radiant::
      SimSensor_MinSensedValue () const
      {
        return this->SimSensor_MinSensedValue_;
      }

      SimSensor_TemperatureSensor_Radiant::SimSensor_MinSensedValue_optional& SimSensor_TemperatureSensor_Radiant::
      ...
      const SimSensor_TemperatureSensor_Radiant::SimSensor_MaxSensedValue_optional& SimSensor_TemperatureSensor_Radiant::
      SimSensor_MaxSensedValue () const
      {
        return this->SimSensor_MaxSensedValue_;
      }

      SimSensor_TemperatureSensor_Radiant::SimSensor_MaxSensedValue_optional& SimSensor_TemperatureSensor_Radiant::
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      ...
      SimSensor_TemperatureSensor_Radiant::
      SimSensor_TemperatureSensor_Radiant (const RefId_type& RefId)
      : ::namespaces::Sim::MepModel::SimSensor_TemperatureSensor (RefId),
      ...
      SimSensor_TemperatureSensor_Radiant::
      SimSensor_TemperatureSensor_Radiant (const SimSensor_TemperatureSensor_Radiant& x,
                                           ::xml_schema::flags f,
                                           ::xml_schema::container* c)
      : ::namespaces::Sim::MepModel::SimSensor_TemperatureSensor (x, f, c),
      ...
      SimSensor_TemperatureSensor_Radiant::
      SimSensor_TemperatureSensor_Radiant (const ::xercesc::DOMElement& e,
                                           ::xml_schema::flags f,
                                           ::xml_schema::container* c)
      : ::namespaces::Sim::MepModel::SimSensor_TemperatureSensor (e, f | ::xml_schema::flags::base, c),
        SimSensor_Controller_ (this),
        SimSensor_Accuracy_ (this),
        SimSensor_MinSensedValue_ (this),
        SimSensor_MaxSensedValue_ (this)
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::MepModel::SimSensor_TemperatureSensor::parse (p, f);
      ...
      SimSensor_TemperatureSensor_Radiant* SimSensor_TemperatureSensor_Radiant::
      _clone (::xml_schema::flags f,
              ::xml_schema::container* c) const
      {
        return new class SimSensor_TemperatureSensor_Radiant (*this, f, c);
      }

      SimSensor_TemperatureSensor_Radiant& SimSensor_TemperatureSensor_Radiant::
      operator= (const SimSensor_TemperatureSensor_Radiant& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::MepModel::SimSensor_TemperatureSensor& > (*this) = x;
