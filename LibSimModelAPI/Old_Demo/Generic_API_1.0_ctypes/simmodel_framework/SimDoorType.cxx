...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      ...
      const SimDoorType::GeometricRepresentations_optional& SimDoorType::
      GeometricRepresentations () const
      {
        return this->GeometricRepresentations_;
      }

      SimDoorType::GeometricRepresentations_optional& SimDoorType::
    ...
    namespace BuildingModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // DoorTypeApplicableOccurrence
          //
          if (n.name () == "DoorTypeApplicableOccurrence" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // DoorTypeOperationType
          //
          if (n.name () == "DoorTypeOperationType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // DoorTypeConstructionType
          //
          if (n.name () == "DoorTypeConstructionType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // DoorTypeParamTakesPrecedence
          //
          if (n.name () == "DoorTypeParamTakesPrecedence" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // DoorTypeSizeable
          //
          if (n.name () == "DoorTypeSizeable" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
