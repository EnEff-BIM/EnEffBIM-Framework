...
#ifndef SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_CHILLED_WATER_TO_CHILLED_WATER_HXX
#define SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_CHILLED_WATER_TO_CHILLED_WATER_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_Economizer_ChilledWaterToChilledWater: public ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_Economizer
      {
        public:
        ...
        // Constructors.
        //
        SimFlowEnergyTransfer_Economizer_ChilledWaterToChilledWater (const RefId_type&);

        SimFlowEnergyTransfer_Economizer_ChilledWaterToChilledWater (const ::xercesc::DOMElement& e,
                                                                     ::xml_schema::flags f = 0,
                                                                     ::xml_schema::container* c = 0);

        SimFlowEnergyTransfer_Economizer_ChilledWaterToChilledWater (const SimFlowEnergyTransfer_Economizer_ChilledWaterToChilledWater& x,
                                                                     ::xml_schema::flags f = 0,
                                                                     ::xml_schema::container* c = 0);

        virtual SimFlowEnergyTransfer_Economizer_ChilledWaterToChilledWater*
        _clone (::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0) const;

        SimFlowEnergyTransfer_Economizer_ChilledWaterToChilledWater&
        operator= (const SimFlowEnergyTransfer_Economizer_ChilledWaterToChilledWater& x);
...
#endif // SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_CHILLED_WATER_TO_CHILLED_WATER_HXX
