    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowEnergyTrans_RatedPwr
          //
          if (n.name () == "SimFlowEnergyTrans_RatedPwr" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_RatedFanPwr
          //
          if (n.name () == "SimFlowEnergyTrans_RatedFanPwr" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_StandbyPwr
          //
          if (n.name () == "SimFlowEnergyTrans_StandbyPwr" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowEnergyTrans_WaterStorageTankName
          //
          if (n.name () == "SimFlowEnergyTrans_WaterStorageTankName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
