...
#ifndef SIM_FLOW_COMPOUND_EQMT_VIRTUAL_SUPPLY_SUBSYSTEMS_COIL_SYSTEM_COOLING_DX_HXX
#define SIM_FLOW_COMPOUND_EQMT_VIRTUAL_SUPPLY_SUBSYSTEMS_COIL_SYSTEM_COOLING_DX_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowCompoundEqmt_VirtualSupplySubsystems_CoilSystemCoolingDX: public ::namespaces::Sim::MepModel::SimFlowCompoundEqmt_VirtualSupplySubsystems
      {
        public:
        ...
        //
        typedef ::xml_schema::string SimFlowCompEqmt_DXCoolingCoilSysInletNodeName_type;
        typedef ::xsd::cxx::tree::optional< SimFlowCompEqmt_DXCoolingCoilSysInletNodeName_type > SimFlowCompEqmt_DXCoolingCoilSysInletNodeName_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowCompEqmt_DXCoolingCoilSysInletNodeName_type, char > SimFlowCompEqmt_DXCoolingCoilSysInletNodeName_traits;

        const SimFlowCompEqmt_DXCoolingCoilSysInletNodeName_optional&
        SimFlowCompEqmt_DXCoolingCoilSysInletNodeName () const;

        SimFlowCompEqmt_DXCoolingCoilSysInletNodeName_optional&
        SimFlowCompEqmt_DXCoolingCoilSysInletNodeName ();
        ...
        void
        SimFlowCompEqmt_DXCoolingCoilSysInletNodeName (::std::auto_ptr< SimFlowCompEqmt_DXCoolingCoilSysInletNodeName_type > p);

        // SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName
        //
        typedef ::xml_schema::string SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName_type;
        typedef ::xsd::cxx::tree::optional< SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName_type > SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName_type, char > SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName_traits;

        const SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName_optional&
        SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName () const;

        SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName_optional&
        SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName ();
        ...
        void
        SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName (::std::auto_ptr< SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName_type > p);

        // SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName
        //
        typedef ::xml_schema::string SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName_type;
        typedef ::xsd::cxx::tree::optional< SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName_type > SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName_type, char > SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName_traits;

        const SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName_optional&
        SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName () const;

        SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName_optional&
        SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName ();
        ...
        void
        SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName (::std::auto_ptr< SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName_type > p);

        // SimFlowCompEqmt_RunOnSensLoad
        //
        typedef ::xml_schema::string SimFlowCompEqmt_RunOnSensLoad_type;
        typedef ::xsd::cxx::tree::optional< SimFlowCompEqmt_RunOnSensLoad_type > SimFlowCompEqmt_RunOnSensLoad_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowCompEqmt_RunOnSensLoad_type, char > SimFlowCompEqmt_RunOnSensLoad_traits;

        const SimFlowCompEqmt_RunOnSensLoad_optional&
        SimFlowCompEqmt_RunOnSensLoad () const;

        SimFlowCompEqmt_RunOnSensLoad_optional&
        SimFlowCompEqmt_RunOnSensLoad ();
        ...
        void
        SimFlowCompEqmt_RunOnSensLoad (::std::auto_ptr< SimFlowCompEqmt_RunOnSensLoad_type > p);

        // SimFlowCompEqmt_RunOnLatentLoad
        //
        typedef ::xml_schema::string SimFlowCompEqmt_RunOnLatentLoad_type;
        typedef ::xsd::cxx::tree::optional< SimFlowCompEqmt_RunOnLatentLoad_type > SimFlowCompEqmt_RunOnLatentLoad_optional;
        typedef ::xsd::cxx::tree::traits< SimFlowCompEqmt_RunOnLatentLoad_type, char > SimFlowCompEqmt_RunOnLatentLoad_traits;

        const SimFlowCompEqmt_RunOnLatentLoad_optional&
        SimFlowCompEqmt_RunOnLatentLoad () const;

        SimFlowCompEqmt_RunOnLatentLoad_optional&
        SimFlowCompEqmt_RunOnLatentLoad ();
        ...
        void
        SimFlowCompEqmt_RunOnLatentLoad (::std::auto_ptr< SimFlowCompEqmt_RunOnLatentLoad_type > p);

        // Constructors.
        //
        SimFlowCompoundEqmt_VirtualSupplySubsystems_CoilSystemCoolingDX (const RefId_type&);
        ...
        virtual SimFlowCompoundEqmt_VirtualSupplySubsystems_CoilSystemCoolingDX*
        ...
        SimFlowCompEqmt_DXCoolingCoilSysInletNodeName_optional SimFlowCompEqmt_DXCoolingCoilSysInletNodeName_;
        SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName_optional SimFlowCompEqmt_DXCoolingCoilSysOutletNodeName_;
        SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName_optional SimFlowCompEqmt_DXCoolingCoilSysSensorNodeName_;
        SimFlowCompEqmt_RunOnSensLoad_optional SimFlowCompEqmt_RunOnSensLoad_;
        SimFlowCompEqmt_RunOnLatentLoad_optional SimFlowCompEqmt_RunOnLatentLoad_;
      };
    }
  }
}
...
#endif // SIM_FLOW_COMPOUND_EQMT_VIRTUAL_SUPPLY_SUBSYSTEMS_COIL_SYSTEM_COOLING_DX_HXX
