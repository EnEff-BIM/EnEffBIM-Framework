    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowPlant_DesignCondenserFluidFlowRate
          //
          if (n.name () == "SimFlowPlant_DesignCondenserFluidFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowPlant_Coef_1_3_CapRatioCurveList
          //
          if (n.name () == "SimFlowPlant_Coef_1_3_CapRatioCurveList" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowPlant_Coef_1_3_PwrRatioCurveList
          //
          if (n.name () == "SimFlowPlant_Coef_1_3_PwrRatioCurveList" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowPlant_Coef_1_3_FullLoadRatioCurveList
          //
          if (n.name () == "SimFlowPlant_Coef_1_3_FullLoadRatioCurveList" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
