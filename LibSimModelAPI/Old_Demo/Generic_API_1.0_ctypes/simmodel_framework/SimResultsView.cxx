    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // VariablesInView
          //
          if (n.name () == "VariablesInView" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ViewType
          //
          if (n.name () == "ViewType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ChartOrTableType
          //
          if (n.name () == "ChartOrTableType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // Font
          //
          if (n.name () == "Font" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // X_AxisMeasure
          //
          if (n.name () == "X_AxisMeasure" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // X_AxisUnits
          //
          if (n.name () == "X_AxisUnits" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // Y_AxisMeasure
          //
          if (n.name () == "Y_AxisMeasure" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // Y_AxisUnits
          //
          if (n.name () == "Y_AxisUnits" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // Y2_AxisMeasure
          //
          if (n.name () == "Y2_AxisMeasure" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // Y2_AxisUnits
          //
          if (n.name () == "Y2_AxisUnits" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // StartDate
          //
          if (n.name () == "StartDate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->StartDate_)
            {
          ...
          // EndDate
          //
          if (n.name () == "EndDate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->EndDate_)
            {
          ...
          // LegendInclDesignAlt
          //
          if (n.name () == "LegendInclDesignAlt" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // LegendInclConfig
          //
          if (n.name () == "LegendInclConfig" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // LegendInclRun
          //
          if (n.name () == "LegendInclRun" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // LegendInclArea
          //
          if (n.name () == "LegendInclArea" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ChartTitle
          //
          if (n.name () == "ChartTitle" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // LeftAxisLabel
          //
          if (n.name () == "LeftAxisLabel" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // RightAxisLabel
          //
          if (n.name () == "RightAxisLabel" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // BottomAxisLabel
          //
          if (n.name () == "BottomAxisLabel" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // Labels
          //
          if (n.name () == "Labels" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // LegendAppearence
          //
          if (n.name () == "LegendAppearence" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // ShowLegend
          //
          if (n.name () == "ShowLegend" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->ShowLegend_)
            {
          ...
          // LegendDockStyle
          //
          if (n.name () == "LegendDockStyle" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // LockAspectRatio
          //
          if (n.name () == "LockAspectRatio" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TableTextStyle
          //
          if (n.name () == "TableTextStyle" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // DecimalPlaces
          //
          if (n.name () == "DecimalPlaces" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // LeftAxisTitle
          //
          if (n.name () == "LeftAxisTitle" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // RightAxisTitle
          //
          if (n.name () == "RightAxisTitle" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // BottomAxisTitle
          //
          if (n.name () == "BottomAxisTitle" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // StartHour
          //
          if (n.name () == "StartHour" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->StartHour_)
            {
          ...
          // StartDay
          //
          if (n.name () == "StartDay" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->StartDay_)
            {
          ...
          // StartMonth
          //
          if (n.name () == "StartMonth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->StartMonth_)
            {
          ...
          // EndHour
          //
          if (n.name () == "EndHour" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->EndHour_)
            {
          ...
          // EndDay
          //
          if (n.name () == "EndDay" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->EndDay_)
            {
          ...
          // EndMonth
          //
          if (n.name () == "EndMonth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->EndMonth_)
            {
