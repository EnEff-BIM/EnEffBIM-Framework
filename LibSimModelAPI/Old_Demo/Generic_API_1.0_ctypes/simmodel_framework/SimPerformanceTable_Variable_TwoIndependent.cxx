    ...
    namespace ResourcesGeometry
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimPerformanceTable_MinValY
          //
          if (n.name () == "SimPerformanceTable_MinValY" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeometry")
          {
          ...
          // SimPerformanceTable_MaxValY
          //
          if (n.name () == "SimPerformanceTable_MaxValY" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeometry")
          {
          ...
          // SimPerformanceTable_InputUnitTypeForY
          //
          if (n.name () == "SimPerformanceTable_InputUnitTypeForY" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeometry")
          {
          ...
          // SimPerformanceTable_XValue_1_164
          //
          if (n.name () == "SimPerformanceTable_XValue_1_164" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeometry")
          {
          ...
          // SimPerformanceTable_YValue_1_164
          //
          if (n.name () == "SimPerformanceTable_YValue_1_164" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeometry")
          {
          ...
          // SimPerformanceTable_OutputValue_1_164
          //
          if (n.name () == "SimPerformanceTable_OutputValue_1_164" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeometry")
          {
