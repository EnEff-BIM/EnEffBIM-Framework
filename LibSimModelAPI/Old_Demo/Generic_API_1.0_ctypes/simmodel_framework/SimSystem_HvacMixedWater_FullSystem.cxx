...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      ...
      : ::namespaces::Sim::BuildingModel::SimSystem_HvacMixedWater (RefId),
      ...
      : ::namespaces::Sim::BuildingModel::SimSystem_HvacMixedWater (x, f, c),
      ...
      SimSystem_HvacMixedWater_FullSystem (const ::xercesc::DOMElement& e,
                                           ::xml_schema::flags f,
                                           ::xml_schema::container* c)
      : ::namespaces::Sim::BuildingModel::SimSystem_HvacMixedWater (e, f | ::xml_schema::flags::base, c),
        SimSys_AvailMngrListName_ (this),
        SimSys_DemandSideOutNodeName_ (this),
        SimSys_FluidType_ (this),
        SimSys_UserDefFluidType_ (this),
      ...
      parse (::xsd::cxx::xml::dom::parser< char >& p,
             ::xml_schema::flags f)
      {
        this->::namespaces::Sim::BuildingModel::SimSystem_HvacMixedWater::parse (p, f);
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimSys_FluidType
          //
          if (n.name () == "SimSys_FluidType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_UserDefFluidType
          //
          if (n.name () == "SimSys_UserDefFluidType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_PlantEqmtOpSchemeName
          //
          if (n.name () == "SimSys_PlantEqmtOpSchemeName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_LoopTempSetpntNodeName
          //
          if (n.name () == "SimSys_LoopTempSetpntNodeName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_MaxLoopTemp
          //
          if (n.name () == "SimSys_MaxLoopTemp" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_MinLoopTemp
          //
          if (n.name () == "SimSys_MinLoopTemp" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_MaxLoopFlowRate
          //
          if (n.name () == "SimSys_MaxLoopFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_MinLoopFlowRate
          //
          if (n.name () == "SimSys_MinLoopFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_PlantLoopVolume
          //
          if (n.name () == "SimSys_PlantLoopVolume" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_PlantSideInNodeName
          //
          if (n.name () == "SimSys_PlantSideInNodeName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_PlantSideOutNodeName
          //
          if (n.name () == "SimSys_PlantSideOutNodeName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_PlantSideBranchListName
          //
          if (n.name () == "SimSys_PlantSideBranchListName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_PlantSideConnListName
          //
          if (n.name () == "SimSys_PlantSideConnListName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_DemandSideInNodeName
          //
          if (n.name () == "SimSys_DemandSideInNodeName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_DemandSideBranchListName
          //
          if (n.name () == "SimSys_DemandSideBranchListName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_DemandSideConnListName
          //
          if (n.name () == "SimSys_DemandSideConnListName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_LoadDistScheme
          //
          if (n.name () == "SimSys_LoadDistScheme" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_PlantLoopDemandCalcScheme
          //
          if (n.name () == "SimSys_PlantLoopDemandCalcScheme" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_CommonPipeSim
          //
          if (n.name () == "SimSys_CommonPipeSim" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
          ...
          // SimSys_PresSimType
          //
          if (n.name () == "SimSys_PresSimType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/BuildingModel")
          {
      ...
      operator= (const SimSystem_HvacMixedWater_FullSystem& x)
      {
        if (this != &x)
        {
          static_cast< ::namespaces::Sim::BuildingModel::SimSystem_HvacMixedWater& > (*this) = x;
