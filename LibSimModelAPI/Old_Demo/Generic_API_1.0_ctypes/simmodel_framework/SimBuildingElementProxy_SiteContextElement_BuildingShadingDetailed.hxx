...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      class SimBuildingElementProxy_SiteContextElement_BuildingShadingDetailed: public ::namespaces::Sim::BuildingModel::SimBuildingElementProxy_SiteContextElement
      {
        public:
