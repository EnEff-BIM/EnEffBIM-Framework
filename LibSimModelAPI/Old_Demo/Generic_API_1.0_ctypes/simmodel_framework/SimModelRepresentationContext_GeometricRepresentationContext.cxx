    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // CoordinateSpaceDimension
          //
          if (n.name () == "CoordinateSpaceDimension" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // Precision
          //
          if (n.name () == "Precision" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
            if (!this->Precision_)
            {
          ...
          // WorldCoordinateSystem
          //
          if (n.name () == "WorldCoordinateSystem" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // TrueNorth
          //
          if (n.name () == "TrueNorth" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimModelRepresentationContext_StartVertexPosition
          //
          if (n.name () == "SimModelRepresentationContext_StartVertexPosition" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimModelRepresentationContext_VertexEntryDir
          //
          if (n.name () == "SimModelRepresentationContext_VertexEntryDir" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimModelRepresentationContext_CoordSys
          //
          if (n.name () == "SimModelRepresentationContext_CoordSys" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimModelRepresentationContext_DylghtRefPointCoordSys
          //
          if (n.name () == "SimModelRepresentationContext_DylghtRefPointCoordSys" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimModelRepresentationContext_RectSurfCoordSys
          //
          if (n.name () == "SimModelRepresentationContext_RectSurfCoordSys" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
