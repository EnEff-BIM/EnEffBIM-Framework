...
#ifndef SIM_CURTAIN_WALL_TYPE_HXX
#define SIM_CURTAIN_WALL_TYPE_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      class SimCurtainWallType: public ::namespaces::Sim::SimModelCore::SimObjectTypeDefinition
      {
        public:
        // RepresentationMaps
        //
        ...
        //
        typedef ::xml_schema::idref CurtainWallArrayParams_type;
        typedef ::xsd::cxx::tree::optional< CurtainWallArrayParams_type > CurtainWallArrayParams_optional;
        typedef ::xsd::cxx::tree::traits< CurtainWallArrayParams_type, char > CurtainWallArrayParams_traits;

        const CurtainWallArrayParams_optional&
        CurtainWallArrayParams () const;

        CurtainWallArrayParams_optional&
        CurtainWallArrayParams ();
        ...
        void
        CurtainWallArrayParams (::std::auto_ptr< CurtainWallArrayParams_type > p);

        // Constructors.
        //
        SimCurtainWallType (const RefId_type&);
        ...
        CurtainWallArrayParams_optional CurtainWallArrayParams_;
      };
    }
  }
}
...
#endif // SIM_CURTAIN_WALL_TYPE_HXX
