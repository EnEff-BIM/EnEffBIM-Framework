...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_HeatExAirToAir_DesiccantBalancedFlow: public ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_HeatExAirToAir
      {
        public:
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList HeatExch_Desic_BalFlow_PerfDataType1_TempEquaCoef_1_8_type;
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList HeatExch_Desic_BalFlow_PerfDataType1_HumidRatioEquaCoef_1_8_type;
