...
#ifndef SIM_PERFORMANCE_CURVE_MATHEMATICAL_EXPONENT_HXX
#define SIM_PERFORMANCE_CURVE_MATHEMATICAL_EXPONENT_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeometry
    {
      class SimPerformanceCurve_Mathematical_Exponent: public ::namespaces::Sim::ResourcesGeometry::SimPerformanceCurve_Mathematical
      {
        public:
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimPerfCurve_Coeff_1_3_Const_type;
        typedef ::xsd::cxx::tree::optional< SimPerfCurve_Coeff_1_3_Const_type > SimPerfCurve_Coeff_1_3_Const_optional;
        typedef ::xsd::cxx::tree::traits< SimPerfCurve_Coeff_1_3_Const_type, char > SimPerfCurve_Coeff_1_3_Const_traits;

        const SimPerfCurve_Coeff_1_3_Const_optional&
        SimPerfCurve_Coeff_1_3_Const () const;

        SimPerfCurve_Coeff_1_3_Const_optional&
        SimPerfCurve_Coeff_1_3_Const ();
        ...
        void
        SimPerfCurve_Coeff_1_3_Const (::std::auto_ptr< SimPerfCurve_Coeff_1_3_Const_type > p);

        // Constructors.
        //
        SimPerformanceCurve_Mathematical_Exponent (const RefId_type&);
        ...
        virtual SimPerformanceCurve_Mathematical_Exponent*
        ...
        SimPerfCurve_Coeff_1_3_Const_optional SimPerfCurve_Coeff_1_3_Const_;
      };
    }
  }
}
...
#endif // SIM_PERFORMANCE_CURVE_MATHEMATICAL_EXPONENT_HXX
