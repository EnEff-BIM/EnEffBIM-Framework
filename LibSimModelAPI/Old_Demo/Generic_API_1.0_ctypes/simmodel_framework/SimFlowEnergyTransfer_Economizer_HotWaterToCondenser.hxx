...
#ifndef SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_HOT_WATER_TO_CONDENSER_HXX
#define SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_HOT_WATER_TO_CONDENSER_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_Economizer_HotWaterToCondenser: public ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_Economizer
      {
        public:
        ...
        // Constructors.
        //
        SimFlowEnergyTransfer_Economizer_HotWaterToCondenser (const RefId_type&);

        SimFlowEnergyTransfer_Economizer_HotWaterToCondenser (const ::xercesc::DOMElement& e,
                                                              ::xml_schema::flags f = 0,
                                                              ::xml_schema::container* c = 0);

        SimFlowEnergyTransfer_Economizer_HotWaterToCondenser (const SimFlowEnergyTransfer_Economizer_HotWaterToCondenser& x,
                                                              ::xml_schema::flags f = 0,
                                                              ::xml_schema::container* c = 0);

        virtual SimFlowEnergyTransfer_Economizer_HotWaterToCondenser*
        _clone (::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0) const;

        SimFlowEnergyTransfer_Economizer_HotWaterToCondenser&
        operator= (const SimFlowEnergyTransfer_Economizer_HotWaterToCondenser& x);
...
#endif // SIM_FLOW_ENERGY_TRANSFER_ECONOMIZER_HOT_WATER_TO_CONDENSER_HXX
