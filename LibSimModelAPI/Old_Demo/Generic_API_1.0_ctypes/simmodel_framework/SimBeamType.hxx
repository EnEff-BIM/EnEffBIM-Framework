...
#ifndef SIM_BEAM_TYPE_HXX
#define SIM_BEAM_TYPE_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace BuildingModel
    {
      class SimBeamType: public ::namespaces::Sim::SimModelCore::SimObjectTypeDefinition
      {
        public:
        // RepresentationMaps
        //
