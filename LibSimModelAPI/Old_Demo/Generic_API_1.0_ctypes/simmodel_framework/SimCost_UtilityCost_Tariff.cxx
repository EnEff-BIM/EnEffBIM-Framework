    ...
    namespace ResourcesGeneral
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimCost_OutputMeterName
          //
          if (n.name () == "SimCost_OutputMeterName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_ConvFactorChoice
          //
          if (n.name () == "SimCost_ConvFactorChoice" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_EnergyConvFactor
          //
          if (n.name () == "SimCost_EnergyConvFactor" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_DemandConvFactor
          //
          if (n.name () == "SimCost_DemandConvFactor" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_TimeUsePeriodSchedName
          //
          if (n.name () == "SimCost_TimeUsePeriodSchedName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_SeasonSchedName
          //
          if (n.name () == "SimCost_SeasonSchedName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_MonthSchedName
          //
          if (n.name () == "SimCost_MonthSchedName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_DemandWindLength
          //
          if (n.name () == "SimCost_DemandWindLength" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_MonthlyChargeVarName
          //
          if (n.name () == "SimCost_MonthlyChargeVarName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_MinMonthlyChargeVarName
          //
          if (n.name () == "SimCost_MinMonthlyChargeVarName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_RealTimePricingChargeSchedName
          //
          if (n.name () == "SimCost_RealTimePricingChargeSchedName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_CustomerBaselineLoadSchedName
          //
          if (n.name () == "SimCost_CustomerBaselineLoadSchedName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_GroupName
          //
          if (n.name () == "SimCost_GroupName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // SimCost_BuyOrSell
          //
          if (n.name () == "SimCost_BuyOrSell" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
          ...
          // UtilCost_Comp_ComputeStep_1_30
          //
          if (n.name () == "UtilCost_Comp_ComputeStep_1_30" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/ResourcesGeneral")
          {
