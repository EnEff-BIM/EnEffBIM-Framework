    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList
          //
          if (n.name () == "SimFlowPlant_Coef_1_3_HotWaterOrSteamUsePartLoadRatioCurveList" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList
          //
          if (n.name () == "SimFlowPlant_Coef_1_3_PumpElecUsePartLoadRatioCurveList" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
