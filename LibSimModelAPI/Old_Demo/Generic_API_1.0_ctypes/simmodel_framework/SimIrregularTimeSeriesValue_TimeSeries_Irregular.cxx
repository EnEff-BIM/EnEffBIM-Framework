...
namespace namespaces
{
  namespace Sim
  {
    namespace ResourcesGeneral
    {
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimIrregularTimeSeriesValue_TimeSeries (RefId)
      {
      }
      ...
      : ::namespaces::Sim::ResourcesGeneral::SimIrregularTimeSeriesValue_TimeSeries (x, f, c)
      {
      }
      ...
      SimIrregularTimeSeriesValue_TimeSeries_Irregular (const ::xercesc::DOMElement& e,
                                                        ::xml_schema::flags f,
                                                        ::xml_schema::container* c)
      : ::namespaces::Sim::ResourcesGeneral::SimIrregularTimeSeriesValue_TimeSeries (e, f, c)
      {
      }
