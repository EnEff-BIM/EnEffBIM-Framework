    ...
    namespace MepModel
    {
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // SimFlowPlant_SolarCollectPerfName
          //
          if (n.name () == "SimFlowPlant_SolarCollectPerfName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SolarCollectPerf_FlatPlate_GrossArea
          //
          if (n.name () == "SolarCollectPerf_FlatPlate_GrossArea" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SolarCollectPerf_FlatPlate_TestFluid
          //
          if (n.name () == "SolarCollectPerf_FlatPlate_TestFluid" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SolarCollectPerf_FlatPlate_TestFlowRate
          //
          if (n.name () == "SolarCollectPerf_FlatPlate_TestFlowRate" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SolarCollectPerf_FlatPlate_TestCorrelType
          //
          if (n.name () == "SolarCollectPerf_FlatPlate_TestCorrelType" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SolarCollectPerf_FlatPlate_Coef1ofEffEquation
          //
          if (n.name () == "SolarCollectPerf_FlatPlate_Coef1ofEffEquation" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SolarCollectPerf_FlatPlate_Coef2ofEffEquation
          //
          if (n.name () == "SolarCollectPerf_FlatPlate_Coef2ofEffEquation" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SolarCollectPerf_FlatPlate_Coef3ofEffEquation
          //
          if (n.name () == "SolarCollectPerf_FlatPlate_Coef3ofEffEquation" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SolarCollectPerf_FlatPlate_Coef2OfIncidentAngleMod
          //
          if (n.name () == "SolarCollectPerf_FlatPlate_Coef2OfIncidentAngleMod" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
          ...
          // SolarCollectPerf_FlatPlate_Coef3OfIncidentAngleMod
          //
          if (n.name () == "SolarCollectPerf_FlatPlate_Coef3OfIncidentAngleMod" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/MepModel")
          {
