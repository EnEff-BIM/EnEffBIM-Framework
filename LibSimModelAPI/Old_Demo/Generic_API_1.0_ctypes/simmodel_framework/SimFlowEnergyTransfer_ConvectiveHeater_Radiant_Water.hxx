...
namespace namespaces
{
  namespace Sim
  {
    namespace MepModel
    {
      class SimFlowEnergyTransfer_ConvectiveHeater_Radiant_Water: public ::namespaces::Sim::MepModel::SimFlowEnergyTransfer_ConvectiveHeater
      {
        public:
        ...
        //
        typedef ::namespaces::Sim::SimModelCore::doubleList SimFlowEnergyTrans_FractRadiantEnergyToSurf_1_20_type;
