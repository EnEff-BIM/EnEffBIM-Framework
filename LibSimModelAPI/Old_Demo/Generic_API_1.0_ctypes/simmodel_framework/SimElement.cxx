...
namespace namespaces
{
  namespace Sim
  {
    namespace SimModelCore
    {
      ...
      const SimElement::SourceLibraryID_optional& SimElement::
      SourceLibraryID () const
      {
        return this->SourceLibraryID_;
      }

      SimElement::SourceLibraryID_optional& SimElement::
      SourceLibraryID ()
      {
        return this->SourceLibraryID_;
      }
      ...
      void SimElement::
      SourceLibraryID (const SourceLibraryID_type& x)
      {
        this->SourceLibraryID_.set (x);
      }

      void SimElement::
      SourceLibraryID (const SourceLibraryID_optional& x)
      {
        this->SourceLibraryID_ = x;
      }

      void SimElement::
      SourceLibraryID (::std::auto_ptr< SourceLibraryID_type > x)
      {
        this->SourceLibraryID_.set (x);
      }

      const SimElement::SourceLibraryEntryName_optional& SimElement::
      SourceLibraryEntryName () const
      {
        return this->SourceLibraryEntryName_;
      }

      SimElement::SourceLibraryEntryName_optional& SimElement::
      ...
      void SimElement::
      SourceLibraryEntryName (const SourceLibraryEntryName_type& x)
      {
        this->SourceLibraryEntryName_.set (x);
      }

      void SimElement::
      SourceLibraryEntryName (const SourceLibraryEntryName_optional& x)
      {
        this->SourceLibraryEntryName_ = x;
      }

      void SimElement::
      SourceLibraryEntryName (::std::auto_ptr< SourceLibraryEntryName_type > x)
      {
        this->SourceLibraryEntryName_.set (x);
      }
  ...
  namespace Sim
  {
    namespace SimModelCore
    {
      ...
      : ::namespaces::Sim::SimModelCore::SimObject (RefId),
        ...
        Placement_ (this),
        Tag_ (this),
        SourceLibraryID_ (this),
        SourceLibraryEntryName_ (this),
      ...
      : ::namespaces::Sim::SimModelCore::SimObject (x, f, c),
        ...
        Tag_ (x.Tag_, f, this),
        SourceLibraryID_ (x.SourceLibraryID_, f, this),
        SourceLibraryEntryName_ (x.SourceLibraryEntryName_, f, this),
             ...
             ::xml_schema::flags f)
      {
        ...
        for (; p.more_content (); p.next_content (false))
        {
          ...
          // GeometricRepresentations
          //
          if (n.name () == "GeometricRepresentations" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/SimModelCore")
          {
          ...
          // ContainingSpatialStructure
          //
          if (n.name () == "ContainingSpatialStructure" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/SimModelCore")
          {
          ...
          // AssignedToGroups
          //
          if (n.name () == "AssignedToGroups" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/SimModelCore")
          {
          ...
          // Placement
          //
          if (n.name () == "Placement" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/SimModelCore")
          {
          ...
          // Tag
          //
          if (n.name () == "Tag" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/SimModelCore")
          {
          ...
          // SourceLibraryID
          //
          if (n.name () == "SourceLibraryID" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/SimModelCore")
          {
            ::std::auto_ptr< SourceLibraryID_type > r (
              SourceLibraryID_traits::create (i, f, this));

            if (!this->SourceLibraryID_)
            {
              this->SourceLibraryID_.set (r);
              continue;
            }
          }
          ...
          // SourceLibraryEntryName
          //
          if (n.name () == "SourceLibraryEntryName" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/SimModelCore")
          {
            ::std::auto_ptr< SourceLibraryEntryName_type > r (
              SourceLibraryEntryName_traits::create (i, f, this));

            if (!this->SourceLibraryEntryName_)
            {
              this->SourceLibraryEntryName_.set (r);
              continue;
            }
          }
          ...
          // SelectedPropertyGroups
          //
          if (n.name () == "SelectedPropertyGroups" && n.namespace_ () == "http://www.lbl.gov/namespaces/Sim/SimModelCore")
          {
      ...
      operator= (const SimElement& x)
      {
        if (this != &x)
        {
          ...
          this->Tag_ = x.Tag_;
          this->SourceLibraryID_ = x.SourceLibraryID_;
          this->SourceLibraryEntryName_ = x.SourceLibraryEntryName_;
