...
#ifndef PROPERTY_MAP_CONVERSION_HXX
#define PROPERTY_MAP_CONVERSION_HXX
...
namespace namespaces
{
  namespace Sim
  {
    namespace DataMap
    {
      class Property_Map_Conversion: public ::xml_schema::type
      {
        public:
        // Description
        //
        ...
        const OutputParameterName_type&
        OutputParameterName () const;

        OutputParameterName_type&
        OutputParameterName ();
        ...
        void
        OutputParameterName (::std::auto_ptr< OutputParameterName_type > p);
        ...
        // Constructors.
        //
        Property_Map_Conversion (const Function_type&,
                                 const OutputParameterName_type&,
                                 const RefId_type&);
        ...
        virtual Property_Map_Conversion*
        ...
        ::xsd::cxx::tree::one< OutputParameterName_type > OutputParameterName_;
...
#endif // PROPERTY_MAP_CONVERSION_HXX
